...
(function (root, factory) {
    ...
    var toString = Object.prototype.toString,
        ...
        OBJECT_CLASS_NAME = p("type-object")+" table table-bordered",
        ...
        switch (type) {
            ...
            case OBJECT:
                ...
                for (key in data) {
                    ...
                    keyNode = sn("td", OBJ_KEY_CLASS_NAME, key);
                ...
                var thead = [];
                tr = document.createElement("tr");
                tr.appendChild(sn("th", '', "Key"));
                tr.appendChild(sn("th", '', "Value"));
                thead.push(tr);

                if (isEmpty) {
                    result = sn("span", OBJ_EMPTY_CLASS_NAME, "(Empty Object)");
                } else {
                    result = scn("table", OBJECT_CLASS_NAME, [scn("thead",'',thead),scn("tbody", '', childs)]);
                }
                break;
            case FUNCTION:
