...
class WorkerMetric:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('WorkerMetric')
...
class WorkerMetricList:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'metrics', (TType.STRUCT,(WorkerMetric, WorkerMetric.thrift_spec)), None, ), # 1
  )
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i795 in xrange(_size791):
            _elem796 = WorkerMetric()
            _elem796.read(iprot)
            self.metrics.append(_elem796)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
