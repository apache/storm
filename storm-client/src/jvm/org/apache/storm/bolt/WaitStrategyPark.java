...
public class WaitStrategyPark implements IBoltWaitStrategy {
    private long parkTimeNanoSec;

    @Override
    public void prepare(Map<String, Object> conf) {
        long microsec = ObjectReader.getLong(conf.get(Config.TOPOLOGY_BOLT_WAIT_STRATEGY_PARK_MICROSEC));
