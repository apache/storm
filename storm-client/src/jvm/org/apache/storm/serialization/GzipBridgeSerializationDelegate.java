...
/**
 * Always writes gzip out, but tests incoming to see if it's gzipped. If it is, deserializes with gzip. If not, uses {@link
 * org.apache.storm.serialization.DefaultSerializationDelegate} to deserialize. Any logic needing to be enabled via {@link
