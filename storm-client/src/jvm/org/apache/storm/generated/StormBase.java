...
public class StormBase implements org.apache.storm.thrift.TBase<StormBase, StormBase._Fields>, java.io.Serializable, Cloneable, Comparable<StormBase> {
  ...
  public int compareTo(StormBase other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_component_executors(), other.is_set_component_executors());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_component_executors()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_launch_time_secs(), other.is_set_launch_time_secs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_launch_time_secs()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_topology_action_options(), other.is_set_topology_action_options());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_topology_action_options()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_prev_status(), other.is_set_prev_status());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_prev_status()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_component_debug(), other.is_set_component_debug());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_component_debug()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_principal(), other.is_set_principal());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_principal()) {
  ...
  private static class StormBaseTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<StormBase> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, StormBase struct) throws org.apache.storm.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.storm.thrift.protocol.TMap _map814 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.I32); 
      ...
      if (incoming.get(5)) {
        {
          org.apache.storm.thrift.protocol.TMap _map818 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.STRUCT); 
