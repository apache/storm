...
public class WorkerSummary implements org.apache.storm.thrift.TBase<WorkerSummary, WorkerSummary._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerSummary> {
  ...
  public int compareTo(WorkerSummary other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_supervisor_id(), other.is_set_supervisor_id());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_component_to_num_tasks(), other.is_set_component_to_num_tasks());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_component_to_num_tasks()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_time_secs(), other.is_set_time_secs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_time_secs()) {
  ...
  private static class WorkerSummaryTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<WorkerSummary> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, WorkerSummary struct) throws org.apache.storm.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          org.apache.storm.thrift.protocol.TMap _map492 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.I64); 
