...
public class NimbusSummary implements org.apache.storm.thrift.TBase<NimbusSummary, NimbusSummary._Fields>, java.io.Serializable, Cloneable, Comparable<NimbusSummary> {
  ...
  private static final org.apache.storm.thrift.protocol.TField TLS_PORT_FIELD_DESC = new org.apache.storm.thrift.protocol.TField("tlsPort", org.apache.storm.thrift.protocol.TType.I32, (short)6);
  ...
  private @org.apache.storm.thrift.annotation.Nullable java.lang.String version; // required
  private int tlsPort; // optional
  ...
  private static final int __TLSPORT_ISSET_ID = 3;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.TLS_PORT};
  ...
  static {
    ...
    tmpMap.put(_Fields.VERSION, new org.apache.storm.thrift.meta_data.FieldMetaData("version", org.apache.storm.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.storm.thrift.meta_data.FieldValueMetaData(org.apache.storm.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.TLS_PORT, new org.apache.storm.thrift.meta_data.FieldMetaData("tlsPort", org.apache.storm.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.storm.thrift.meta_data.FieldValueMetaData(org.apache.storm.thrift.protocol.TType.I32)));
  ...
  public void set_tlsPort(int tlsPort) {
    ...
    set_tlsPort_isSet(true);
  }

  public void unset_tlsPort() {
    __isset_bitfield = org.apache.storm.thrift.EncodingUtils.clearBit(__isset_bitfield, __TLSPORT_ISSET_ID);
  }

  /** Returns true if field tlsPort is set (has been assigned a value) and false otherwise */
  public boolean is_set_tlsPort() {
    return org.apache.storm.thrift.EncodingUtils.testBit(__isset_bitfield, __TLSPORT_ISSET_ID);
  }

  public void set_tlsPort_isSet(boolean value) {
    __isset_bitfield = org.apache.storm.thrift.EncodingUtils.setBit(__isset_bitfield, __TLSPORT_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.storm.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case TLS_PORT:
      if (value == null) {
        ...
        set_tlsPort((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(NimbusSummary that) {
    ...
    boolean this_present_tlsPort = true && this.is_set_tlsPort();
    boolean that_present_tlsPort = true && that.is_set_tlsPort();
    if (this_present_tlsPort || that_present_tlsPort) {
      if (!(this_present_tlsPort && that_present_tlsPort))
        return false;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((is_set_tlsPort()) ? 131071 : 524287);
    if (is_set_tlsPort())
      hashCode = hashCode * 8191 + tlsPort;
  ...
  public int compareTo(NimbusSummary other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_port(), other.is_set_port());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_port()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_isLeader(), other.is_set_isLeader());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_isLeader()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_tlsPort(), other.is_set_tlsPort());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_tlsPort()) {
      lastComparison = org.apache.storm.thrift.TBaseHelper.compareTo(this.tlsPort, other.tlsPort);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class NimbusSummaryStandardScheme extends org.apache.storm.thrift.scheme.StandardScheme<NimbusSummary> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol iprot, NimbusSummary struct) throws org.apache.storm.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // TLS_PORT
            if (schemeField.type == org.apache.storm.thrift.protocol.TType.I32) {
              struct.tlsPort = iprot.readI32();
              struct.set_tlsPort_isSet(true);
            } else { 
              org.apache.storm.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.storm.thrift.protocol.TProtocol oprot, NimbusSummary struct) throws org.apache.storm.thrift.TException {
      ...
      if (struct.is_set_tlsPort()) {
        oprot.writeFieldBegin(TLS_PORT_FIELD_DESC);
        oprot.writeI32(struct.tlsPort);
        oprot.writeFieldEnd();
      }
