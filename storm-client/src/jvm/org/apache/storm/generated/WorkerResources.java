...
public class WorkerResources implements org.apache.storm.thrift.TBase<WorkerResources, WorkerResources._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerResources> {
        ...
        switch (schemeField.id) {
          ...
          case 6: // RESOURCES
            if (schemeField.type == org.apache.storm.thrift.protocol.TType.MAP) {
              {
                org.apache.storm.thrift.protocol.TMap _map724 = iprot.readMapBegin();
                struct.resources = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map724.size);
                @org.apache.storm.thrift.annotation.Nullable java.lang.String _key725;
                double _val726;
                for (int _i727 = 0; _i727 < _map724.size; ++_i727)
                {
                  _key725 = iprot.readString();
                  _val726 = iprot.readDouble();
                  struct.resources.put(_key725, _val726);
                }
                iprot.readMapEnd();
              }
          ...
          case 7: // SHARED_RESOURCES
            if (schemeField.type == org.apache.storm.thrift.protocol.TType.MAP) {
              {
                org.apache.storm.thrift.protocol.TMap _map728 = iprot.readMapBegin();
                struct.shared_resources = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map728.size);
                ...
                for (int _i731 = 0; _i731 < _map728.size; ++_i731)
                {
                  ...
                  struct.shared_resources.put(_key729, _val730);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.resources != null) {
        if (struct.is_set_resources()) {
          oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter732 : struct.resources.entrySet())
            {
              oprot.writeString(_iter732.getKey());
              oprot.writeDouble(_iter732.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.shared_resources != null) {
        if (struct.is_set_shared_resources()) {
          oprot.writeFieldBegin(SHARED_RESOURCES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter733 : struct.shared_resources.entrySet())
            {
  ...
  private static class WorkerResourcesTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<WorkerResources> {
      ...
      if (struct.is_set_resources()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter734 : struct.resources.entrySet())
          {
            oprot.writeString(_iter734.getKey());
            oprot.writeDouble(_iter734.getValue());
          }
        }
      }
      if (struct.is_set_shared_resources()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter735 : struct.shared_resources.entrySet())
          {
            oprot.writeString(_iter735.getKey());
            oprot.writeDouble(_iter735.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, WorkerResources struct) throws org.apache.storm.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.storm.thrift.protocol.TMap _map736 = new org.apache.storm.thrift.protocol.TMap(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.resources = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map736.size);
          ...
          for (int _i739 = 0; _i739 < _map736.size; ++_i739)
          {
            ...
            _val738 = iprot.readDouble();
            struct.resources.put(_key737, _val738);
          }
        }
        struct.set_resources_isSet(true);
      }
      if (incoming.get(6)) {
        {
          org.apache.storm.thrift.protocol.TMap _map740 = new org.apache.storm.thrift.protocol.TMap(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.shared_resources = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map740.size);
          @org.apache.storm.thrift.annotation.Nullable java.lang.String _key741;
          double _val742;
          for (int _i743 = 0; _i743 < _map740.size; ++_i743)
          {
            _key741 = iprot.readString();
            _val742 = iprot.readDouble();
            struct.shared_resources.put(_key741, _val742);
          }
        }
        struct.set_shared_resources_isSet(true);
      }
