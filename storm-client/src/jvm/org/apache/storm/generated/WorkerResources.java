...
public class WorkerResources implements org.apache.storm.thrift.TBase<WorkerResources, WorkerResources._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerResources> {
  ...
  public int compareTo(WorkerResources other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_mem_on_heap(), other.is_set_mem_on_heap());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_mem_off_heap(), other.is_set_mem_off_heap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_mem_off_heap()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_cpu(), other.is_set_cpu());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_cpu()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_shared_mem_on_heap(), other.is_set_shared_mem_on_heap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_shared_mem_on_heap()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_shared_mem_off_heap(), other.is_set_shared_mem_off_heap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_shared_mem_off_heap()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_shared_resources(), other.is_set_shared_resources());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_shared_resources()) {
  ...
  private static class WorkerResourcesTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<WorkerResources> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, WorkerResources struct) throws org.apache.storm.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.storm.thrift.protocol.TMap _map728 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.DOUBLE); 
      ...
      if (incoming.get(6)) {
        {
          org.apache.storm.thrift.protocol.TMap _map732 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.DOUBLE); 
