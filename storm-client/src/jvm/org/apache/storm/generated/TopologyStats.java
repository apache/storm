...
public class TopologyStats implements org.apache.storm.thrift.TBase<TopologyStats, TopologyStats._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyStats> {
  ...
  public int compareTo(TopologyStats other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_window_to_emitted(), other.is_set_window_to_emitted());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_window_to_transferred(), other.is_set_window_to_transferred());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_window_to_transferred()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_window_to_complete_latencies_ms(), other.is_set_window_to_complete_latencies_ms());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_window_to_complete_latencies_ms()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_window_to_acked(), other.is_set_window_to_acked());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_window_to_acked()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_window_to_failed(), other.is_set_window_to_failed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_window_to_failed()) {
  ...
  private static class TopologyStatsTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<TopologyStats> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, TopologyStats struct) throws org.apache.storm.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.storm.thrift.protocol.TMap _map466 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.I64); 
      ...
      if (incoming.get(1)) {
        {
          org.apache.storm.thrift.protocol.TMap _map470 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.I64); 
      ...
      if (incoming.get(2)) {
        {
          org.apache.storm.thrift.protocol.TMap _map474 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.DOUBLE); 
      ...
      if (incoming.get(3)) {
        {
          org.apache.storm.thrift.protocol.TMap _map478 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.I64); 
      ...
      if (incoming.get(4)) {
        {
          org.apache.storm.thrift.protocol.TMap _map482 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.I64); 
