...
public class SupervisorPageInfo implements org.apache.storm.thrift.TBase<SupervisorPageInfo, SupervisorPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorPageInfo> {
  ...
  public int compareTo(SupervisorPageInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_supervisor_summaries(), other.is_set_supervisor_summaries());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_worker_summaries(), other.is_set_worker_summaries());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_worker_summaries()) {
  ...
  private static class SupervisorPageInfoTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<SupervisorPageInfo> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, SupervisorPageInfo struct) throws org.apache.storm.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.storm.thrift.protocol.TList _list506 = iprot.readListBegin(org.apache.storm.thrift.protocol.TType.STRUCT);
      ...
      if (incoming.get(1)) {
        {
          org.apache.storm.thrift.protocol.TList _list509 = iprot.readListBegin(org.apache.storm.thrift.protocol.TType.STRUCT);
