...
public class ErrorInfo implements org.apache.storm.thrift.TBase<ErrorInfo, ErrorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ErrorInfo> {
  ...
  public int compareTo(ErrorInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_error(), other.is_set_error());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_error_time_secs(), other.is_set_error_time_secs());
    if (lastComparison != 0) {
      return lastComparison;
    }
