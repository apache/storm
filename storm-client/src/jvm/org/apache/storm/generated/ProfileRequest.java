...
public class ProfileRequest implements org.apache.storm.thrift.TBase<ProfileRequest, ProfileRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ProfileRequest> {
  ...
  private @org.apache.storm.thrift.annotation.Nullable NodeInfo nodeInfo; // required
  ...
  public void set_nodeInfo(@org.apache.storm.thrift.annotation.Nullable NodeInfo nodeInfo) {
    this.nodeInfo = nodeInfo;
  }
  ...
  public int compareTo(ProfileRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_nodeInfo(), other.is_set_nodeInfo());
    if (lastComparison != 0) {
