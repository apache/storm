...
public class ComponentAggregateStats implements org.apache.storm.thrift.TBase<ComponentAggregateStats, ComponentAggregateStats._Fields>, java.io.Serializable, Cloneable, Comparable<ComponentAggregateStats> {
  ...
  private @org.apache.storm.thrift.annotation.Nullable ComponentType type; // optional
  private @org.apache.storm.thrift.annotation.Nullable CommonAggregateStats common_stats; // optional
   ...
   * @see ComponentType
   */
  public void set_type(@org.apache.storm.thrift.annotation.Nullable ComponentType type) {
    this.type = type;
  }
  ...
  public void set_common_stats(@org.apache.storm.thrift.annotation.Nullable CommonAggregateStats common_stats) {
  ...
  public void set_specific_stats(@org.apache.storm.thrift.annotation.Nullable SpecificAggregateStats specific_stats) {
  ...
  public void set_last_error(@org.apache.storm.thrift.annotation.Nullable ErrorInfo last_error) {
  ...
  public int compareTo(ComponentAggregateStats other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_type(), other.is_set_type());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_common_stats(), other.is_set_common_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_common_stats()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_specific_stats(), other.is_set_specific_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_specific_stats()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_last_error(), other.is_set_last_error());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_last_error()) {
