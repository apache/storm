...
public class DistributedRPC {
  ...
  public static class Processor<I extends Iface> extends org.apache.storm.thrift.TBaseProcessor<I> implements org.apache.storm.thrift.TProcessor {
    ...
    public static class execute<I extends Iface> extends org.apache.storm.thrift.ProcessFunction<I, execute_args, execute_result> {
      public execute() {
        super("execute");
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.storm.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class execute<I extends AsyncIface> extends org.apache.storm.thrift.AsyncProcessFunction<I, execute_args, java.lang.String, execute_result> {
      public execute() {
        super("execute");
      }
