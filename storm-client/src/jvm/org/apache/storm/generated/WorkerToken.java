...
public class WorkerToken implements org.apache.storm.thrift.TBase<WorkerToken, WorkerToken._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerToken> {
  ...
  public int compareTo(WorkerToken other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_serviceType(), other.is_set_serviceType());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_info(), other.is_set_info());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_info()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_signature(), other.is_set_signature());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_signature()) {
