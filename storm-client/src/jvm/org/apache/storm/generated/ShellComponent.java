...
public class ShellComponent implements org.apache.storm.thrift.TBase<ShellComponent, ShellComponent._Fields>, java.io.Serializable, Cloneable, Comparable<ShellComponent> {
  ...
  public int compareTo(ShellComponent other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_execution_command(), other.is_set_execution_command());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_script(), other.is_set_script());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_script()) {
