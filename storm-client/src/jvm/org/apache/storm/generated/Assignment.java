...
public class Assignment implements org.apache.storm.thrift.TBase<Assignment, Assignment._Fields>, java.io.Serializable, Cloneable, Comparable<Assignment> {
  ...
  public int compareTo(Assignment other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_master_code_dir(), other.is_set_master_code_dir());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_node_host(), other.is_set_node_host());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_node_host()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_executor_node_port(), other.is_set_executor_node_port());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_executor_node_port()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_executor_start_time_secs(), other.is_set_executor_start_time_secs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_executor_start_time_secs()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_worker_resources(), other.is_set_worker_resources());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_worker_resources()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_total_shared_off_heap(), other.is_set_total_shared_off_heap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_total_shared_off_heap()) {
  ...
  private static class AssignmentTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<Assignment> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, Assignment struct) throws org.apache.storm.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.storm.thrift.protocol.TMap _map776 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.STRING); 
      ...
      if (incoming.get(1)) {
        {
          org.apache.storm.thrift.protocol.TMap _map780 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.LIST, org.apache.storm.thrift.protocol.TType.STRUCT); 
          ...
          {
            {
              org.apache.storm.thrift.protocol.TList _list784 = iprot.readListBegin(org.apache.storm.thrift.protocol.TType.I64);
      ...
      if (incoming.get(2)) {
        {
          org.apache.storm.thrift.protocol.TMap _map787 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.LIST, org.apache.storm.thrift.protocol.TType.I64); 
          ...
          {
            {
              org.apache.storm.thrift.protocol.TList _list791 = iprot.readListBegin(org.apache.storm.thrift.protocol.TType.I64);
      ...
      if (incoming.get(3)) {
        {
          org.apache.storm.thrift.protocol.TMap _map794 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRUCT, org.apache.storm.thrift.protocol.TType.STRUCT); 
      ...
      if (incoming.get(4)) {
        {
          org.apache.storm.thrift.protocol.TMap _map798 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.DOUBLE); 
