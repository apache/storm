...
public class DistributedRPCInvocations {
  ...
  public static class Processor<I extends Iface> extends org.apache.storm.thrift.TBaseProcessor<I> implements org.apache.storm.thrift.TProcessor {
    ...
    public static class result<I extends Iface> extends org.apache.storm.thrift.ProcessFunction<I, result_args, result_result> {
      public result() {
        super("result");
      }
      ...
      @Override
      public result_result getEmptyResultInstance() {
        return new result_result();
      }

      @Override
      public result_result getResult(I iface, result_args args) throws org.apache.storm.thrift.TException {
        result_result result = getEmptyResultInstance();
        try {
    ...
    public static class fetchRequest<I extends Iface> extends org.apache.storm.thrift.ProcessFunction<I, fetchRequest_args, fetchRequest_result> {
      public fetchRequest() {
        super("fetchRequest");
      }
      ...
      @Override
      public fetchRequest_result getEmptyResultInstance() {
        return new fetchRequest_result();
      }

      @Override
      public fetchRequest_result getResult(I iface, fetchRequest_args args) throws org.apache.storm.thrift.TException {
        fetchRequest_result result = getEmptyResultInstance();
        try {
    ...
    public static class failRequest<I extends Iface> extends org.apache.storm.thrift.ProcessFunction<I, failRequest_args, failRequest_result> {
      public failRequest() {
        super("failRequest");
      }
      ...
      @Override
      public failRequest_result getEmptyResultInstance() {
        return new failRequest_result();
      }

      @Override
      public failRequest_result getResult(I iface, failRequest_args args) throws org.apache.storm.thrift.TException {
        failRequest_result result = getEmptyResultInstance();
        try {
    ...
    public static class failRequestV2<I extends Iface> extends org.apache.storm.thrift.ProcessFunction<I, failRequestV2_args, failRequestV2_result> {
      ...
      @Override
      public failRequestV2_result getEmptyResultInstance() {
        return new failRequestV2_result();
      }

      @Override
      public failRequestV2_result getResult(I iface, failRequestV2_args args) throws org.apache.storm.thrift.TException {
        failRequestV2_result result = getEmptyResultInstance();
        try {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.storm.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class result<I extends AsyncIface> extends org.apache.storm.thrift.AsyncProcessFunction<I, result_args, Void, result_result> {
      public result() {
        super("result");
      }
    ...
    public static class fetchRequest<I extends AsyncIface> extends org.apache.storm.thrift.AsyncProcessFunction<I, fetchRequest_args, DRPCRequest, fetchRequest_result> {
      public fetchRequest() {
        super("fetchRequest");
      }
    ...
    public static class failRequest<I extends AsyncIface> extends org.apache.storm.thrift.AsyncProcessFunction<I, failRequest_args, Void, failRequest_result> {
      public failRequest() {
        super("failRequest");
      }
    ...
    public static class failRequestV2<I extends AsyncIface> extends org.apache.storm.thrift.AsyncProcessFunction<I, failRequestV2_args, Void, failRequestV2_result> {
      public failRequestV2() {
        super("failRequestV2");
      }
  ...
  public static class result_args implements org.apache.storm.thrift.TBase<result_args, result_args._Fields>, java.io.Serializable, Cloneable, Comparable<result_args>   {
    ...
    public int compareTo(result_args other) {
      ...
      lastComparison = java.lang.Boolean.compare(is_set_result(), other.is_set_result());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (is_set_result()) {
