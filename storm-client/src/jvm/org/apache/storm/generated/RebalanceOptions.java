...
public class RebalanceOptions implements org.apache.storm.thrift.TBase<RebalanceOptions, RebalanceOptions._Fields>, java.io.Serializable, Cloneable, Comparable<RebalanceOptions> {
  ...
  public int compareTo(RebalanceOptions other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_topology_resources_overrides(), other.is_set_topology_resources_overrides());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_topology_resources_overrides()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_topology_conf_overrides(), other.is_set_topology_conf_overrides());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_topology_conf_overrides()) {
  ...
  private static class RebalanceOptionsTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<RebalanceOptions> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, RebalanceOptions struct) throws org.apache.storm.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.storm.thrift.protocol.TMap _map634 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.I32); 
      ...
      if (incoming.get(3)) {
        {
          org.apache.storm.thrift.protocol.TMap _map638 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.MAP); 
          ...
          for (int _i641 = 0; _i641 < _map638.size; ++_i641)
          {
            ...
            {
              org.apache.storm.thrift.protocol.TMap _map642 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.DOUBLE); 
