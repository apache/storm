        ...
        switch (schemeField.id) {
          case 1: // SERIALIZED_PARTS
            if (schemeField.type == org.apache.storm.thrift.protocol.TType.MAP) {
              {
                org.apache.storm.thrift.protocol.TMap _map840 = iprot.readMapBegin();
                struct.serialized_parts = new java.util.HashMap<java.lang.String,ThriftSerializedObject>(2*_map840.size);
                @org.apache.storm.thrift.annotation.Nullable java.lang.String _key841;
                @org.apache.storm.thrift.annotation.Nullable ThriftSerializedObject _val842;
                for (int _i843 = 0; _i843 < _map840.size; ++_i843)
                {
                  _key841 = iprot.readString();
                  _val842 = new ThriftSerializedObject();
                  _val842.read(iprot);
                  struct.serialized_parts.put(_key841, _val842);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.storm.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.storm.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, ThriftSerializedObject> _iter844 : struct.serialized_parts.entrySet())
          {
            oprot.writeString(_iter844.getKey());
            _iter844.getValue().write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class LocalStateDataTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.storm.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.storm.thrift.TException {
      org.apache.storm.thrift.protocol.TTupleProtocol oprot = (org.apache.storm.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.lang.String, ThriftSerializedObject> _iter845 : struct.serialized_parts.entrySet())
        {
          oprot.writeString(_iter845.getKey());
          _iter845.getValue().write(oprot);
        }
      }
    }
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.storm.thrift.TException {
      ...
      {
        org.apache.storm.thrift.protocol.TMap _map846 = new org.apache.storm.thrift.protocol.TMap(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.serialized_parts = new java.util.HashMap<java.lang.String,ThriftSerializedObject>(2*_map846.size);
        @org.apache.storm.thrift.annotation.Nullable java.lang.String _key847;
        @org.apache.storm.thrift.annotation.Nullable ThriftSerializedObject _val848;
        for (int _i849 = 0; _i849 < _map846.size; ++_i849)
        {
          _key847 = iprot.readString();
          _val848 = new ThriftSerializedObject();
          _val848.read(iprot);
          struct.serialized_parts.put(_key847, _val848);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
