        ...
        switch (schemeField.id) {
          case 1: // SERIALIZED_PARTS
            if (schemeField.type == org.apache.storm.thrift.protocol.TType.MAP) {
              {
                org.apache.storm.thrift.protocol.TMap _map790 = iprot.readMapBegin();
                struct.serialized_parts = new java.util.HashMap<java.lang.String,ThriftSerializedObject>(2*_map790.size);
                @org.apache.storm.thrift.annotation.Nullable java.lang.String _key791;
                @org.apache.storm.thrift.annotation.Nullable ThriftSerializedObject _val792;
                for (int _i793 = 0; _i793 < _map790.size; ++_i793)
                {
                  _key791 = iprot.readString();
                  _val792 = new ThriftSerializedObject();
                  _val792.read(iprot);
                  struct.serialized_parts.put(_key791, _val792);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.storm.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.storm.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, ThriftSerializedObject> _iter794 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.storm.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.storm.thrift.TException {
      org.apache.storm.thrift.protocol.TTupleProtocol oprot = (org.apache.storm.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.lang.String, ThriftSerializedObject> _iter795 : struct.serialized_parts.entrySet())
        {
          oprot.writeString(_iter795.getKey());
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.storm.thrift.TException {
      ...
      {
        org.apache.storm.thrift.protocol.TMap _map796 = new org.apache.storm.thrift.protocol.TMap(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.serialized_parts = new java.util.HashMap<java.lang.String,ThriftSerializedObject>(2*_map796.size);
        @org.apache.storm.thrift.annotation.Nullable java.lang.String _key797;
        @org.apache.storm.thrift.annotation.Nullable ThriftSerializedObject _val798;
        for (int _i799 = 0; _i799 < _map796.size; ++_i799)
        {
          _key797 = iprot.readString();
          _val798 = new ThriftSerializedObject();
          _val798.read(iprot);
          struct.serialized_parts.put(_key797, _val798);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
