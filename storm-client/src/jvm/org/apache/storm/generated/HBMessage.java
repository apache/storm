...
public class HBMessage implements org.apache.storm.thrift.TBase<HBMessage, HBMessage._Fields>, java.io.Serializable, Cloneable, Comparable<HBMessage> {
  ...
  public int compareTo(HBMessage other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_data(), other.is_set_data());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_data()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_message_id(), other.is_set_message_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_message_id()) {
