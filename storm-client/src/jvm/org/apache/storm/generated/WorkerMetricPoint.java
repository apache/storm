...
public class WorkerMetricPoint implements org.apache.storm.thrift.TBase<WorkerMetricPoint, WorkerMetricPoint._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerMetricPoint> {
  ...
  public int compareTo(WorkerMetricPoint other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_metricName(), other.is_set_metricName());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_timestamp(), other.is_set_timestamp());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_timestamp()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_metricValue(), other.is_set_metricValue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(is_set_componentId(), other.is_set_componentId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_componentId()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_executorId(), other.is_set_executorId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_executorId()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_streamId(), other.is_set_streamId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_streamId()) {
