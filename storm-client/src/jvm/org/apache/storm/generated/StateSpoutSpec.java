...
public class StateSpoutSpec implements org.apache.storm.thrift.TBase<StateSpoutSpec, StateSpoutSpec._Fields>, java.io.Serializable, Cloneable, Comparable<StateSpoutSpec> {
  ...
  private @org.apache.storm.thrift.annotation.Nullable ComponentObject state_spout_object; // required
  ...
  public void set_state_spout_object(@org.apache.storm.thrift.annotation.Nullable ComponentObject state_spout_object) {
    this.state_spout_object = state_spout_object;
  }
  ...
  public int compareTo(StateSpoutSpec other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_state_spout_object(), other.is_set_state_spout_object());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_common(), other.is_set_common());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_common()) {
