...
public class LogLevel implements org.apache.storm.thrift.TBase<LogLevel, LogLevel._Fields>, java.io.Serializable, Cloneable, Comparable<LogLevel> {
  ...
  private @org.apache.storm.thrift.annotation.Nullable LogLevelAction action; // required
  private @org.apache.storm.thrift.annotation.Nullable java.lang.String target_log_level; // optional
   ...
   * @see LogLevelAction
   */
  public void set_action(@org.apache.storm.thrift.annotation.Nullable LogLevelAction action) {
    this.action = action;
  }
  ...
  public void set_target_log_level(@org.apache.storm.thrift.annotation.Nullable java.lang.String target_log_level) {
  ...
  public void set_reset_log_level(@org.apache.storm.thrift.annotation.Nullable java.lang.String reset_log_level) {
  ...
  public int compareTo(LogLevel other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_target_log_level(), other.is_set_target_log_level());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_target_log_level()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_reset_log_level_timeout_secs(), other.is_set_reset_log_level_timeout_secs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_reset_log_level_timeout_secs()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_reset_log_level_timeout_epoch(), other.is_set_reset_log_level_timeout_epoch());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_reset_log_level_timeout_epoch()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_reset_log_level(), other.is_set_reset_log_level());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_reset_log_level()) {
