...
public class BoltStats implements org.apache.storm.thrift.TBase<BoltStats, BoltStats._Fields>, java.io.Serializable, Cloneable, Comparable<BoltStats> {
  ...
  public int compareTo(BoltStats other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_acked(), other.is_set_acked());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_failed(), other.is_set_failed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_failed()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_process_ms_avg(), other.is_set_process_ms_avg());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_process_ms_avg()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_execute_ms_avg(), other.is_set_execute_ms_avg());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_execute_ms_avg()) {
  ...
  private static class BoltStatsTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<BoltStats> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, BoltStats struct) throws org.apache.storm.thrift.TException {
      ...
      {
        org.apache.storm.thrift.protocol.TMap _map250 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.MAP); 
        ...
        for (int _i253 = 0; _i253 < _map250.size; ++_i253)
        {
          ...
          {
            org.apache.storm.thrift.protocol.TMap _map254 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRUCT, org.apache.storm.thrift.protocol.TType.I64); 
      ...
      struct.set_acked_isSet(true);
      {
        org.apache.storm.thrift.protocol.TMap _map258 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.MAP); 
        ...
        for (int _i261 = 0; _i261 < _map258.size; ++_i261)
        {
          ...
          {
            org.apache.storm.thrift.protocol.TMap _map262 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRUCT, org.apache.storm.thrift.protocol.TType.I64); 
      ...
      struct.set_failed_isSet(true);
      {
        org.apache.storm.thrift.protocol.TMap _map266 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.MAP); 
        ...
        for (int _i269 = 0; _i269 < _map266.size; ++_i269)
        {
          ...
          {
            org.apache.storm.thrift.protocol.TMap _map270 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRUCT, org.apache.storm.thrift.protocol.TType.DOUBLE); 
      ...
      struct.set_process_ms_avg_isSet(true);
      {
        org.apache.storm.thrift.protocol.TMap _map274 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.MAP); 
        ...
        for (int _i277 = 0; _i277 < _map274.size; ++_i277)
        {
          ...
          {
            org.apache.storm.thrift.protocol.TMap _map278 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRUCT, org.apache.storm.thrift.protocol.TType.I64); 
      ...
      struct.set_executed_isSet(true);
      {
        org.apache.storm.thrift.protocol.TMap _map282 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.MAP); 
        ...
        for (int _i285 = 0; _i285 < _map282.size; ++_i285)
        {
          ...
          {
            org.apache.storm.thrift.protocol.TMap _map286 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRUCT, org.apache.storm.thrift.protocol.TType.DOUBLE); 
