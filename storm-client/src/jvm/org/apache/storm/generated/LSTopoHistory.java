...
public class LSTopoHistory implements org.apache.storm.thrift.TBase<LSTopoHistory, LSTopoHistory._Fields>, java.io.Serializable, Cloneable, Comparable<LSTopoHistory> {
  ...
  public int compareTo(LSTopoHistory other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_time_stamp(), other.is_set_time_stamp());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(is_set_users(), other.is_set_users());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_users()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_groups(), other.is_set_groups());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_groups()) {
  ...
  private static class LSTopoHistoryTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<LSTopoHistory> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, LSTopoHistory struct) throws org.apache.storm.thrift.TException {
      ...
      struct.set_time_stamp_isSet(true);
      {
        org.apache.storm.thrift.protocol.TList _list888 = iprot.readListBegin(org.apache.storm.thrift.protocol.TType.STRING);
      ...
      struct.set_users_isSet(true);
      {
        org.apache.storm.thrift.protocol.TList _list891 = iprot.readListBegin(org.apache.storm.thrift.protocol.TType.STRING);
