...
public class ExecutorInfo implements org.apache.storm.thrift.TBase<ExecutorInfo, ExecutorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ExecutorInfo> {
  ...
  public int compareTo(ExecutorInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_task_start(), other.is_set_task_start());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_task_end(), other.is_set_task_end());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_task_end()) {
