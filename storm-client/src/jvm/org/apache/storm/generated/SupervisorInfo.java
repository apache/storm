...
public class SupervisorInfo implements org.apache.storm.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
  ...
  public int compareTo(SupervisorInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_hostname(), other.is_set_hostname());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_hostname()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_assignment_id(), other.is_set_assignment_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_assignment_id()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_used_ports(), other.is_set_used_ports());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_used_ports()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_scheduler_meta(), other.is_set_scheduler_meta());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_scheduler_meta()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_server_port(), other.is_set_server_port());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_server_port()) {
  ...
  private static class SupervisorInfoTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<SupervisorInfo> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, SupervisorInfo struct) throws org.apache.storm.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.storm.thrift.protocol.TList _list694 = iprot.readListBegin(org.apache.storm.thrift.protocol.TType.I64);
      ...
      if (incoming.get(2)) {
        {
          org.apache.storm.thrift.protocol.TList _list697 = iprot.readListBegin(org.apache.storm.thrift.protocol.TType.I64);
      ...
      if (incoming.get(3)) {
        {
          org.apache.storm.thrift.protocol.TMap _map700 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.STRING); 
      ...
      if (incoming.get(6)) {
        {
          org.apache.storm.thrift.protocol.TMap _map704 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.DOUBLE); 
