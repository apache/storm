...
public class SpoutSpec implements org.apache.storm.thrift.TBase<SpoutSpec, SpoutSpec._Fields>, java.io.Serializable, Cloneable, Comparable<SpoutSpec> {
  ...
  private @org.apache.storm.thrift.annotation.Nullable ComponentObject spout_object; // required
  ...
  public void set_spout_object(@org.apache.storm.thrift.annotation.Nullable ComponentObject spout_object) {
    this.spout_object = spout_object;
  }
  ...
  public int compareTo(SpoutSpec other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_spout_object(), other.is_set_spout_object());
    if (lastComparison != 0) {
