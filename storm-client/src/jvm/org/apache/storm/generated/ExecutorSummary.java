...
public class ExecutorSummary implements org.apache.storm.thrift.TBase<ExecutorSummary, ExecutorSummary._Fields>, java.io.Serializable, Cloneable, Comparable<ExecutorSummary> {
  ...
  private @org.apache.storm.thrift.annotation.Nullable ExecutorInfo executor_info; // required
  ...
  public void set_executor_info(@org.apache.storm.thrift.annotation.Nullable ExecutorInfo executor_info) {
    this.executor_info = executor_info;
  }
  ...
  public void set_stats(@org.apache.storm.thrift.annotation.Nullable ExecutorStats stats) {
    this.stats = stats;
  }
  ...
  public int compareTo(ExecutorSummary other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_executor_info(), other.is_set_executor_info());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_stats(), other.is_set_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_stats()) {
