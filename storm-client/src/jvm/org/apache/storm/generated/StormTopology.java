...
public class StormTopology implements org.apache.storm.thrift.TBase<StormTopology, StormTopology._Fields>, java.io.Serializable, Cloneable, Comparable<StormTopology> {
  ...
  public int compareTo(StormTopology other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_spouts(), other.is_set_spouts());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_bolts(), other.is_set_bolts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_bolts()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_state_spouts(), other.is_set_state_spouts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_state_spouts()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_worker_hooks(), other.is_set_worker_hooks());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_worker_hooks()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_dependency_jars(), other.is_set_dependency_jars());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_dependency_jars()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_dependency_artifacts(), other.is_set_dependency_artifacts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_dependency_artifacts()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_jdk_version(), other.is_set_jdk_version());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_jdk_version()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_component_to_shared_memory(), other.is_set_component_to_shared_memory());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_component_to_shared_memory()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_shared_memory(), other.is_set_shared_memory());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_shared_memory()) {
  ...
  private static class StormTopologyTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<StormTopology> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, StormTopology struct) throws org.apache.storm.thrift.TException {
      ...
      {
        org.apache.storm.thrift.protocol.TMap _map94 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.STRUCT); 
      ...
      struct.set_spouts_isSet(true);
      {
        org.apache.storm.thrift.protocol.TMap _map98 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.STRUCT); 
      ...
      struct.set_bolts_isSet(true);
      {
        org.apache.storm.thrift.protocol.TMap _map102 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.STRUCT); 
      ...
      if (incoming.get(0)) {
        {
          org.apache.storm.thrift.protocol.TList _list106 = iprot.readListBegin(org.apache.storm.thrift.protocol.TType.STRING);
      ...
      if (incoming.get(1)) {
        {
          org.apache.storm.thrift.protocol.TList _list109 = iprot.readListBegin(org.apache.storm.thrift.protocol.TType.STRING);
      ...
      if (incoming.get(2)) {
        {
          org.apache.storm.thrift.protocol.TList _list112 = iprot.readListBegin(org.apache.storm.thrift.protocol.TType.STRING);
      ...
      if (incoming.get(5)) {
        {
          org.apache.storm.thrift.protocol.TMap _map115 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.SET); 
          ...
          for (int _i118 = 0; _i118 < _map115.size; ++_i118)
          {
            ...
            {
              org.apache.storm.thrift.protocol.TSet _set119 = iprot.readSetBegin(org.apache.storm.thrift.protocol.TType.STRING);
      ...
      if (incoming.get(6)) {
        {
          org.apache.storm.thrift.protocol.TMap _map122 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.STRUCT); 
