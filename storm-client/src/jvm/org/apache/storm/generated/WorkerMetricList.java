...
public class WorkerMetricList implements org.apache.thrift.TBase<WorkerMetricList, WorkerMetricList._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerMetricList> {
  ...
  private List<WorkerMetric> metrics; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.METRICS, new org.apache.thrift.meta_data.FieldMetaData("metrics", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, WorkerMetric.class))));
  ...
  public WorkerMetricList(WorkerMetricList other) {
    if (other.is_set_metrics()) {
      List<WorkerMetric> __this__metrics = new ArrayList<WorkerMetric>(other.metrics.size());
      for (WorkerMetric other_element : other.metrics) {
        __this__metrics.add(new WorkerMetric(other_element));
      }
  ...
  public java.util.Iterator<WorkerMetric> get_metrics_iterator() {
    return (this.metrics == null) ? null : this.metrics.iterator();
  }

  public void add_to_metrics(WorkerMetric elem) {
    if (this.metrics == null) {
      this.metrics = new ArrayList<WorkerMetric>();
    }
    this.metrics.add(elem);
  }

  public List<WorkerMetric> get_metrics() {
    return this.metrics;
  }

  public void set_metrics(List<WorkerMetric> metrics) {
    this.metrics = metrics;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case METRICS:
      if (value == null) {
        ...
        set_metrics((List<WorkerMetric>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metrics = new ArrayList<WorkerMetric>(_list886.size);
                WorkerMetric _elem887;
                for (int _i888 = 0; _i888 < _list886.size; ++_i888)
                {
                  _elem887 = new WorkerMetric();
                  _elem887.read(iprot);
                  struct.metrics.add(_elem887);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WorkerMetricList struct) throws org.apache.thrift.TException {
      ...
      if (struct.metrics != null) {
        oprot.writeFieldBegin(METRICS_FIELD_DESC);
        {
          ...
          for (WorkerMetric _iter889 : struct.metrics)
          {
      ...
      if (struct.is_set_metrics()) {
        {
          ...
          for (WorkerMetric _iter890 : struct.metrics)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.metrics = new ArrayList<WorkerMetric>(_list891.size);
          WorkerMetric _elem892;
          for (int _i893 = 0; _i893 < _list891.size; ++_i893)
          {
            _elem892 = new WorkerMetric();
            _elem892.read(iprot);
            struct.metrics.add(_elem892);
          }
        }
        struct.set_metrics_isSet(true);
      }
