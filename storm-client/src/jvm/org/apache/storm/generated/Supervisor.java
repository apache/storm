...
public class Supervisor {
  ...
  public static class Processor<I extends Iface> extends org.apache.storm.thrift.TBaseProcessor<I> implements org.apache.storm.thrift.TProcessor {
    ...
    public Processor(I iface) {
      super(iface, getProcessMap(new java.util.HashMap<java.lang.String, org.apache.storm.thrift.ProcessFunction<I, ? extends org.apache.storm.thrift.TBase, ? extends org.apache.storm.thrift.TBase>>()));
    }

    protected Processor(I iface, java.util.Map<java.lang.String, org.apache.storm.thrift.ProcessFunction<I, ? extends org.apache.storm.thrift.TBase, ? extends org.apache.storm.thrift.TBase>> processMap) {
      super(iface, getProcessMap(processMap));
    }

    private static <I extends Iface> java.util.Map<java.lang.String, org.apache.storm.thrift.ProcessFunction<I, ? extends org.apache.storm.thrift.TBase, ? extends org.apache.storm.thrift.TBase>> getProcessMap(java.util.Map<java.lang.String, org.apache.storm.thrift.ProcessFunction<I, ? extends  org.apache.storm.thrift.TBase, ? extends org.apache.storm.thrift.TBase>> processMap) {
    ...
    public static class sendSupervisorAssignments<I extends Iface> extends org.apache.storm.thrift.ProcessFunction<I, sendSupervisorAssignments_args, sendSupervisorAssignments_result> {
      ...
      @Override
      public sendSupervisorAssignments_result getEmptyResultInstance() {
        return new sendSupervisorAssignments_result();
      }
      ...
      public sendSupervisorAssignments_result getResult(I iface, sendSupervisorAssignments_args args) throws org.apache.storm.thrift.TException {
        sendSupervisorAssignments_result result = getEmptyResultInstance();
        try {
    ...
    public static class getLocalAssignmentForStorm<I extends Iface> extends org.apache.storm.thrift.ProcessFunction<I, getLocalAssignmentForStorm_args, getLocalAssignmentForStorm_result> {
      ...
      @Override
      public getLocalAssignmentForStorm_result getEmptyResultInstance() {
        return new getLocalAssignmentForStorm_result();
      }
      ...
      public getLocalAssignmentForStorm_result getResult(I iface, getLocalAssignmentForStorm_args args) throws org.apache.storm.thrift.TException {
        getLocalAssignmentForStorm_result result = getEmptyResultInstance();
        try {
    ...
    public static class sendSupervisorWorkerHeartbeat<I extends Iface> extends org.apache.storm.thrift.ProcessFunction<I, sendSupervisorWorkerHeartbeat_args, sendSupervisorWorkerHeartbeat_result> {
      ...
      @Override
      public sendSupervisorWorkerHeartbeat_result getEmptyResultInstance() {
        return new sendSupervisorWorkerHeartbeat_result();
      }
      ...
      public sendSupervisorWorkerHeartbeat_result getResult(I iface, sendSupervisorWorkerHeartbeat_args args) throws org.apache.storm.thrift.TException {
        sendSupervisorWorkerHeartbeat_result result = getEmptyResultInstance();
        try {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.storm.thrift.TBaseAsyncProcessor<I> {
    ...
    public AsyncProcessor(I iface) {
      super(iface, getProcessMap(new java.util.HashMap<java.lang.String, org.apache.storm.thrift.AsyncProcessFunction<I, ? extends org.apache.storm.thrift.TBase, ?, ? extends org.apache.storm.thrift.TBase>>()));
    }

    protected AsyncProcessor(I iface, java.util.Map<java.lang.String,  org.apache.storm.thrift.AsyncProcessFunction<I, ? extends  org.apache.storm.thrift.TBase, ?, ? extends org.apache.storm.thrift.TBase>> processMap) {
      super(iface, getProcessMap(processMap));
    }

    private static <I extends AsyncIface> java.util.Map<java.lang.String,  org.apache.storm.thrift.AsyncProcessFunction<I, ? extends  org.apache.storm.thrift.TBase, ?, ? extends org.apache.storm.thrift.TBase>> getProcessMap(java.util.Map<java.lang.String,  org.apache.storm.thrift.AsyncProcessFunction<I, ? extends  org.apache.storm.thrift.TBase, ?, ? extends org.apache.storm.thrift.TBase>> processMap) {
      processMap.put("sendSupervisorAssignments", new sendSupervisorAssignments());
      processMap.put("getLocalAssignmentForStorm", new getLocalAssignmentForStorm());
      processMap.put("sendSupervisorWorkerHeartbeat", new sendSupervisorWorkerHeartbeat());
      return processMap;
    ...
    public static class sendSupervisorAssignments<I extends AsyncIface> extends org.apache.storm.thrift.AsyncProcessFunction<I, sendSupervisorAssignments_args, Void, sendSupervisorAssignments_result> {
      public sendSupervisorAssignments() {
        super("sendSupervisorAssignments");
      }
    ...
    public static class getLocalAssignmentForStorm<I extends AsyncIface> extends org.apache.storm.thrift.AsyncProcessFunction<I, getLocalAssignmentForStorm_args, Assignment, getLocalAssignmentForStorm_result> {
      public getLocalAssignmentForStorm() {
        super("getLocalAssignmentForStorm");
      }
    ...
    public static class sendSupervisorWorkerHeartbeat<I extends AsyncIface> extends org.apache.storm.thrift.AsyncProcessFunction<I, sendSupervisorWorkerHeartbeat_args, Void, sendSupervisorWorkerHeartbeat_result> {
      public sendSupervisorWorkerHeartbeat() {
        super("sendSupervisorWorkerHeartbeat");
      }
  ...
  public static class sendSupervisorAssignments_args implements org.apache.storm.thrift.TBase<sendSupervisorAssignments_args, sendSupervisorAssignments_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendSupervisorAssignments_args>   {
    ...
    public int compareTo(sendSupervisorAssignments_args other) {
      ...
      lastComparison = java.lang.Boolean.compare(is_set_assignments(), other.is_set_assignments());
      if (lastComparison != 0) {
  ...
  public static class sendSupervisorWorkerHeartbeat_args implements org.apache.storm.thrift.TBase<sendSupervisorWorkerHeartbeat_args, sendSupervisorWorkerHeartbeat_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendSupervisorWorkerHeartbeat_args>   {
    ...
    public int compareTo(sendSupervisorWorkerHeartbeat_args other) {
      ...
      lastComparison = java.lang.Boolean.compare(is_set_heartbeat(), other.is_set_heartbeat());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (is_set_heartbeat()) {
