...
public class WorkerTokenInfo implements org.apache.storm.thrift.TBase<WorkerTokenInfo, WorkerTokenInfo._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerTokenInfo> {
  ...
  public int compareTo(WorkerTokenInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_userName(), other.is_set_userName());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_topologyId(), other.is_set_topologyId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_topologyId()) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_secretVersion(), other.is_set_secretVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(is_set_expirationTimeMillis(), other.is_set_expirationTimeMillis());
    if (lastComparison != 0) {
      return lastComparison;
    }
