...
public class SpoutStats implements org.apache.storm.thrift.TBase<SpoutStats, SpoutStats._Fields>, java.io.Serializable, Cloneable, Comparable<SpoutStats> {
  ...
  public int compareTo(SpoutStats other) {
    ...
    lastComparison = java.lang.Boolean.compare(is_set_complete_ms_avg(), other.is_set_complete_ms_avg());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_complete_ms_avg()) {
  ...
  private static class SpoutStatsTupleScheme extends org.apache.storm.thrift.scheme.TupleScheme<SpoutStats> {
    ...
    public void read(org.apache.storm.thrift.protocol.TProtocol prot, SpoutStats struct) throws org.apache.storm.thrift.TException {
      ...
      {
        org.apache.storm.thrift.protocol.TMap _map326 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.MAP); 
        ...
        for (int _i329 = 0; _i329 < _map326.size; ++_i329)
        {
          ...
          {
            org.apache.storm.thrift.protocol.TMap _map330 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.I64); 
      ...
      struct.set_acked_isSet(true);
      {
        org.apache.storm.thrift.protocol.TMap _map334 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.MAP); 
        ...
        for (int _i337 = 0; _i337 < _map334.size; ++_i337)
        {
          ...
          {
            org.apache.storm.thrift.protocol.TMap _map338 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.I64); 
      ...
      struct.set_failed_isSet(true);
      {
        org.apache.storm.thrift.protocol.TMap _map342 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.MAP); 
        ...
        for (int _i345 = 0; _i345 < _map342.size; ++_i345)
        {
          ...
          {
            org.apache.storm.thrift.protocol.TMap _map346 = iprot.readMapBegin(org.apache.storm.thrift.protocol.TType.STRING, org.apache.storm.thrift.protocol.TType.DOUBLE); 
