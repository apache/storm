...
public interface EvictionContext {
    /**
     * Returns the reference time that the eviction policy could use to evict the events. In the case of event time processing, this would
     * be the watermark time.
     *
