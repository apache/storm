...
/**
 * Node that holds partitioning/grouping information. This is used for operations like groupBy (fields grouping), global aggregate/reduce
 * (global grouping), state query (all grouping).
 */
