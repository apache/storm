...
import org.apache.storm.metrics2.BoltExecutorMetrics;
...
public class BoltExecutor extends Executor {
    ...
    private BoltExecutorMetrics executorMetrics;
    ...
    public BoltExecutor(WorkerState workerData, List<Long> executorId, Map<String, String> credentials) {
        ...
        this.executorMetrics = new BoltExecutorMetrics(workerTopologyContext, workerData.getMetricRegistry(), topoConf);
    }
    ...
    public void tupleActionFn(int taskId, TupleImpl tuple) throws Exception {
        ...
        if (Constants.SYSTEM_FLUSH_STREAM_ID.equals(streamId)) {
            ...
            if (delta >= 0) {
                executorMetrics.boltExecuteTuple(tuple.getSourceComponent(),
                        tuple.getSourceStreamId(), taskId, delta);
            }
        }
    }
}
