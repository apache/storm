...
public class StringMetadataCache implements LRUMap.CacheEvictionCallback<String, StringMetadata>,
    ...
    /**
     * Add the string metadata to the cache.  Note, this can cause data to be evicted
     * from the cache when full.  When this occurs, the evictionCallback() method
     * is called to store the metadata back into the RocksDB database.  This method is only exposed to
     * the WritableStringMetadataCache interface
     *
     ...
     */
    public void put(String s, StringMetadata stringMetadata) throws MetricException {
