...
class SupervisorSummary:
  ...
  thrift_spec = (
    ...
    (7, TType.MAP, 'system_stats', (TType.STRING,None,TType.DOUBLE,None), None, ), # 7
  )

  def __init__(self, host=None, uptime_secs=None, num_workers=None, num_used_workers=None, supervisor_id=None, version=thrift_spec[6][4], system_stats=None,):
    self.host = host
    self.uptime_secs = uptime_secs
    self.num_workers = num_workers
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i70 in xrange(_size66):
            ...
            self.system_stats[_key71] = _val72
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.version is not None:
      ...
      oprot.writeFieldEnd()
    if self.system_stats is not None:
      oprot.writeFieldBegin('system_stats', TType.MAP, 7)
      oprot.writeMapBegin(TType.STRING, TType.DOUBLE, len(self.system_stats))
      for kiter73,viter74 in self.system_stats.items():
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.system_stats)
    return value
...
class ClusterSummary:
  ...
  def write(self, oprot):
    ...
    if self.supervisors is not None:
      ...
      for iter87 in self.supervisors:
        iter87.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class BoltStats:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i93 in xrange(_size89):
            _key94 = iprot.readString().decode('utf-8')
            _val95 = {}
            (_ktype97, _vtype98, _size96 ) = iprot.readMapBegin()
            for _i100 in xrange(_size96):
              _key101 = GlobalStreamId()
              _key101.read(iprot)
              _val102 = iprot.readI64();
              _val95[_key101] = _val102
            iprot.readMapEnd()
            self.acked[_key94] = _val95
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        ...
        if ftype == TType.MAP:
          ...
          for _i121 in xrange(_size117):
            ...
            iprot.readMapEnd()
            self.process_ms_avg[_key122] = _val123
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        ...
        if ftype == TType.MAP:
          ...
          for _i149 in xrange(_size145):
            ...
            iprot.readMapEnd()
            self.execute_ms_avg[_key150] = _val151
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.acked is not None:
      ...
      for kiter159,viter160 in self.acked.items():
        oprot.writeString(kiter159.encode('utf-8'))
    ...
    if self.failed is not None:
      ...
      for kiter163,viter164 in self.failed.items():
        oprot.writeString(kiter163.encode('utf-8'))
        oprot.writeMapBegin(TType.STRUCT, TType.I64, len(viter164))
        for kiter165,viter166 in viter164.items():
          kiter165.write(oprot)
          oprot.writeI64(viter166)
        oprot.writeMapEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.process_ms_avg is not None:
      ...
      for kiter167,viter168 in self.process_ms_avg.items():
        oprot.writeString(kiter167.encode('utf-8'))
        oprot.writeMapBegin(TType.STRUCT, TType.DOUBLE, len(viter168))
        for kiter169,viter170 in viter168.items():
          kiter169.write(oprot)
          oprot.writeDouble(viter170)
        oprot.writeMapEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.executed is not None:
      ...
      for kiter171,viter172 in self.executed.items():
        oprot.writeString(kiter171.encode('utf-8'))
        oprot.writeMapBegin(TType.STRUCT, TType.I64, len(viter172))
        for kiter173,viter174 in viter172.items():
          kiter173.write(oprot)
          oprot.writeI64(viter174)
        oprot.writeMapEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.execute_ms_avg is not None:
      ...
      for kiter175,viter176 in self.execute_ms_avg.items():
        oprot.writeString(kiter175.encode('utf-8'))
        oprot.writeMapBegin(TType.STRUCT, TType.DOUBLE, len(viter176))
...
class SpoutStats:
  ...
  def write(self, oprot):
    ...
    if self.acked is not None:
      oprot.writeFieldBegin('acked', TType.MAP, 1)
      oprot.writeMapBegin(TType.STRING, TType.MAP, len(self.acked))
      for kiter221,viter222 in self.acked.items():
        oprot.writeString(kiter221.encode('utf-8'))
        oprot.writeMapBegin(TType.STRING, TType.I64, len(viter222))
    ...
    if self.failed is not None:
      oprot.writeFieldBegin('failed', TType.MAP, 2)
      oprot.writeMapBegin(TType.STRING, TType.MAP, len(self.failed))
      for kiter225,viter226 in self.failed.items():
        oprot.writeString(kiter225.encode('utf-8'))
        oprot.writeMapBegin(TType.STRING, TType.I64, len(viter226))
        for kiter227,viter228 in viter226.items():
          oprot.writeString(kiter227.encode('utf-8'))
          oprot.writeI64(viter228)
        oprot.writeMapEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.complete_ms_avg is not None:
      ...
      for kiter229,viter230 in self.complete_ms_avg.items():
        oprot.writeString(kiter229.encode('utf-8'))
        oprot.writeMapBegin(TType.STRING, TType.DOUBLE, len(viter230))
        for kiter231,viter232 in viter230.items():
          oprot.writeString(kiter231.encode('utf-8'))
          oprot.writeDouble(viter232)
        oprot.writeMapEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class ExecutorStats:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i251 in xrange(_size247):
            ...
            iprot.readMapEnd()
            self.transferred[_key252] = _val253
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
  ...
  def write(self, oprot):
    ...
    if self.emitted is not None:
      ...
      for kiter261,viter262 in self.emitted.items():
        oprot.writeString(kiter261.encode('utf-8'))
        oprot.writeMapBegin(TType.STRING, TType.I64, len(viter262))
        for kiter263,viter264 in viter262.items():
          oprot.writeString(kiter263.encode('utf-8'))
          oprot.writeI64(viter264)
        oprot.writeMapEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.transferred is not None:
      ...
      for kiter265,viter266 in self.transferred.items():
        oprot.writeString(kiter265.encode('utf-8'))
        oprot.writeMapBegin(TType.STRING, TType.I64, len(viter266))
        for kiter267,viter268 in viter266.items():
          oprot.writeString(kiter267.encode('utf-8'))
          oprot.writeI64(viter268)
        oprot.writeMapEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class TopologyInfo:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i273 in xrange(_size269):
            _elem274 = ExecutorSummary()
            _elem274.read(iprot)
            self.executors.append(_elem274)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.errors is not None:
      ...
      for kiter289,viter290 in self.errors.items():
        oprot.writeString(kiter289.encode('utf-8'))
        oprot.writeListBegin(TType.STRUCT, len(viter290))
...
class SupervisorInfo:
  ...
  thrift_spec = (
    ...
    (9, TType.MAP, 'system_stats', (TType.STRING,None,TType.DOUBLE,None), None, ), # 9
  )

  def __init__(self, time_secs=None, hostname=None, assignment_id=None, used_ports=None, meta=None, scheduler_meta=None, uptime_secs=None, version=None, system_stats=None,):
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i333 in xrange(_size329):
            ...
            self.system_stats[_key334] = _val335
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.version is not None:
      ...
      oprot.writeFieldEnd()
    if self.system_stats is not None:
      oprot.writeFieldBegin('system_stats', TType.MAP, 9)
      oprot.writeMapBegin(TType.STRING, TType.DOUBLE, len(self.system_stats))
      for kiter340,viter341 in self.system_stats.items():
        oprot.writeString(kiter340.encode('utf-8'))
        oprot.writeDouble(viter341)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class Assignment:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i353 in xrange(_size349):
            _key354 = iprot.readString().decode('utf-8')
            _val355 = iprot.readString().decode('utf-8')
            self.node_host[_key354] = _val355
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.MAP:
          ...
          for _i360 in xrange(_size356):
            ...
            for _i367 in xrange(_size363):
              ...
              _key361.append(_elem368)
            iprot.readListEnd()
            _val362 = NodeInfo()
            _val362.read(iprot)
            self.executor_node_port[_key361] = _val362
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.MAP:
          ...
          for _i373 in xrange(_size369):
            ...
            for _i380 in xrange(_size376):
              ...
              _key374.append(_elem381)
            iprot.readListEnd()
            _val375 = iprot.readI64();
            self.executor_start_time_secs[_key374] = _val375
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.node_host is not None:
      ...
      for kiter382,viter383 in self.node_host.items():
        oprot.writeString(kiter382.encode('utf-8'))
        oprot.writeString(viter383.encode('utf-8'))
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.executor_node_port is not None:
      ...
      for kiter384,viter385 in self.executor_node_port.items():
        oprot.writeListBegin(TType.I64, len(kiter384))
        for iter386 in kiter384:
          oprot.writeI64(iter386)
        oprot.writeListEnd()
        viter385.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.executor_start_time_secs is not None:
      ...
      for kiter387,viter388 in self.executor_start_time_secs.items():
        oprot.writeListBegin(TType.I64, len(kiter387))
        for iter389 in kiter387:
          oprot.writeI64(iter389)
        oprot.writeListEnd()
        oprot.writeI64(viter388)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class StormBase:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i394 in xrange(_size390):
            ...
            self.component_executors[_key395] = _val396
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.component_executors is not None:
      ...
      for kiter397,viter398 in self.component_executors.items():
        oprot.writeString(kiter397.encode('utf-8'))
        oprot.writeI32(viter398)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class ClusterWorkerHeartbeat:
  ...
  thrift_spec = (
    ...
    (5, TType.MAP, 'system_stats', (TType.STRING,None,TType.DOUBLE,None), None, ), # 5
  )

  def __init__(self, storm_id=None, executor_stats=None, time_secs=None, uptime_secs=None, system_stats=None,):
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i410 in xrange(_size406):
            ...
            self.system_stats[_key411] = _val412
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.uptime_secs is not None:
      ...
      oprot.writeFieldEnd()
    if self.system_stats is not None:
      oprot.writeFieldBegin('system_stats', TType.MAP, 5)
      oprot.writeMapBegin(TType.STRING, TType.DOUBLE, len(self.system_stats))
      for kiter415,viter416 in self.system_stats.items():
        oprot.writeString(kiter415.encode('utf-8'))
        oprot.writeDouble(viter416)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class LocalStateData:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i421 in xrange(_size417):
            _key422 = iprot.readString().decode('utf-8')
            _val423 = ThriftSerializedObject()
            _val423.read(iprot)
            self.serialized_parts[_key422] = _val423
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.serialized_parts is not None:
      ...
      for kiter424,viter425 in self.serialized_parts.items():
        oprot.writeString(kiter424.encode('utf-8'))
        viter425.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i430 in xrange(_size426):
            _elem431 = ExecutorInfo()
            _elem431.read(iprot)
            self.executors.append(_elem431)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class LSApprovedWorkers:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i437 in xrange(_size433):
            ...
            self.approved_workers[_key438] = _val439
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.approved_workers is not None:
      ...
      for kiter440,viter441 in self.approved_workers.items():
        oprot.writeString(kiter440.encode('utf-8'))
        oprot.writeI32(viter441)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class LSSupervisorAssignments:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i446 in xrange(_size442):
            _key447 = iprot.readI32();
            _val448 = LocalAssignment()
            _val448.read(iprot)
            self.assignments[_key447] = _val448
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.assignments is not None:
      ...
      for kiter449,viter450 in self.assignments.items():
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i455 in xrange(_size451):
            _elem456 = ExecutorInfo()
            _elem456.read(iprot)
            self.executors.append(_elem456)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
