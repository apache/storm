...
class SupervisorAssignments:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i725 in xrange(_size721):
            _key726 = iprot.readString().decode('utf-8')
            _val727 = Assignment()
            _val727.read(iprot)
            self.storm_assignment[_key726] = _val727
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.storm_assignment is not None:
      ...
      for kiter728,viter729 in self.storm_assignment.items():
        oprot.writeString(kiter728.encode('utf-8'))
