...
public interface IBolt extends Serializable {
     ...
     * @param codeDir Override codeDir path on context to use ruby, python or js path.Empty if need to use same as context codeDir path.
     */
    void prepare(Map stormConf, TopologyContext context, OutputCollector collector, String codeDir);
