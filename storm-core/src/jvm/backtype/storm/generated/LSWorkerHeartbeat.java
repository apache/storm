            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.executors = new ArrayList<ExecutorInfo>(_list512.size);
                ExecutorInfo _elem513;
                for (int _i514 = 0; _i514 < _list512.size; ++_i514)
                {
                  _elem513 = new ExecutorInfo();
                  _elem513.read(iprot);
                  struct.executors.add(_elem513);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executors != null) {
        oprot.writeFieldBegin(EXECUTORS_FIELD_DESC);
        {
          ...
          for (ExecutorInfo _iter515 : struct.executors)
          {
  ...
  private static class LSWorkerHeartbeatTupleScheme extends TupleScheme<LSWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.topology_id);
      {
        ...
        for (ExecutorInfo _iter516 : struct.executors)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_topology_id_isSet(true);
      {
        ...
        struct.executors = new ArrayList<ExecutorInfo>(_list517.size);
        ExecutorInfo _elem518;
        for (int _i519 = 0; _i519 < _list517.size; ++_i519)
        {
          _elem518 = new ExecutorInfo();
          _elem518.read(iprot);
          struct.executors.add(_elem518);
        }
      }
      struct.set_executors_isSet(true);
      struct.port = iprot.readI32();
