...
public class ComponentPageInfo implements org.apache.thrift.TBase<ComponentPageInfo, ComponentPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ComponentPageInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_stats = new HashMap<String,ComponentAggregateStats>(2*_map444.size);
                String _key445;
                ...
                for (int _i447 = 0; _i447 < _map444.size; ++_i447)
                {
                  ...
                  _val446.read(iprot);
                  struct.window_to_stats.put(_key445, _val446);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.gsid_to_input_stats = new HashMap<GlobalStreamId,ComponentAggregateStats>(2*_map448.size);
                GlobalStreamId _key449;
                ComponentAggregateStats _val450;
                for (int _i451 = 0; _i451 < _map448.size; ++_i451)
                {
                  _key449 = new GlobalStreamId();
                  _key449.read(iprot);
                  _val450 = new ComponentAggregateStats();
                  _val450.read(iprot);
                  struct.gsid_to_input_stats.put(_key449, _val450);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.sid_to_output_stats = new HashMap<String,ComponentAggregateStats>(2*_map452.size);
                String _key453;
                ...
                for (int _i455 = 0; _i455 < _map452.size; ++_i455)
                {
                  ...
                  _val454.read(iprot);
                  struct.sid_to_output_stats.put(_key453, _val454);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.exec_stats = new ArrayList<ExecutorAggregateStats>(_list456.size);
                ExecutorAggregateStats _elem457;
                for (int _i458 = 0; _i458 < _list456.size; ++_i458)
                {
                  _elem457 = new ExecutorAggregateStats();
                  _elem457.read(iprot);
                  struct.exec_stats.add(_elem457);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.errors = new ArrayList<ErrorInfo>(_list459.size);
                ErrorInfo _elem460;
                for (int _i461 = 0; _i461 < _list459.size; ++_i461)
                {
                  _elem460 = new ErrorInfo();
                  _elem460.read(iprot);
                  struct.errors.add(_elem460);
                }
                iprot.readListEnd();
              }
  ...
  private static class ComponentPageInfoTupleScheme extends TupleScheme<ComponentPageInfo> {
      ...
      if (struct.is_set_window_to_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter467 : struct.window_to_stats.entrySet())
          {
      ...
      if (struct.is_set_gsid_to_input_stats()) {
        {
          ...
          for (Map.Entry<GlobalStreamId, ComponentAggregateStats> _iter468 : struct.gsid_to_input_stats.entrySet())
          {
            _iter468.getKey().write(oprot);
      ...
      if (struct.is_set_sid_to_output_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter469 : struct.sid_to_output_stats.entrySet())
          {
      ...
      if (struct.is_set_exec_stats()) {
        {
          ...
          for (ExecutorAggregateStats _iter470 : struct.exec_stats)
          {
      ...
      if (struct.is_set_errors()) {
        {
          ...
          for (ErrorInfo _iter471 : struct.errors)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ComponentPageInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TMap _map472 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map476 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list484 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
