...
public class Assignment implements org.apache.thrift.TBase<Assignment, Assignment._Fields>, java.io.Serializable, Cloneable, Comparable<Assignment> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.node_host = new HashMap<String,String>(2*_map390.size);
                String _key391;
                String _val392;
                for (int _i393 = 0; _i393 < _map390.size; ++_i393)
                {
                  ...
                  struct.node_host.put(_key391, _val392);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map394.size);
                List<Long> _key395;
                NodeInfo _val396;
                ...
                {
                  {
                    ...
                    _key395 = new ArrayList<Long>(_list398.size);
                    long _elem399;
                    for (int _i400 = 0; _i400 < _list398.size; ++_i400)
                    {
                      _elem399 = iprot.readI64();
                      _key395.add(_elem399);
                    }
                    iprot.readListEnd();
                  }
                  _val396 = new NodeInfo();
                  _val396.read(iprot);
                  struct.executor_node_port.put(_key395, _val396);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map401.size);
                List<Long> _key402;
                long _val403;
                ...
                {
                  {
                    ...
                    _key402 = new ArrayList<Long>(_list405.size);
                    long _elem406;
                    for (int _i407 = 0; _i407 < _list405.size; ++_i407)
                    {
                      _elem406 = iprot.readI64();
                      _key402.add(_elem406);
                    }
                    iprot.readListEnd();
                  }
                  _val403 = iprot.readI64();
                  struct.executor_start_time_secs.put(_key402, _val403);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.node_host != null) {
        if (struct.is_set_node_host()) {
          oprot.writeFieldBegin(NODE_HOST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter408 : struct.node_host.entrySet())
            {
      ...
      if (struct.executor_node_port != null) {
        if (struct.is_set_executor_node_port()) {
          oprot.writeFieldBegin(EXECUTOR_NODE_PORT_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, NodeInfo> _iter409 : struct.executor_node_port.entrySet())
            {
              {
      ...
      if (struct.executor_start_time_secs != null) {
        if (struct.is_set_executor_start_time_secs()) {
          oprot.writeFieldBegin(EXECUTOR_START_TIME_SECS_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, Long> _iter411 : struct.executor_start_time_secs.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter411.getKey().size()));
                for (long _iter412 : _iter411.getKey())
                {
                  oprot.writeI64(_iter412);
                }
                oprot.writeListEnd();
              }
              oprot.writeI64(_iter411.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class AssignmentTupleScheme extends TupleScheme<Assignment> {
      ...
      if (struct.is_set_node_host()) {
        {
          ...
          for (Map.Entry<String, String> _iter413 : struct.node_host.entrySet())
          {
      ...
      if (struct.is_set_executor_node_port()) {
        {
          ...
          for (Map.Entry<List<Long>, NodeInfo> _iter414 : struct.executor_node_port.entrySet())
          {
            {
      ...
      if (struct.is_set_executor_start_time_secs()) {
        {
          ...
          for (Map.Entry<List<Long>, Long> _iter416 : struct.executor_start_time_secs.entrySet())
          {
            {
              oprot.writeI32(_iter416.getKey().size());
              for (long _iter417 : _iter416.getKey())
              {
                oprot.writeI64(_iter417);
              }
            }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Assignment struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.node_host = new HashMap<String,String>(2*_map418.size);
          String _key419;
          String _val420;
          for (int _i421 = 0; _i421 < _map418.size; ++_i421)
          {
            ...
            struct.node_host.put(_key419, _val420);
          }
        }
        struct.set_node_host_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map422 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map422.size);
          List<Long> _key423;
          NodeInfo _val424;
          for (int _i425 = 0; _i425 < _map422.size; ++_i425)
          {
            {
              org.apache.thrift.protocol.TList _list426 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
              _key423 = new ArrayList<Long>(_list426.size);
              long _elem427;
              for (int _i428 = 0; _i428 < _list426.size; ++_i428)
              {
                _elem427 = iprot.readI64();
                _key423.add(_elem427);
              }
            }
            _val424 = new NodeInfo();
            _val424.read(iprot);
            struct.executor_node_port.put(_key423, _val424);
          }
        }
        struct.set_executor_node_port_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map429 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map429.size);
          List<Long> _key430;
          long _val431;
          for (int _i432 = 0; _i432 < _map429.size; ++_i432)
          {
            {
              org.apache.thrift.protocol.TList _list433 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
              _key430 = new ArrayList<Long>(_list433.size);
              long _elem434;
              for (int _i435 = 0; _i435 < _list433.size; ++_i435)
              {
                _elem434 = iprot.readI64();
                _key430.add(_elem434);
              }
            }
            _val431 = iprot.readI64();
            struct.executor_start_time_secs.put(_key430, _val431);
          }
        }
        struct.set_executor_start_time_secs_isSet(true);
      }
