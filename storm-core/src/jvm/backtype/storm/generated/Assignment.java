      ...
      if (struct.node_host != null) {
        if (struct.is_set_node_host()) {
          oprot.writeFieldBegin(NODE_HOST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter572 : struct.node_host.entrySet())
            {
              oprot.writeString(_iter572.getKey());
              oprot.writeString(_iter572.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.executor_node_port != null) {
        if (struct.is_set_executor_node_port()) {
          oprot.writeFieldBegin(EXECUTOR_NODE_PORT_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, NodeInfo> _iter573 : struct.executor_node_port.entrySet())
            {
              {
      ...
      if (struct.executor_start_time_secs != null) {
        if (struct.is_set_executor_start_time_secs()) {
          oprot.writeFieldBegin(EXECUTOR_START_TIME_SECS_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, Long> _iter575 : struct.executor_start_time_secs.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter575.getKey().size()));
                for (long _iter576 : _iter575.getKey())
                {
                  oprot.writeI64(_iter576);
                }
                oprot.writeListEnd();
              }
              oprot.writeI64(_iter575.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.is_set_node_host()) {
        {
          ...
          for (Map.Entry<String, String> _iter577 : struct.node_host.entrySet())
          {
      ...
      if (struct.is_set_executor_node_port()) {
        {
          ...
          for (Map.Entry<List<Long>, NodeInfo> _iter578 : struct.executor_node_port.entrySet())
          {
            {
              oprot.writeI32(_iter578.getKey().size());
              for (long _iter579 : _iter578.getKey())
              {
      ...
      if (struct.is_set_executor_start_time_secs()) {
        {
          ...
          for (Map.Entry<List<Long>, Long> _iter580 : struct.executor_start_time_secs.entrySet())
          {
            {
              oprot.writeI32(_iter580.getKey().size());
              for (long _iter581 : _iter580.getKey())
              {
                oprot.writeI64(_iter581);
              }
            }
            oprot.writeI64(_iter580.getValue());
          }
        }
      }
    }
