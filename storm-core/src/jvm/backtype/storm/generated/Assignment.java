...
public class Assignment implements org.apache.thrift.TBase<Assignment, Assignment._Fields>, java.io.Serializable, Cloneable, Comparable<Assignment> {
      ...
      if (struct.node_host != null) {
        if (struct.is_set_node_host()) {
          oprot.writeFieldBegin(NODE_HOST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter426 : struct.node_host.entrySet())
            {
      ...
      if (struct.executor_node_port != null) {
        if (struct.is_set_executor_node_port()) {
          oprot.writeFieldBegin(EXECUTOR_NODE_PORT_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, NodeInfo> _iter427 : struct.executor_node_port.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter427.getKey().size()));
                for (long _iter428 : _iter427.getKey())
                {
                  oprot.writeI64(_iter428);
                }
                oprot.writeListEnd();
              }
      ...
      if (struct.executor_start_time_secs != null) {
        if (struct.is_set_executor_start_time_secs()) {
          oprot.writeFieldBegin(EXECUTOR_START_TIME_SECS_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, Long> _iter429 : struct.executor_start_time_secs.entrySet())
            {
              {
  ...
  private static class AssignmentTupleScheme extends TupleScheme<Assignment> {
      ...
      if (struct.is_set_node_host()) {
        {
          ...
          for (Map.Entry<String, String> _iter431 : struct.node_host.entrySet())
          {
      ...
      if (struct.is_set_executor_node_port()) {
        {
          ...
          for (Map.Entry<List<Long>, NodeInfo> _iter432 : struct.executor_node_port.entrySet())
          {
            {
              oprot.writeI32(_iter432.getKey().size());
              for (long _iter433 : _iter432.getKey())
              {
      ...
      if (struct.is_set_executor_start_time_secs()) {
        {
          ...
          for (Map.Entry<List<Long>, Long> _iter434 : struct.executor_start_time_secs.entrySet())
          {
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Assignment struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map436 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.node_host = new HashMap<String,String>(2*_map436.size);
          String _key437;
          String _val438;
          for (int _i439 = 0; _i439 < _map436.size; ++_i439)
          {
            ...
            struct.node_host.put(_key437, _val438);
          }
        }
        struct.set_node_host_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map440 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map440.size);
          List<Long> _key441;
          NodeInfo _val442;
          for (int _i443 = 0; _i443 < _map440.size; ++_i443)
          {
            {
              org.apache.thrift.protocol.TList _list444 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
              _key441 = new ArrayList<Long>(_list444.size);
              long _elem445;
              for (int _i446 = 0; _i446 < _list444.size; ++_i446)
              {
                _elem445 = iprot.readI64();
                _key441.add(_elem445);
              }
            }
            _val442 = new NodeInfo();
            _val442.read(iprot);
            struct.executor_node_port.put(_key441, _val442);
          }
        }
        struct.set_executor_node_port_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map447 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map447.size);
          List<Long> _key448;
          long _val449;
          for (int _i450 = 0; _i450 < _map447.size; ++_i450)
          {
            {
              org.apache.thrift.protocol.TList _list451 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
              _key448 = new ArrayList<Long>(_list451.size);
              long _elem452;
              for (int _i453 = 0; _i453 < _list451.size; ++_i453)
              {
                _elem452 = iprot.readI64();
                _key448.add(_elem452);
              }
            }
            _val449 = iprot.readI64();
            struct.executor_start_time_secs.put(_key448, _val449);
          }
        }
        struct.set_executor_start_time_secs_isSet(true);
      }
