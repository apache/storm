...
public class Assignment implements org.apache.thrift.TBase<Assignment, Assignment._Fields>, java.io.Serializable, Cloneable, Comparable<Assignment> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.node_host = new HashMap<String,String>(2*_map554.size);
                String _key555;
                String _val556;
                for (int _i557 = 0; _i557 < _map554.size; ++_i557)
                {
                  ...
                  struct.node_host.put(_key555, _val556);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map558.size);
                List<Long> _key559;
                NodeInfo _val560;
                ...
                {
                  {
                    ...
                    _key559 = new ArrayList<Long>(_list562.size);
                    long _elem563;
                    for (int _i564 = 0; _i564 < _list562.size; ++_i564)
                    {
                      _elem563 = iprot.readI64();
                      _key559.add(_elem563);
                    }
                    iprot.readListEnd();
                  }
                  _val560 = new NodeInfo();
                  _val560.read(iprot);
                  struct.executor_node_port.put(_key559, _val560);
                }
                iprot.readMapEnd();
              }
          ...
          case 4: // EXECUTOR_START_TIME_SECS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map565 = iprot.readMapBegin();
                struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map565.size);
                List<Long> _key566;
                long _val567;
                ...
                {
                  {
                    ...
                    _key566 = new ArrayList<Long>(_list569.size);
                    long _elem570;
                    for (int _i571 = 0; _i571 < _list569.size; ++_i571)
                    {
                      _elem570 = iprot.readI64();
                      _key566.add(_elem570);
                    }
                    iprot.readListEnd();
                  }
                  _val567 = iprot.readI64();
                  struct.executor_start_time_secs.put(_key566, _val567);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.worker_resources = new HashMap<NodeInfo,WorkerResources>(2*_map572.size);
                NodeInfo _key573;
                WorkerResources _val574;
                for (int _i575 = 0; _i575 < _map572.size; ++_i575)
                {
                  _key573 = new NodeInfo();
                  _key573.read(iprot);
                  _val574 = new WorkerResources();
                  _val574.read(iprot);
                  struct.worker_resources.put(_key573, _val574);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.executor_node_port != null) {
        if (struct.is_set_executor_node_port()) {
          oprot.writeFieldBegin(EXECUTOR_NODE_PORT_FIELD_DESC);
          {
            ...
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter577.getKey().size()));
  ...
  private static class AssignmentTupleScheme extends TupleScheme<Assignment> {
      ...
      if (struct.is_set_node_host()) {
        {
          ...
          for (Map.Entry<String, String> _iter582 : struct.node_host.entrySet())
          {
      ...
      if (struct.is_set_executor_node_port()) {
        {
          ...
          for (Map.Entry<List<Long>, NodeInfo> _iter583 : struct.executor_node_port.entrySet())
          {
            {
      ...
      if (struct.is_set_executor_start_time_secs()) {
        {
          ...
          for (Map.Entry<List<Long>, Long> _iter585 : struct.executor_start_time_secs.entrySet())
          {
            {
      ...
      if (struct.is_set_worker_resources()) {
        {
          ...
          for (Map.Entry<NodeInfo, WorkerResources> _iter587 : struct.worker_resources.entrySet())
          {
            _iter587.getKey().write(oprot);
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Assignment struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map588 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.node_host = new HashMap<String,String>(2*_map588.size);
          String _key589;
          String _val590;
          for (int _i591 = 0; _i591 < _map588.size; ++_i591)
          {
            ...
            struct.node_host.put(_key589, _val590);
          }
        }
        struct.set_node_host_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map592 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map592.size);
          List<Long> _key593;
          NodeInfo _val594;
          ...
          {
            {
              ...
              _key593 = new ArrayList<Long>(_list596.size);
              long _elem597;
              for (int _i598 = 0; _i598 < _list596.size; ++_i598)
              {
                _elem597 = iprot.readI64();
                _key593.add(_elem597);
              }
            }
            _val594 = new NodeInfo();
            _val594.read(iprot);
            struct.executor_node_port.put(_key593, _val594);
          }
        }
        struct.set_executor_node_port_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map599 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map599.size);
          List<Long> _key600;
          long _val601;
          for (int _i602 = 0; _i602 < _map599.size; ++_i602)
          {
            {
              org.apache.thrift.protocol.TList _list603 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
              _key600 = new ArrayList<Long>(_list603.size);
              long _elem604;
            ...
            _val601 = iprot.readI64();
            struct.executor_start_time_secs.put(_key600, _val601);
          }
        }
        struct.set_executor_start_time_secs_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.worker_resources = new HashMap<NodeInfo,WorkerResources>(2*_map606.size);
          NodeInfo _key607;
          WorkerResources _val608;
          for (int _i609 = 0; _i609 < _map606.size; ++_i609)
          {
            _key607 = new NodeInfo();
            _key607.read(iprot);
            _val608 = new WorkerResources();
            _val608.read(iprot);
            struct.worker_resources.put(_key607, _val608);
          }
        }
        struct.set_worker_resources_isSet(true);
      }
