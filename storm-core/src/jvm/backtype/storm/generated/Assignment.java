...
public class Assignment implements org.apache.thrift.TBase<Assignment, Assignment._Fields>, java.io.Serializable, Cloneable, Comparable<Assignment> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.node_host = new HashMap<String,String>(2*_map410.size);
                String _key411;
                String _val412;
                for (int _i413 = 0; _i413 < _map410.size; ++_i413)
                {
                  ...
                  struct.node_host.put(_key411, _val412);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map414.size);
                List<Long> _key415;
                NodeInfo _val416;
                ...
                {
                  {
                    ...
                    _key415 = new ArrayList<Long>(_list418.size);
                    long _elem419;
                    for (int _i420 = 0; _i420 < _list418.size; ++_i420)
                    {
                      _elem419 = iprot.readI64();
                      _key415.add(_elem419);
                    }
                    iprot.readListEnd();
                  }
                  _val416 = new NodeInfo();
                  _val416.read(iprot);
                  struct.executor_node_port.put(_key415, _val416);
                }
                iprot.readMapEnd();
              }
          ...
          case 4: // EXECUTOR_START_TIME_SECS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map421 = iprot.readMapBegin();
                struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map421.size);
                List<Long> _key422;
                long _val423;
                ...
                {
                  {
                    ...
                    _key422 = new ArrayList<Long>(_list425.size);
                    long _elem426;
                    for (int _i427 = 0; _i427 < _list425.size; ++_i427)
                    {
                      _elem426 = iprot.readI64();
                      _key422.add(_elem426);
                    }
                    iprot.readListEnd();
                  }
                  _val423 = iprot.readI64();
                  struct.executor_start_time_secs.put(_key422, _val423);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.node_host != null) {
        if (struct.is_set_node_host()) {
          oprot.writeFieldBegin(NODE_HOST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter428 : struct.node_host.entrySet())
            {
      ...
      if (struct.executor_node_port != null) {
        if (struct.is_set_executor_node_port()) {
          oprot.writeFieldBegin(EXECUTOR_NODE_PORT_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, NodeInfo> _iter429 : struct.executor_node_port.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter429.getKey().size()));
                for (long _iter430 : _iter429.getKey())
                {
                  oprot.writeI64(_iter430);
                }
                oprot.writeListEnd();
              }
      ...
      if (struct.executor_start_time_secs != null) {
        if (struct.is_set_executor_start_time_secs()) {
          oprot.writeFieldBegin(EXECUTOR_START_TIME_SECS_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, Long> _iter431 : struct.executor_start_time_secs.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter431.getKey().size()));
                for (long _iter432 : _iter431.getKey())
                {
  ...
  private static class AssignmentTupleScheme extends TupleScheme<Assignment> {
      ...
      if (struct.is_set_node_host()) {
        {
          ...
          for (Map.Entry<String, String> _iter433 : struct.node_host.entrySet())
          {
      ...
      if (struct.is_set_executor_node_port()) {
        {
          ...
          for (Map.Entry<List<Long>, NodeInfo> _iter434 : struct.executor_node_port.entrySet())
          {
            {
              oprot.writeI32(_iter434.getKey().size());
              for (long _iter435 : _iter434.getKey())
              {
      ...
      if (struct.is_set_executor_start_time_secs()) {
        {
          ...
          for (Map.Entry<List<Long>, Long> _iter436 : struct.executor_start_time_secs.entrySet())
          {
            {
              oprot.writeI32(_iter436.getKey().size());
              for (long _iter437 : _iter436.getKey())
              {
                oprot.writeI64(_iter437);
              }
            }
            oprot.writeI64(_iter436.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Assignment struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.node_host = new HashMap<String,String>(2*_map438.size);
          String _key439;
          String _val440;
          for (int _i441 = 0; _i441 < _map438.size; ++_i441)
          {
            ...
            struct.node_host.put(_key439, _val440);
          }
        }
        struct.set_node_host_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map442 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map442.size);
          List<Long> _key443;
          NodeInfo _val444;
          for (int _i445 = 0; _i445 < _map442.size; ++_i445)
          {
            {
              org.apache.thrift.protocol.TList _list446 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
              _key443 = new ArrayList<Long>(_list446.size);
              long _elem447;
              for (int _i448 = 0; _i448 < _list446.size; ++_i448)
              {
                _elem447 = iprot.readI64();
                _key443.add(_elem447);
              }
            }
            _val444 = new NodeInfo();
            _val444.read(iprot);
            struct.executor_node_port.put(_key443, _val444);
          }
        }
        struct.set_executor_node_port_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map449 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map449.size);
          List<Long> _key450;
          long _val451;
          for (int _i452 = 0; _i452 < _map449.size; ++_i452)
          {
            {
              org.apache.thrift.protocol.TList _list453 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
              _key450 = new ArrayList<Long>(_list453.size);
              long _elem454;
              for (int _i455 = 0; _i455 < _list453.size; ++_i455)
              {
                _elem454 = iprot.readI64();
                _key450.add(_elem454);
              }
            }
            _val451 = iprot.readI64();
            struct.executor_start_time_secs.put(_key450, _val451);
          }
        }
        struct.set_executor_start_time_secs_isSet(true);
      }
