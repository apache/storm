...
public class LogConfig implements org.apache.thrift.TBase<LogConfig, LogConfig._Fields>, java.io.Serializable, Cloneable, Comparable<LogConfig> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.named_logger_level = new HashMap<String,LogLevel>(2*_map676.size);
                String _key677;
                LogLevel _val678;
                for (int _i679 = 0; _i679 < _map676.size; ++_i679)
                {
                  _key677 = iprot.readString();
                  _val678 = new LogLevel();
                  _val678.read(iprot);
                  struct.named_logger_level.put(_key677, _val678);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.named_logger_level != null) {
        if (struct.is_set_named_logger_level()) {
          oprot.writeFieldBegin(NAMED_LOGGER_LEVEL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, LogLevel> _iter680 : struct.named_logger_level.entrySet())
            {
  ...
  private static class LogConfigTupleScheme extends TupleScheme<LogConfig> {
      ...
      if (struct.is_set_named_logger_level()) {
        {
          ...
          for (Map.Entry<String, LogLevel> _iter681 : struct.named_logger_level.entrySet())
          {
            oprot.writeString(_iter681.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LogConfig struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map682 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.named_logger_level = new HashMap<String,LogLevel>(2*_map682.size);
          String _key683;
          LogLevel _val684;
          for (int _i685 = 0; _i685 < _map682.size; ++_i685)
          {
            _key683 = iprot.readString();
            _val684 = new LogLevel();
            _val684.read(iprot);
            struct.named_logger_level.put(_key683, _val684);
          }
        }
        struct.set_named_logger_level_isSet(true);
      }
