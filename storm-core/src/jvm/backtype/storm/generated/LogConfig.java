      ...
      if (struct.named_logger_level != null) {
        if (struct.is_set_named_logger_level()) {
          oprot.writeFieldBegin(NAMED_LOGGER_LEVEL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, LogLevel> _iter690 : struct.named_logger_level.entrySet())
            {
      ...
      if (struct.is_set_named_logger_level()) {
        {
          ...
          for (Map.Entry<String, LogLevel> _iter691 : struct.named_logger_level.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.named_logger_level = new HashMap<String,LogLevel>(2*_map692.size);
          String _key693;
          LogLevel _val694;
          for (int _i695 = 0; _i695 < _map692.size; ++_i695)
          {
            _key693 = iprot.readString();
            _val694 = new LogLevel();
            _val694.read(iprot);
            struct.named_logger_level.put(_key693, _val694);
          }
        }
        struct.set_named_logger_level_isSet(true);
      }
