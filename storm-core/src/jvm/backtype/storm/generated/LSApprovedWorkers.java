            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.approved_workers = new HashMap<String,Integer>(2*_map648.size);
                String _key649;
                int _val650;
                for (int _i651 = 0; _i651 < _map648.size; ++_i651)
                {
                  _key649 = iprot.readString();
                  _val650 = iprot.readI32();
                  struct.approved_workers.put(_key649, _val650);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      if (struct.approved_workers != null) {
        oprot.writeFieldBegin(APPROVED_WORKERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter652 : struct.approved_workers.entrySet())
          {
            oprot.writeString(_iter652.getKey());
            oprot.writeI32(_iter652.getValue());
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class LSApprovedWorkersTupleScheme extends TupleScheme<LSApprovedWorkers> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Integer> _iter653 : struct.approved_workers.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map654 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
        struct.approved_workers = new HashMap<String,Integer>(2*_map654.size);
        String _key655;
        int _val656;
        for (int _i657 = 0; _i657 < _map654.size; ++_i657)
        {
          ...
          struct.approved_workers.put(_key655, _val656);
        }
      }
      struct.set_approved_workers_isSet(true);
    }
