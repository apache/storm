            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.approved_workers = new HashMap<String,Integer>(2*_map492.size);
                String _key493;
                int _val494;
                for (int _i495 = 0; _i495 < _map492.size; ++_i495)
                {
                  ...
                  struct.approved_workers.put(_key493, _val494);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      if (struct.approved_workers != null) {
        oprot.writeFieldBegin(APPROVED_WORKERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter496 : struct.approved_workers.entrySet())
          {
            oprot.writeString(_iter496.getKey());
            oprot.writeI32(_iter496.getValue());
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class LSApprovedWorkersTupleScheme extends TupleScheme<LSApprovedWorkers> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Integer> _iter497 : struct.approved_workers.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map498 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
        struct.approved_workers = new HashMap<String,Integer>(2*_map498.size);
        String _key499;
        int _val500;
        for (int _i501 = 0; _i501 < _map498.size; ++_i501)
        {
          _key499 = iprot.readString();
          _val500 = iprot.readI32();
          struct.approved_workers.put(_key499, _val500);
        }
      }
      struct.set_approved_workers_isSet(true);
    }
