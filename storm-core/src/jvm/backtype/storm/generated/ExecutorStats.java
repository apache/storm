            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.throughput = new HashMap<String,Map<String,Double>>(2*_map284.size);
                String _key285;
                ...
                for (int _i287 = 0; _i287 < _map284.size; ++_i287)
                {
                  ...
                  struct.throughput.put(_key285, _val286);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.throughput != null) {
        if (struct.is_set_throughput()) {
          oprot.writeFieldBegin(THROUGHPUT_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Map<String,Double>> _iter296 : struct.throughput.entrySet())
            {
              oprot.writeString(_iter296.getKey());
              {
                oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, _iter296.getValue().size()));
                for (Map.Entry<String, Double> _iter297 : _iter296.getValue().entrySet())
                {
  ...
  private static class ExecutorStatsTupleScheme extends TupleScheme<ExecutorStats> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ExecutorStats struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Map<String,Long>> _iter298 : struct.emitted.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Map<String,Long>> _iter300 : struct.transferred.entrySet())
        {
      ...
      if (struct.is_set_throughput()) {
        {
          ...
          for (Map.Entry<String, Map<String,Double>> _iter302 : struct.throughput.entrySet())
          {
            oprot.writeString(_iter302.getKey());
            {
              oprot.writeI32(_iter302.getValue().size());
              for (Map.Entry<String, Double> _iter303 : _iter302.getValue().entrySet())
              {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ExecutorStats struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.emitted = new HashMap<String,Map<String,Long>>(2*_map304.size);
        String _key305;
        ...
        for (int _i307 = 0; _i307 < _map304.size; ++_i307)
        {
          ...
          struct.emitted.put(_key305, _val306);
        }
      }
      struct.set_emitted_isSet(true);
      {
        ...
        struct.transferred = new HashMap<String,Map<String,Long>>(2*_map312.size);
        String _key313;
        ...
        for (int _i315 = 0; _i315 < _map312.size; ++_i315)
        {
          ...
          struct.transferred.put(_key313, _val314);
        }
      }
      struct.set_transferred_isSet(true);
      struct.specific = new ExecutorSpecificStats();
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.throughput = new HashMap<String,Map<String,Double>>(2*_map320.size);
          String _key321;
          Map<String,Double> _val322;
          for (int _i323 = 0; _i323 < _map320.size; ++_i323)
          {
            _key321 = iprot.readString();
            {
              org.apache.thrift.protocol.TMap _map324 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
              _val322 = new HashMap<String,Double>(2*_map324.size);
              String _key325;
              double _val326;
            ...
            struct.throughput.put(_key321, _val322);
          }
        }
        struct.set_throughput_isSet(true);
      }
