...
public class SupervisorSummary implements org.apache.thrift.TBase<SupervisorSummary, SupervisorSummary._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorSummary> {
  ...
  private static final org.apache.thrift.protocol.TField SYSTEM_STATS_FIELD_DESC = new org.apache.thrift.protocol.TField("system_stats", org.apache.thrift.protocol.TType.MAP, (short)7);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SYSTEM_STATS((short)7, "system_stats");
  ...
  private static final _Fields optionals[] = {_Fields.VERSION,_Fields.SYSTEM_STATS};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.system_stats = new HashMap<String,Double>(2*_map74.size);
                String _key75;
                double _val76;
                for (int _i77 = 0; _i77 < _map74.size; ++_i77)
                {
                  ...
                  struct.system_stats.put(_key75, _val76);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.system_stats != null) {
        if (struct.is_set_system_stats()) {
          oprot.writeFieldBegin(SYSTEM_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter78 : struct.system_stats.entrySet())
            {
      ...
      if (struct.is_set_system_stats()) {
        {
          ...
          for (Map.Entry<String, Double> _iter79 : struct.system_stats.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.system_stats = new HashMap<String,Double>(2*_map80.size);
          String _key81;
          double _val82;
          for (int _i83 = 0; _i83 < _map80.size; ++_i83)
          {
            ...
            struct.system_stats.put(_key81, _val82);
          }
        }
        struct.set_system_stats_isSet(true);
      }
