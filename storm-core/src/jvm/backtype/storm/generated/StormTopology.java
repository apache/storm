            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.spouts = new HashMap<String,SpoutSpec>(2*_map54.size);
                String _key55;
                SpoutSpec _val56;
                for (int _i57 = 0; _i57 < _map54.size; ++_i57)
                {
                  _key55 = iprot.readString();
                  _val56 = new SpoutSpec();
                  _val56.read(iprot);
                  struct.spouts.put(_key55, _val56);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.bolts = new HashMap<String,Bolt>(2*_map58.size);
                String _key59;
                Bolt _val60;
                for (int _i61 = 0; _i61 < _map58.size; ++_i61)
                {
                  ...
                  _val60 = new Bolt();
                  _val60.read(iprot);
                  struct.bolts.put(_key59, _val60);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.state_spouts = new HashMap<String,StateSpoutSpec>(2*_map62.size);
                String _key63;
                StateSpoutSpec _val64;
                for (int _i65 = 0; _i65 < _map62.size; ++_i65)
                {
                  _key63 = iprot.readString();
                  _val64 = new StateSpoutSpec();
                  _val64.read(iprot);
                  struct.state_spouts.put(_key63, _val64);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StormTopology struct) throws org.apache.thrift.TException {
      ...
      if (struct.spouts != null) {
        oprot.writeFieldBegin(SPOUTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, SpoutSpec> _iter66 : struct.spouts.entrySet())
          {
      ...
      if (struct.bolts != null) {
        oprot.writeFieldBegin(BOLTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Bolt> _iter67 : struct.bolts.entrySet())
          {
      ...
      if (struct.state_spouts != null) {
        oprot.writeFieldBegin(STATE_SPOUTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, StateSpoutSpec> _iter68 : struct.state_spouts.entrySet())
          {
  ...
  private static class StormTopologyTupleScheme extends TupleScheme<StormTopology> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, StormTopology struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, SpoutSpec> _iter69 : struct.spouts.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Bolt> _iter70 : struct.bolts.entrySet())
        {
