...
public class TopologyStats implements org.apache.thrift.TBase<TopologyStats, TopologyStats._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_throughput = new HashMap<String,Double>(2*_map384.size);
                String _key385;
                double _val386;
                for (int _i387 = 0; _i387 < _map384.size; ++_i387)
                {
                  _key385 = iprot.readString();
                  _val386 = iprot.readDouble();
                  struct.window_to_throughput.put(_key385, _val386);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.window_to_throughput != null) {
        if (struct.is_set_window_to_throughput()) {
          oprot.writeFieldBegin(WINDOW_TO_THROUGHPUT_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter393 : struct.window_to_throughput.entrySet())
            {
  ...
  private static class TopologyStatsTupleScheme extends TupleScheme<TopologyStats> {
      ...
      if (struct.is_set_window_to_complete_latencies_ms()) {
        {
          ...
          for (Map.Entry<String, Double> _iter396 : struct.window_to_complete_latencies_ms.entrySet())
          {
      ...
      if (struct.is_set_window_to_acked()) {
        {
          ...
          for (Map.Entry<String, Long> _iter397 : struct.window_to_acked.entrySet())
          {
      ...
      if (struct.is_set_window_to_failed()) {
        {
          ...
          for (Map.Entry<String, Long> _iter398 : struct.window_to_failed.entrySet())
          {
      ...
      if (struct.is_set_window_to_throughput()) {
        {
          ...
          for (Map.Entry<String, Double> _iter399 : struct.window_to_throughput.entrySet())
          {
            oprot.writeString(_iter399.getKey());
            oprot.writeDouble(_iter399.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.window_to_complete_latencies_ms = new HashMap<String,Double>(2*_map408.size);
          String _key409;
          double _val410;
          for (int _i411 = 0; _i411 < _map408.size; ++_i411)
          {
            ...
            struct.window_to_complete_latencies_ms.put(_key409, _val410);
          }
        }
        struct.set_window_to_complete_latencies_ms_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.window_to_acked = new HashMap<String,Long>(2*_map412.size);
          String _key413;
          long _val414;
          for (int _i415 = 0; _i415 < _map412.size; ++_i415)
          {
            ...
            struct.window_to_acked.put(_key413, _val414);
          }
        }
        struct.set_window_to_acked_isSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.window_to_failed = new HashMap<String,Long>(2*_map416.size);
          String _key417;
          long _val418;
          for (int _i419 = 0; _i419 < _map416.size; ++_i419)
          {
            ...
            struct.window_to_failed.put(_key417, _val418);
          }
        }
        struct.set_window_to_failed_isSet(true);
      }
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map420 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.window_to_throughput = new HashMap<String,Double>(2*_map420.size);
          String _key421;
          double _val422;
          for (int _i423 = 0; _i423 < _map420.size; ++_i423)
          {
            _key421 = iprot.readString();
            _val422 = iprot.readDouble();
            struct.window_to_throughput.put(_key421, _val422);
          }
        }
        struct.set_window_to_throughput_isSet(true);
      }
