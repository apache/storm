...
public class TopologyStats implements org.apache.thrift.TBase<TopologyStats, TopologyStats._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyStats> {
  ...
  private static final org.apache.thrift.protocol.TField WINDOW_TO_THROUGHPUT_FIELD_DESC = new org.apache.thrift.protocol.TField("window_to_throughput", org.apache.thrift.protocol.TType.MAP, (short)3);
  private static final org.apache.thrift.protocol.TField WINDOW_TO_COMPLETE_LATENCIES_MS_FIELD_DESC = new org.apache.thrift.protocol.TField("window_to_complete_latencies_ms", org.apache.thrift.protocol.TType.MAP, (short)4);
  private static final org.apache.thrift.protocol.TField WINDOW_TO_ACKED_FIELD_DESC = new org.apache.thrift.protocol.TField("window_to_acked", org.apache.thrift.protocol.TType.MAP, (short)5);
  private static final org.apache.thrift.protocol.TField WINDOW_TO_FAILED_FIELD_DESC = new org.apache.thrift.protocol.TField("window_to_failed", org.apache.thrift.protocol.TType.MAP, (short)6);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    WINDOW_TO_THROUGHPUT((short)3, "window_to_throughput"),
    WINDOW_TO_COMPLETE_LATENCIES_MS((short)4, "window_to_complete_latencies_ms"),
    WINDOW_TO_ACKED((short)5, "window_to_acked"),
    WINDOW_TO_FAILED((short)6, "window_to_failed");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // WINDOW_TO_THROUGHPUT
          return WINDOW_TO_THROUGHPUT;
        case 4: // WINDOW_TO_COMPLETE_LATENCIES_MS
          return WINDOW_TO_COMPLETE_LATENCIES_MS;
        case 5: // WINDOW_TO_ACKED
          return WINDOW_TO_ACKED;
        case 6: // WINDOW_TO_FAILED
  ...
  private static final _Fields optionals[] = {_Fields.WINDOW_TO_EMITTED,_Fields.WINDOW_TO_TRANSFERRED,_Fields.WINDOW_TO_THROUGHPUT,_Fields.WINDOW_TO_COMPLETE_LATENCIES_MS,_Fields.WINDOW_TO_ACKED,_Fields.WINDOW_TO_FAILED};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_throughput = new HashMap<String,Double>(2*_map372.size);
                String _key373;
                double _val374;
                for (int _i375 = 0; _i375 < _map372.size; ++_i375)
                {
                  ...
                  struct.window_to_throughput.put(_key373, _val374);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.window_to_throughput != null) {
        if (struct.is_set_window_to_throughput()) {
          oprot.writeFieldBegin(WINDOW_TO_THROUGHPUT_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter390 : struct.window_to_throughput.entrySet())
            {
      ...
      if (struct.window_to_complete_latencies_ms != null) {
        if (struct.is_set_window_to_complete_latencies_ms()) {
          oprot.writeFieldBegin(WINDOW_TO_COMPLETE_LATENCIES_MS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter391 : struct.window_to_complete_latencies_ms.entrySet())
            {
              oprot.writeString(_iter391.getKey());
              oprot.writeDouble(_iter391.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.window_to_acked != null) {
        if (struct.is_set_window_to_acked()) {
          oprot.writeFieldBegin(WINDOW_TO_ACKED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter392 : struct.window_to_acked.entrySet())
            {
      ...
      if (struct.window_to_failed != null) {
        if (struct.is_set_window_to_failed()) {
          oprot.writeFieldBegin(WINDOW_TO_FAILED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter393 : struct.window_to_failed.entrySet())
            {
  ...
  private static class TopologyStatsTupleScheme extends TupleScheme<TopologyStats> {
      ...
      if (struct.is_set_window_to_emitted()) {
        {
          ...
          for (Map.Entry<String, Long> _iter394 : struct.window_to_emitted.entrySet())
          {
      ...
      if (struct.is_set_window_to_transferred()) {
        {
          ...
          for (Map.Entry<String, Long> _iter395 : struct.window_to_transferred.entrySet())
          {
            oprot.writeString(_iter395.getKey());
            oprot.writeI64(_iter395.getValue());
          }
        }
      }
      if (struct.is_set_window_to_throughput()) {
        {
          ...
          for (Map.Entry<String, Double> _iter396 : struct.window_to_throughput.entrySet())
          {
            oprot.writeString(_iter396.getKey());
            oprot.writeDouble(_iter396.getValue());
          }
        }
      }
      if (struct.is_set_window_to_complete_latencies_ms()) {
        {
          ...
          for (Map.Entry<String, Double> _iter397 : struct.window_to_complete_latencies_ms.entrySet())
          {
            oprot.writeString(_iter397.getKey());
            oprot.writeDouble(_iter397.getValue());
          }
        }
      }
      if (struct.is_set_window_to_acked()) {
        {
          ...
          for (Map.Entry<String, Long> _iter398 : struct.window_to_acked.entrySet())
          {
      ...
      if (struct.is_set_window_to_failed()) {
        {
          ...
          for (Map.Entry<String, Long> _iter399 : struct.window_to_failed.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map400 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.window_to_emitted = new HashMap<String,Long>(2*_map400.size);
          String _key401;
          long _val402;
          for (int _i403 = 0; _i403 < _map400.size; ++_i403)
          {
            ...
            struct.window_to_emitted.put(_key401, _val402);
          }
        }
        struct.set_window_to_emitted_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map404 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.window_to_transferred = new HashMap<String,Long>(2*_map404.size);
          String _key405;
          long _val406;
          for (int _i407 = 0; _i407 < _map404.size; ++_i407)
          {
            ...
            struct.window_to_transferred.put(_key405, _val406);
          }
        }
        struct.set_window_to_transferred_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map408 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map412 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.window_to_complete_latencies_ms = new HashMap<String,Double>(2*_map412.size);
          String _key413;
          double _val414;
          for (int _i415 = 0; _i415 < _map412.size; ++_i415)
          {
            _key413 = iprot.readString();
            _val414 = iprot.readDouble();
            struct.window_to_complete_latencies_ms.put(_key413, _val414);
          }
        }
        struct.set_window_to_complete_latencies_ms_isSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TMap _map416 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.window_to_acked = new HashMap<String,Long>(2*_map416.size);
          String _key417;
          long _val418;
          for (int _i419 = 0; _i419 < _map416.size; ++_i419)
          {
            _key417 = iprot.readString();
            _val418 = iprot.readI64();
            struct.window_to_acked.put(_key417, _val418);
          }
        }
        struct.set_window_to_acked_isSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.window_to_failed = new HashMap<String,Long>(2*_map420.size);
          String _key421;
          long _val422;
          for (int _i423 = 0; _i423 < _map420.size; ++_i423)
          {
            ...
            struct.window_to_failed.put(_key421, _val422);
          }
        }
        struct.set_window_to_failed_isSet(true);
      }
