...
public class TopologyPageInfo implements org.apache.thrift.TBase<TopologyPageInfo, TopologyPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyPageInfo> {
      ...
      if (struct.id_to_spout_agg_stats != null) {
        if (struct.is_set_id_to_spout_agg_stats()) {
          oprot.writeFieldBegin(ID_TO_SPOUT_AGG_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ComponentAggregateStats> _iter432 : struct.id_to_spout_agg_stats.entrySet())
            {
      ...
      if (struct.id_to_bolt_agg_stats != null) {
        if (struct.is_set_id_to_bolt_agg_stats()) {
          oprot.writeFieldBegin(ID_TO_BOLT_AGG_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ComponentAggregateStats> _iter433 : struct.id_to_bolt_agg_stats.entrySet())
            {
  ...
  private static class TopologyPageInfoTupleScheme extends TupleScheme<TopologyPageInfo> {
      ...
      if (struct.is_set_id_to_spout_agg_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter434 : struct.id_to_spout_agg_stats.entrySet())
          {
      ...
      if (struct.is_set_id_to_bolt_agg_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter435 : struct.id_to_bolt_agg_stats.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyPageInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TMap _map436 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.id_to_spout_agg_stats = new HashMap<String,ComponentAggregateStats>(2*_map436.size);
          String _key437;
          ...
          for (int _i439 = 0; _i439 < _map436.size; ++_i439)
          {
            ...
            _val438.read(iprot);
            struct.id_to_spout_agg_stats.put(_key437, _val438);
          }
        }
        struct.set_id_to_spout_agg_stats_isSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.id_to_bolt_agg_stats = new HashMap<String,ComponentAggregateStats>(2*_map440.size);
          String _key441;
          ...
          for (int _i443 = 0; _i443 < _map440.size; ++_i443)
          {
            ...
            _val442.read(iprot);
            struct.id_to_bolt_agg_stats.put(_key441, _val442);
          }
        }
        struct.set_id_to_bolt_agg_stats_isSet(true);
      }
