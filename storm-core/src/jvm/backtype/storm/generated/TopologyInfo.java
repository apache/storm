            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new HashMap<String,DebugOptions>(2*_map338.size);
                String _key339;
                DebugOptions _val340;
                for (int _i341 = 0; _i341 < _map338.size; ++_i341)
                {
                  _key339 = iprot.readString();
                  _val340 = new DebugOptions();
                  _val340.read(iprot);
                  struct.component_debug.put(_key339, _val340);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.errors != null) {
        oprot.writeFieldBegin(ERRORS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, List<ErrorInfo>> _iter343 : struct.errors.entrySet())
          {
            ...
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter343.getValue().size()));
  ...
  private static class TopologyInfoTupleScheme extends TupleScheme<TopologyInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_uptime_secs_isSet(true);
      {
        ...
        struct.executors = new ArrayList<ExecutorSummary>(_list350.size);
        ExecutorSummary _elem351;
        for (int _i352 = 0; _i352 < _list350.size; ++_i352)
        {
          _elem351 = new ExecutorSummary();
          _elem351.read(iprot);
          struct.executors.add(_elem351);
        }
      }
      struct.set_executors_isSet(true);
      struct.status = iprot.readString();
      struct.set_status_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map353 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
        struct.errors = new HashMap<String,List<ErrorInfo>>(2*_map353.size);
        String _key354;
        List<ErrorInfo> _val355;
        for (int _i356 = 0; _i356 < _map353.size; ++_i356)
        {
          _key354 = iprot.readString();
          {
            ...
            _val355 = new ArrayList<ErrorInfo>(_list357.size);
            ErrorInfo _elem358;
            for (int _i359 = 0; _i359 < _list357.size; ++_i359)
            {
              _elem358 = new ErrorInfo();
              _elem358.read(iprot);
              _val355.add(_elem358);
            }
          }
          struct.errors.put(_key354, _val355);
        }
      }
      struct.set_errors_isSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.component_debug = new HashMap<String,DebugOptions>(2*_map360.size);
          String _key361;
          DebugOptions _val362;
          for (int _i363 = 0; _i363 < _map360.size; ++_i363)
          {
            _key361 = iprot.readString();
            _val362 = new DebugOptions();
            _val362.read(iprot);
            struct.component_debug.put(_key361, _val362);
          }
        }
        struct.set_component_debug_isSet(true);
      }
