    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.executors != null) {
        oprot.writeFieldBegin(EXECUTORS_FIELD_DESC);
        {
          ...
          for (ExecutorSummary _iter340 : struct.executors)
          {
      ...
      if (struct.errors != null) {
        oprot.writeFieldBegin(ERRORS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, List<ErrorInfo>> _iter341 : struct.errors.entrySet())
          {
            oprot.writeString(_iter341.getKey());
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter341.getValue().size()));
              for (ErrorInfo _iter342 : _iter341.getValue())
              {
  ...
  private static class TopologyInfoTupleScheme extends TupleScheme<TopologyInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.uptime_secs);
      {
        ...
        for (ExecutorSummary _iter343 : struct.executors)
        {
      ...
      oprot.writeString(struct.status);
      {
        ...
        for (Map.Entry<String, List<ErrorInfo>> _iter344 : struct.errors.entrySet())
        {
          oprot.writeString(_iter344.getKey());
          {
            oprot.writeI32(_iter344.getValue().size());
            for (ErrorInfo _iter345 : _iter344.getValue())
            {
