            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.executors = new ArrayList<ExecutorSummary>(_list318.size);
                ExecutorSummary _elem319;
                for (int _i320 = 0; _i320 < _list318.size; ++_i320)
                {
                  _elem319 = new ExecutorSummary();
                  _elem319.read(iprot);
                  struct.executors.add(_elem319);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errors = new HashMap<String,List<ErrorInfo>>(2*_map321.size);
                String _key322;
                List<ErrorInfo> _val323;
                for (int _i324 = 0; _i324 < _map321.size; ++_i324)
                {
                  _key322 = iprot.readString();
                  {
                    ...
                    _val323 = new ArrayList<ErrorInfo>(_list325.size);
                    ErrorInfo _elem326;
                    for (int _i327 = 0; _i327 < _list325.size; ++_i327)
                    {
                      _elem326 = new ErrorInfo();
                      _elem326.read(iprot);
                      _val323.add(_elem326);
                    }
                    iprot.readListEnd();
                  }
                  struct.errors.put(_key322, _val323);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new HashMap<String,DebugOptions>(2*_map328.size);
                String _key329;
                DebugOptions _val330;
                for (int _i331 = 0; _i331 < _map328.size; ++_i331)
                {
                  _key329 = iprot.readString();
                  _val330 = new DebugOptions();
                  _val330.read(iprot);
                  struct.component_debug.put(_key329, _val330);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.executors != null) {
        oprot.writeFieldBegin(EXECUTORS_FIELD_DESC);
        {
          ...
          for (ExecutorSummary _iter332 : struct.executors)
          {
      ...
      if (struct.errors != null) {
        oprot.writeFieldBegin(ERRORS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, List<ErrorInfo>> _iter333 : struct.errors.entrySet())
          {
            oprot.writeString(_iter333.getKey());
            {
              ...
              for (ErrorInfo _iter334 : _iter333.getValue())
              {
      ...
      if (struct.component_debug != null) {
        if (struct.is_set_component_debug()) {
          oprot.writeFieldBegin(COMPONENT_DEBUG_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, DebugOptions> _iter335 : struct.component_debug.entrySet())
            {
  ...
  private static class TopologyInfoTupleScheme extends TupleScheme<TopologyInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.uptime_secs);
      {
        ...
        for (ExecutorSummary _iter336 : struct.executors)
        {
      ...
      oprot.writeString(struct.status);
      {
        ...
        for (Map.Entry<String, List<ErrorInfo>> _iter337 : struct.errors.entrySet())
        {
          oprot.writeString(_iter337.getKey());
          {
            oprot.writeI32(_iter337.getValue().size());
            for (ErrorInfo _iter338 : _iter337.getValue())
            {
      ...
      if (struct.is_set_component_debug()) {
        {
          ...
          for (Map.Entry<String, DebugOptions> _iter339 : struct.component_debug.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_uptime_secs_isSet(true);
      {
        ...
        struct.executors = new ArrayList<ExecutorSummary>(_list340.size);
        ExecutorSummary _elem341;
        for (int _i342 = 0; _i342 < _list340.size; ++_i342)
        {
          _elem341 = new ExecutorSummary();
          _elem341.read(iprot);
          struct.executors.add(_elem341);
        }
      }
      struct.set_executors_isSet(true);
      struct.status = iprot.readString();
      struct.set_status_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map343 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
        struct.errors = new HashMap<String,List<ErrorInfo>>(2*_map343.size);
        String _key344;
        List<ErrorInfo> _val345;
        for (int _i346 = 0; _i346 < _map343.size; ++_i346)
        {
          _key344 = iprot.readString();
          {
            ...
            _val345 = new ArrayList<ErrorInfo>(_list347.size);
            ErrorInfo _elem348;
            for (int _i349 = 0; _i349 < _list347.size; ++_i349)
            {
              _elem348 = new ErrorInfo();
              _elem348.read(iprot);
              _val345.add(_elem348);
            }
          }
          struct.errors.put(_key344, _val345);
        }
      }
      struct.set_errors_isSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.component_debug = new HashMap<String,DebugOptions>(2*_map350.size);
          String _key351;
          DebugOptions _val352;
          for (int _i353 = 0; _i353 < _map350.size; ++_i353)
          {
            _key351 = iprot.readString();
            _val352 = new DebugOptions();
            _val352.read(iprot);
            struct.component_debug.put(_key351, _val352);
          }
        }
        struct.set_component_debug_isSet(true);
      }
