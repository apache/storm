            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.executors = new ArrayList<ExecutorSummary>(_list370.size);
                ExecutorSummary _elem371;
                for (int _i372 = 0; _i372 < _list370.size; ++_i372)
                {
                  _elem371 = new ExecutorSummary();
                  _elem371.read(iprot);
                  struct.executors.add(_elem371);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errors = new HashMap<String,List<ErrorInfo>>(2*_map373.size);
                String _key374;
                List<ErrorInfo> _val375;
                for (int _i376 = 0; _i376 < _map373.size; ++_i376)
                {
                  _key374 = iprot.readString();
                  {
                    ...
                    _val375 = new ArrayList<ErrorInfo>(_list377.size);
                    ErrorInfo _elem378;
                    for (int _i379 = 0; _i379 < _list377.size; ++_i379)
                    {
                      _elem378 = new ErrorInfo();
                      _elem378.read(iprot);
                      _val375.add(_elem378);
                    }
                    iprot.readListEnd();
                  }
                  struct.errors.put(_key374, _val375);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.executors != null) {
        oprot.writeFieldBegin(EXECUTORS_FIELD_DESC);
        {
          ...
          for (ExecutorSummary _iter380 : struct.executors)
          {
      ...
      if (struct.errors != null) {
        oprot.writeFieldBegin(ERRORS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, List<ErrorInfo>> _iter381 : struct.errors.entrySet())
          {
            oprot.writeString(_iter381.getKey());
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter381.getValue().size()));
              for (ErrorInfo _iter382 : _iter381.getValue())
              {
  ...
  private static class TopologyInfoTupleScheme extends TupleScheme<TopologyInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.uptime_secs);
      {
        ...
        for (ExecutorSummary _iter383 : struct.executors)
        {
      ...
      oprot.writeString(struct.status);
      {
        ...
        for (Map.Entry<String, List<ErrorInfo>> _iter384 : struct.errors.entrySet())
        {
          oprot.writeString(_iter384.getKey());
          {
            oprot.writeI32(_iter384.getValue().size());
            for (ErrorInfo _iter385 : _iter384.getValue())
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_uptime_secs_isSet(true);
      {
        ...
        struct.executors = new ArrayList<ExecutorSummary>(_list386.size);
      ...
      struct.set_status_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map389 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
        struct.errors = new HashMap<String,List<ErrorInfo>>(2*_map389.size);
        String _key390;
        List<ErrorInfo> _val391;
        for (int _i392 = 0; _i392 < _map389.size; ++_i392)
        {
          _key390 = iprot.readString();
          {
            ...
            _val391 = new ArrayList<ErrorInfo>(_list393.size);
            ErrorInfo _elem394;
