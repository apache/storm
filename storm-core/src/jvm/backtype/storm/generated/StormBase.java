            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map454.size);
                String _key455;
                int _val456;
                for (int _i457 = 0; _i457 < _map454.size; ++_i457)
                {
                  ...
                  struct.component_executors.put(_key455, _val456);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter462 : struct.component_executors.entrySet())
            {
              oprot.writeString(_iter462.getKey());
              oprot.writeI32(_iter462.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.component_debug != null) {
        if (struct.is_set_component_debug()) {
          oprot.writeFieldBegin(COMPONENT_DEBUG_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, DebugOptions> _iter463 : struct.component_debug.entrySet())
            {
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter464 : struct.component_executors.entrySet())
          {
      ...
      if (struct.is_set_component_debug()) {
        {
          ...
          for (Map.Entry<String, DebugOptions> _iter465 : struct.component_debug.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.component_executors = new HashMap<String,Integer>(2*_map466.size);
          String _key467;
          int _val468;
          for (int _i469 = 0; _i469 < _map466.size; ++_i469)
          {
            ...
            struct.component_executors.put(_key467, _val468);
          }
        }
        struct.set_component_executors_isSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.component_debug = new HashMap<String,DebugOptions>(2*_map470.size);
          String _key471;
          DebugOptions _val472;
          for (int _i473 = 0; _i473 < _map470.size; ++_i473)
          {
            _key471 = iprot.readString();
            _val472 = new DebugOptions();
            _val472.read(iprot);
            struct.component_debug.put(_key471, _val472);
          }
        }
        struct.set_component_debug_isSet(true);
      }
