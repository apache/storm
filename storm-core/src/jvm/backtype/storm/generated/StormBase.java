...
public class StormBase implements org.apache.thrift.TBase<StormBase, StormBase._Fields>, java.io.Serializable, Cloneable, Comparable<StormBase> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map444.size);
                String _key445;
                int _val446;
                for (int _i447 = 0; _i447 < _map444.size; ++_i447)
                {
                  ...
                  struct.component_executors.put(_key445, _val446);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new HashMap<String,DebugOptions>(2*_map448.size);
                String _key449;
                DebugOptions _val450;
                for (int _i451 = 0; _i451 < _map448.size; ++_i451)
                {
                  _key449 = iprot.readString();
                  _val450 = new DebugOptions();
                  _val450.read(iprot);
                  struct.component_debug.put(_key449, _val450);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter452 : struct.component_executors.entrySet())
            {
              oprot.writeString(_iter452.getKey());
              oprot.writeI32(_iter452.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.component_debug != null) {
        if (struct.is_set_component_debug()) {
          oprot.writeFieldBegin(COMPONENT_DEBUG_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, DebugOptions> _iter453 : struct.component_debug.entrySet())
            {
  ...
  private static class StormBaseTupleScheme extends TupleScheme<StormBase> {
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter454 : struct.component_executors.entrySet())
          {
      ...
      if (struct.is_set_component_debug()) {
        {
          ...
          for (Map.Entry<String, DebugOptions> _iter455 : struct.component_debug.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormBase struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.component_executors = new HashMap<String,Integer>(2*_map456.size);
          String _key457;
          int _val458;
          for (int _i459 = 0; _i459 < _map456.size; ++_i459)
          {
            ...
            struct.component_executors.put(_key457, _val458);
          }
        }
        struct.set_component_executors_isSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map460 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.component_debug = new HashMap<String,DebugOptions>(2*_map460.size);
          String _key461;
          DebugOptions _val462;
          for (int _i463 = 0; _i463 < _map460.size; ++_i463)
          {
            _key461 = iprot.readString();
            _val462 = new DebugOptions();
            _val462.read(iprot);
            struct.component_debug.put(_key461, _val462);
          }
        }
        struct.set_component_debug_isSet(true);
      }
