...
public class StormBase implements org.apache.thrift.TBase<StormBase, StormBase._Fields>, java.io.Serializable, Cloneable, Comparable<StormBase> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map610.size);
                String _key611;
                int _val612;
                for (int _i613 = 0; _i613 < _map610.size; ++_i613)
                {
                  _key611 = iprot.readString();
                  _val612 = iprot.readI32();
                  struct.component_executors.put(_key611, _val612);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new HashMap<String,DebugOptions>(2*_map614.size);
                String _key615;
                DebugOptions _val616;
                for (int _i617 = 0; _i617 < _map614.size; ++_i617)
                {
                  _key615 = iprot.readString();
                  _val616 = new DebugOptions();
                  _val616.read(iprot);
                  struct.component_debug.put(_key615, _val616);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter618 : struct.component_executors.entrySet())
            {
      ...
      if (struct.component_debug != null) {
        if (struct.is_set_component_debug()) {
          oprot.writeFieldBegin(COMPONENT_DEBUG_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, DebugOptions> _iter619 : struct.component_debug.entrySet())
            {
  ...
  private static class StormBaseTupleScheme extends TupleScheme<StormBase> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormBase struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map622 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.component_executors = new HashMap<String,Integer>(2*_map622.size);
          String _key623;
          int _val624;
          for (int _i625 = 0; _i625 < _map622.size; ++_i625)
          {
            ...
            struct.component_executors.put(_key623, _val624);
          }
        }
        struct.set_component_executors_isSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map626 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.component_debug = new HashMap<String,DebugOptions>(2*_map626.size);
          String _key627;
          DebugOptions _val628;
          for (int _i629 = 0; _i629 < _map626.size; ++_i629)
          {
            _key627 = iprot.readString();
            _val628 = new DebugOptions();
            _val628.read(iprot);
            struct.component_debug.put(_key627, _val628);
          }
        }
        struct.set_component_debug_isSet(true);
      }
