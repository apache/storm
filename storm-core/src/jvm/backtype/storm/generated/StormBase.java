...
public class StormBase implements org.apache.thrift.TBase<StormBase, StormBase._Fields>, java.io.Serializable, Cloneable, Comparable<StormBase> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map436.size);
                String _key437;
                int _val438;
                for (int _i439 = 0; _i439 < _map436.size; ++_i439)
                {
                  ...
                  struct.component_executors.put(_key437, _val438);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter440 : struct.component_executors.entrySet())
            {
              oprot.writeString(_iter440.getKey());
              oprot.writeI32(_iter440.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class StormBaseTupleScheme extends TupleScheme<StormBase> {
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter441 : struct.component_executors.entrySet())
          {
            oprot.writeString(_iter441.getKey());
            oprot.writeI32(_iter441.getValue());
          }
        }
      }
      if (struct.is_set_launch_time_secs()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormBase struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map442 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.component_executors = new HashMap<String,Integer>(2*_map442.size);
          String _key443;
          int _val444;
          for (int _i445 = 0; _i445 < _map442.size; ++_i445)
          {
            _key443 = iprot.readString();
            _val444 = iprot.readI32();
            struct.component_executors.put(_key443, _val444);
          }
        }
        struct.set_component_executors_isSet(true);
      }
