...
public class NodeInfo implements org.apache.thrift.TBase<NodeInfo, NodeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<NodeInfo> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // PORT
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set382 = iprot.readSetBegin();
                struct.port = new HashSet<Long>(2*_set382.size);
                long _elem383;
                for (int _i384 = 0; _i384 < _set382.size; ++_i384)
                {
                  _elem383 = iprot.readI64();
                  struct.port.add(_elem383);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_node_isSet(true);
      {
        org.apache.thrift.protocol.TSet _set387 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.port = new HashSet<Long>(2*_set387.size);
        long _elem388;
        for (int _i389 = 0; _i389 < _set387.size; ++_i389)
        {
          _elem388 = iprot.readI64();
          struct.port.add(_elem388);
        }
      }
      struct.set_port_isSet(true);
    }
