            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.port = new HashSet<Long>(2*_set402.size);
                long _elem403;
                for (int _i404 = 0; _i404 < _set402.size; ++_i404)
                {
                  _elem403 = iprot.readI64();
                  struct.port.add(_elem403);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_node_isSet(true);
      {
        ...
        struct.port = new HashSet<Long>(2*_set407.size);
        long _elem408;
        for (int _i409 = 0; _i409 < _set407.size; ++_i409)
        {
          _elem408 = iprot.readI64();
          struct.port.add(_elem408);
        }
      }
      struct.set_port_isSet(true);
    }
