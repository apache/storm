...
public class NodeInfo implements org.apache.thrift.TBase<NodeInfo, NodeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<NodeInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.port = new HashSet<Long>(2*_set400.size);
                long _elem401;
                for (int _i402 = 0; _i402 < _set400.size; ++_i402)
                {
                  _elem401 = iprot.readI64();
                  struct.port.add(_elem401);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.port != null) {
        oprot.writeFieldBegin(PORT_FIELD_DESC);
        {
          ...
          for (long _iter403 : struct.port)
          {
            oprot.writeI64(_iter403);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_node_isSet(true);
      {
        org.apache.thrift.protocol.TSet _set405 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.port = new HashSet<Long>(2*_set405.size);
        long _elem406;
        for (int _i407 = 0; _i407 < _set405.size; ++_i407)
        {
          _elem406 = iprot.readI64();
          struct.port.add(_elem406);
        }
      }
      struct.set_port_isSet(true);
    }
