...
public class NodeInfo implements org.apache.thrift.TBase<NodeInfo, NodeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<NodeInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.port = new HashSet<Long>(2*_set546.size);
                long _elem547;
                for (int _i548 = 0; _i548 < _set546.size; ++_i548)
                {
                  _elem547 = iprot.readI64();
                  struct.port.add(_elem547);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_node_isSet(true);
      {
        org.apache.thrift.protocol.TSet _set551 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.port = new HashSet<Long>(2*_set551.size);
        long _elem552;
        for (int _i553 = 0; _i553 < _set551.size; ++_i553)
        {
          _elem552 = iprot.readI64();
          struct.port.add(_elem552);
        }
      }
      struct.set_port_isSet(true);
    }
