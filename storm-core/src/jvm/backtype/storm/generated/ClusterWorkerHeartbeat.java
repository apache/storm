            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map474.size);
                ExecutorInfo _key475;
                ExecutorStats _val476;
                for (int _i477 = 0; _i477 < _map474.size; ++_i477)
                {
                  _key475 = new ExecutorInfo();
                  _key475.read(iprot);
                  _val476 = new ExecutorStats();
                  _val476.read(iprot);
                  struct.executor_stats.put(_key475, _val476);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_stats != null) {
        oprot.writeFieldBegin(EXECUTOR_STATS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ExecutorInfo, ExecutorStats> _iter478 : struct.executor_stats.entrySet())
          {
            _iter478.getKey().write(oprot);
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.storm_id);
      {
        ...
        for (Map.Entry<ExecutorInfo, ExecutorStats> _iter479 : struct.executor_stats.entrySet())
        {
          _iter479.getKey().write(oprot);
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map480 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map480.size);
        ExecutorInfo _key481;
        ExecutorStats _val482;
        for (int _i483 = 0; _i483 < _map480.size; ++_i483)
        {
          _key481 = new ExecutorInfo();
          _key481.read(iprot);
          _val482 = new ExecutorStats();
          _val482.read(iprot);
          struct.executor_stats.put(_key481, _val482);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
