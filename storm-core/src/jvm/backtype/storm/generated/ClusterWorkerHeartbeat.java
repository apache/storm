            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map620.size);
                ExecutorInfo _key621;
                ExecutorStats _val622;
                for (int _i623 = 0; _i623 < _map620.size; ++_i623)
                {
                  _key621 = new ExecutorInfo();
                  _key621.read(iprot);
                  _val622 = new ExecutorStats();
                  _val622.read(iprot);
                  struct.executor_stats.put(_key621, _val622);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_stats != null) {
        oprot.writeFieldBegin(EXECUTOR_STATS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ExecutorInfo, ExecutorStats> _iter624 : struct.executor_stats.entrySet())
          {
            _iter624.getKey().write(oprot);
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.storm_id);
      {
        ...
        for (Map.Entry<ExecutorInfo, ExecutorStats> _iter625 : struct.executor_stats.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map626 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map626.size);
        ExecutorInfo _key627;
        ExecutorStats _val628;
        for (int _i629 = 0; _i629 < _map626.size; ++_i629)
        {
          _key627 = new ExecutorInfo();
          _key627.read(iprot);
          _val628 = new ExecutorStats();
          _val628.read(iprot);
          struct.executor_stats.put(_key627, _val628);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
