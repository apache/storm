            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.system_stats = new HashMap<String,Double>(2*_map450.size);
                String _key451;
                double _val452;
                for (int _i453 = 0; _i453 < _map450.size; ++_i453)
                {
                  ...
                  struct.system_stats.put(_key451, _val452);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_stats != null) {
        oprot.writeFieldBegin(EXECUTOR_STATS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ExecutorInfo, ExecutorStats> _iter454 : struct.executor_stats.entrySet())
          {
      ...
      if (struct.system_stats != null) {
        if (struct.is_set_system_stats()) {
          oprot.writeFieldBegin(SYSTEM_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter455 : struct.system_stats.entrySet())
            {
              oprot.writeString(_iter455.getKey());
              oprot.writeDouble(_iter455.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.storm_id);
      {
        ...
        for (Map.Entry<ExecutorInfo, ExecutorStats> _iter456 : struct.executor_stats.entrySet())
        {
          _iter456.getKey().write(oprot);
      ...
      if (struct.is_set_system_stats()) {
        {
          ...
          for (Map.Entry<String, Double> _iter457 : struct.system_stats.entrySet())
          {
            oprot.writeString(_iter457.getKey());
            oprot.writeDouble(_iter457.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map458 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map458.size);
        ExecutorInfo _key459;
        ExecutorStats _val460;
        for (int _i461 = 0; _i461 < _map458.size; ++_i461)
        {
          _key459 = new ExecutorInfo();
          _key459.read(iprot);
          _val460 = new ExecutorStats();
          _val460.read(iprot);
          struct.executor_stats.put(_key459, _val460);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map462 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.system_stats = new HashMap<String,Double>(2*_map462.size);
          String _key463;
          double _val464;
          for (int _i465 = 0; _i465 < _map462.size; ++_i465)
          {
            _key463 = iprot.readString();
            _val464 = iprot.readDouble();
            struct.system_stats.put(_key463, _val464);
          }
        }
        struct.set_system_stats_isSet(true);
      }
