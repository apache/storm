            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map466.size);
                ExecutorInfo _key467;
                ExecutorStats _val468;
                for (int _i469 = 0; _i469 < _map466.size; ++_i469)
                {
                  _key467 = new ExecutorInfo();
                  _key467.read(iprot);
                  _val468 = new ExecutorStats();
                  _val468.read(iprot);
                  struct.executor_stats.put(_key467, _val468);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_stats != null) {
        oprot.writeFieldBegin(EXECUTOR_STATS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ExecutorInfo, ExecutorStats> _iter470 : struct.executor_stats.entrySet())
          {
            _iter470.getKey().write(oprot);
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.storm_id);
      {
        ...
        for (Map.Entry<ExecutorInfo, ExecutorStats> _iter471 : struct.executor_stats.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map472 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map472.size);
        ExecutorInfo _key473;
        ExecutorStats _val474;
        for (int _i475 = 0; _i475 < _map472.size; ++_i475)
        {
          _key473 = new ExecutorInfo();
          _key473.read(iprot);
          _val474 = new ExecutorStats();
          _val474.read(iprot);
          struct.executor_stats.put(_key473, _val474);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
