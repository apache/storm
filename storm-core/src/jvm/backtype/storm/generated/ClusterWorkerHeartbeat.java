            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map464.size);
                ExecutorInfo _key465;
                ExecutorStats _val466;
                for (int _i467 = 0; _i467 < _map464.size; ++_i467)
                {
                  _key465 = new ExecutorInfo();
                  _key465.read(iprot);
                  _val466 = new ExecutorStats();
                  _val466.read(iprot);
                  struct.executor_stats.put(_key465, _val466);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_stats != null) {
        oprot.writeFieldBegin(EXECUTOR_STATS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ExecutorInfo, ExecutorStats> _iter468 : struct.executor_stats.entrySet())
          {
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.storm_id);
      {
        ...
        for (Map.Entry<ExecutorInfo, ExecutorStats> _iter469 : struct.executor_stats.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map470 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map470.size);
        ExecutorInfo _key471;
        ExecutorStats _val472;
        for (int _i473 = 0; _i473 < _map470.size; ++_i473)
        {
          _key471 = new ExecutorInfo();
          _key471.read(iprot);
          _val472 = new ExecutorStats();
          _val472.read(iprot);
          struct.executor_stats.put(_key471, _val472);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
