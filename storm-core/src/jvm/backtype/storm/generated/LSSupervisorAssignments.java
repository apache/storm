            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map502.size);
                int _key503;
                LocalAssignment _val504;
                for (int _i505 = 0; _i505 < _map502.size; ++_i505)
                {
                  _key503 = iprot.readI32();
                  _val504 = new LocalAssignment();
                  _val504.read(iprot);
                  struct.assignments.put(_key503, _val504);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      if (struct.assignments != null) {
        oprot.writeFieldBegin(ASSIGNMENTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, LocalAssignment> _iter506 : struct.assignments.entrySet())
          {
            oprot.writeI32(_iter506.getKey());
  ...
  private static class LSSupervisorAssignmentsTupleScheme extends TupleScheme<LSSupervisorAssignments> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<Integer, LocalAssignment> _iter507 : struct.assignments.entrySet())
        {
          oprot.writeI32(_iter507.getKey());
          _iter507.getValue().write(oprot);
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map508 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map508.size);
        int _key509;
        LocalAssignment _val510;
        for (int _i511 = 0; _i511 < _map508.size; ++_i511)
        {
          _key509 = iprot.readI32();
          _val510 = new LocalAssignment();
          _val510.read(iprot);
          struct.assignments.put(_key509, _val510);
        }
      }
      struct.set_assignments_isSet(true);
    }
