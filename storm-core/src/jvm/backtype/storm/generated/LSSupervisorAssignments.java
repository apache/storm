            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map494.size);
                int _key495;
                LocalAssignment _val496;
                for (int _i497 = 0; _i497 < _map494.size; ++_i497)
                {
                  _key495 = iprot.readI32();
                  _val496 = new LocalAssignment();
                  _val496.read(iprot);
                  struct.assignments.put(_key495, _val496);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      if (struct.assignments != null) {
        oprot.writeFieldBegin(ASSIGNMENTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, LocalAssignment> _iter498 : struct.assignments.entrySet())
          {
            oprot.writeI32(_iter498.getKey());
  ...
  private static class LSSupervisorAssignmentsTupleScheme extends TupleScheme<LSSupervisorAssignments> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<Integer, LocalAssignment> _iter499 : struct.assignments.entrySet())
        {
          oprot.writeI32(_iter499.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map500 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map500.size);
        int _key501;
        LocalAssignment _val502;
        for (int _i503 = 0; _i503 < _map500.size; ++_i503)
        {
          _key501 = iprot.readI32();
          _val502 = new LocalAssignment();
          _val502.read(iprot);
          struct.assignments.put(_key501, _val502);
        }
      }
      struct.set_assignments_isSet(true);
    }
