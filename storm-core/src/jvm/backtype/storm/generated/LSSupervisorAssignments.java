            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map512.size);
                int _key513;
                LocalAssignment _val514;
                for (int _i515 = 0; _i515 < _map512.size; ++_i515)
                {
                  _key513 = iprot.readI32();
                  _val514 = new LocalAssignment();
                  _val514.read(iprot);
                  struct.assignments.put(_key513, _val514);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      if (struct.assignments != null) {
        oprot.writeFieldBegin(ASSIGNMENTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, LocalAssignment> _iter516 : struct.assignments.entrySet())
          {
            oprot.writeI32(_iter516.getKey());
  ...
  private static class LSSupervisorAssignmentsTupleScheme extends TupleScheme<LSSupervisorAssignments> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<Integer, LocalAssignment> _iter517 : struct.assignments.entrySet())
        {
          oprot.writeI32(_iter517.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map518 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map518.size);
        int _key519;
        LocalAssignment _val520;
        for (int _i521 = 0; _i521 < _map518.size; ++_i521)
        {
          _key519 = iprot.readI32();
          _val520 = new LocalAssignment();
          _val520.read(iprot);
          struct.assignments.put(_key519, _val520);
        }
      }
      struct.set_assignments_isSet(true);
    }
