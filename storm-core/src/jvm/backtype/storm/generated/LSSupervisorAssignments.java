            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map658.size);
                int _key659;
                LocalAssignment _val660;
                for (int _i661 = 0; _i661 < _map658.size; ++_i661)
                {
                  _key659 = iprot.readI32();
                  _val660 = new LocalAssignment();
                  _val660.read(iprot);
                  struct.assignments.put(_key659, _val660);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      if (struct.assignments != null) {
        oprot.writeFieldBegin(ASSIGNMENTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, LocalAssignment> _iter662 : struct.assignments.entrySet())
          {
            oprot.writeI32(_iter662.getKey());
  ...
  private static class LSSupervisorAssignmentsTupleScheme extends TupleScheme<LSSupervisorAssignments> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<Integer, LocalAssignment> _iter663 : struct.assignments.entrySet())
        {
          oprot.writeI32(_iter663.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map664 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map664.size);
        int _key665;
        LocalAssignment _val666;
        for (int _i667 = 0; _i667 < _map664.size; ++_i667)
        {
          _key665 = iprot.readI32();
          _val666 = new LocalAssignment();
          _val666.read(iprot);
          struct.assignments.put(_key665, _val666);
        }
      }
      struct.set_assignments_isSet(true);
    }
