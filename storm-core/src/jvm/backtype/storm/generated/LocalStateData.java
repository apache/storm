            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map474.size);
                String _key475;
                ThriftSerializedObject _val476;
                for (int _i477 = 0; _i477 < _map474.size; ++_i477)
                {
                  _key475 = iprot.readString();
                  _val476 = new ThriftSerializedObject();
                  _val476.read(iprot);
                  struct.serialized_parts.put(_key475, _val476);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, ThriftSerializedObject> _iter478 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, ThriftSerializedObject> _iter479 : struct.serialized_parts.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map480.size);
        String _key481;
        ThriftSerializedObject _val482;
        for (int _i483 = 0; _i483 < _map480.size; ++_i483)
        {
          _key481 = iprot.readString();
          _val482 = new ThriftSerializedObject();
          _val482.read(iprot);
          struct.serialized_parts.put(_key481, _val482);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
