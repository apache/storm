            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map630.size);
                String _key631;
                ThriftSerializedObject _val632;
                for (int _i633 = 0; _i633 < _map630.size; ++_i633)
                {
                  _key631 = iprot.readString();
                  _val632 = new ThriftSerializedObject();
                  _val632.read(iprot);
                  struct.serialized_parts.put(_key631, _val632);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, ThriftSerializedObject> _iter634 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, ThriftSerializedObject> _iter635 : struct.serialized_parts.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map636.size);
        String _key637;
        ThriftSerializedObject _val638;
        for (int _i639 = 0; _i639 < _map636.size; ++_i639)
        {
          _key637 = iprot.readString();
          _val638 = new ThriftSerializedObject();
          _val638.read(iprot);
          struct.serialized_parts.put(_key637, _val638);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
