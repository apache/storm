            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map466.size);
                String _key467;
                ThriftSerializedObject _val468;
                for (int _i469 = 0; _i469 < _map466.size; ++_i469)
                {
                  _key467 = iprot.readString();
                  _val468 = new ThriftSerializedObject();
                  _val468.read(iprot);
                  struct.serialized_parts.put(_key467, _val468);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, ThriftSerializedObject> _iter470 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, ThriftSerializedObject> _iter471 : struct.serialized_parts.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map472.size);
        String _key473;
        ThriftSerializedObject _val474;
        for (int _i475 = 0; _i475 < _map472.size; ++_i475)
        {
          _key473 = iprot.readString();
          _val474 = new ThriftSerializedObject();
          _val474.read(iprot);
          struct.serialized_parts.put(_key473, _val474);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
