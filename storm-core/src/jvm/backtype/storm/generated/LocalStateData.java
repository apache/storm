            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map484.size);
                String _key485;
                ThriftSerializedObject _val486;
                for (int _i487 = 0; _i487 < _map484.size; ++_i487)
                {
                  _key485 = iprot.readString();
                  _val486 = new ThriftSerializedObject();
                  _val486.read(iprot);
                  struct.serialized_parts.put(_key485, _val486);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, ThriftSerializedObject> _iter488 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, ThriftSerializedObject> _iter489 : struct.serialized_parts.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map490.size);
        String _key491;
        ThriftSerializedObject _val492;
        for (int _i493 = 0; _i493 < _map490.size; ++_i493)
        {
          _key491 = iprot.readString();
          _val492 = new ThriftSerializedObject();
          _val492.read(iprot);
          struct.serialized_parts.put(_key491, _val492);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
