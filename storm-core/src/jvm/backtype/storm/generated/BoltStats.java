...
public class BoltStats implements org.apache.thrift.TBase<BoltStats, BoltStats._Fields>, java.io.Serializable, Cloneable, Comparable<BoltStats> {
  ...
  private static final org.apache.thrift.protocol.TField DESERIALIZE_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("deserialize_time", org.apache.thrift.protocol.TType.MAP, (short)6);
  ...
  private Map<String,Map<GlobalStreamId,Double>> deserialize_time; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    DESERIALIZE_TIME((short)6, "deserialize_time");
  ...
  public BoltStats(
    ...
    Map<String,Map<GlobalStreamId,Double>> deserialize_time)
  {
    this();
    this.acked = acked;
    this.failed = failed;
  ...
  public BoltStats(BoltStats other) {
    ...
    if (other.is_set_deserialize_time()) {
      Map<String,Map<GlobalStreamId,Double>> __this__deserialize_time = new HashMap<String,Map<GlobalStreamId,Double>>(other.deserialize_time.size());
      for (Map.Entry<String, Map<GlobalStreamId,Double>> other_element : other.deserialize_time.entrySet()) {
        ...
        Map<GlobalStreamId,Double> __this__deserialize_time_copy_value = new HashMap<GlobalStreamId,Double>(other_element_value.size());
        for (Map.Entry<GlobalStreamId, Double> other_element_value_element : other_element_value.entrySet()) {

          GlobalStreamId other_element_value_element_key = other_element_value_element.getKey();
          Double other_element_value_element_value = other_element_value_element.getValue();

          GlobalStreamId __this__deserialize_time_copy_value_copy_key = new GlobalStreamId(other_element_value_element_key);

          Double __this__deserialize_time_copy_value_copy_value = other_element_value_element_value;

          __this__deserialize_time_copy_value.put(__this__deserialize_time_copy_value_copy_key, __this__deserialize_time_copy_value_copy_value);
        }
  ...
  public void put_to_deserialize_time(String key, Map<GlobalStreamId,Double> val) {
    if (this.deserialize_time == null) {
      this.deserialize_time = new HashMap<String,Map<GlobalStreamId,Double>>();
    }
    this.deserialize_time.put(key, val);
  }

  public Map<String,Map<GlobalStreamId,Double>> get_deserialize_time() {
    return this.deserialize_time;
  }

  public void set_deserialize_time(Map<String,Map<GlobalStreamId,Double>> deserialize_time) {
    this.deserialize_time = deserialize_time;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DESERIALIZE_TIME:
      if (value == null) {
        ...
        set_deserialize_time((Map<String,Map<GlobalStreamId,Double>>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.deserialize_time = new HashMap<String,Map<GlobalStreamId,Double>>(2*_map130.size);
                String _key131;
                ...
                for (int _i133 = 0; _i133 < _map130.size; ++_i133)
                {
                  ...
                  struct.deserialize_time.put(_key131, _val132);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BoltStats struct) throws org.apache.thrift.TException {
      ...
      if (struct.deserialize_time != null) {
        oprot.writeFieldBegin(DESERIALIZE_TIME_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Map<GlobalStreamId,Double>> _iter148 : struct.deserialize_time.entrySet())
          {
  ...
  private static class BoltStatsTupleScheme extends TupleScheme<BoltStats> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, BoltStats struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter150 : struct.acked.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter152 : struct.failed.entrySet())
        {
          oprot.writeString(_iter152.getKey());
          {
            oprot.writeI32(_iter152.getValue().size());
            for (Map.Entry<GlobalStreamId, Long> _iter153 : _iter152.getValue().entrySet())
            {
      ...
      }
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Double>> _iter154 : struct.process_ms_avg.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter156 : struct.executed.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Double>> _iter158 : struct.execute_ms_avg.entrySet())
        {
          oprot.writeString(_iter158.getKey());
          {
            oprot.writeI32(_iter158.getValue().size());
            for (Map.Entry<GlobalStreamId, Double> _iter159 : _iter158.getValue().entrySet())
            {
      ...
      }
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Double>> _iter160 : struct.deserialize_time.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, BoltStats struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.acked = new HashMap<String,Map<GlobalStreamId,Long>>(2*_map162.size);
        String _key163;
        Map<GlobalStreamId,Long> _val164;
        for (int _i165 = 0; _i165 < _map162.size; ++_i165)
        {
          _key163 = iprot.readString();
          {
            org.apache.thrift.protocol.TMap _map166 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.I64, iprot.readI32());
            _val164 = new HashMap<GlobalStreamId,Long>(2*_map166.size);
            GlobalStreamId _key167;
            long _val168;
            for (int _i169 = 0; _i169 < _map166.size; ++_i169)
            {
              _key167 = new GlobalStreamId();
              _key167.read(iprot);
              _val168 = iprot.readI64();
              _val164.put(_key167, _val168);
            }
          }
          struct.acked.put(_key163, _val164);
        }
      }
      struct.set_acked_isSet(true);
      {
        ...
        struct.failed = new HashMap<String,Map<GlobalStreamId,Long>>(2*_map170.size);
        String _key171;
        Map<GlobalStreamId,Long> _val172;
        for (int _i173 = 0; _i173 < _map170.size; ++_i173)
        {
          _key171 = iprot.readString();
          {
            org.apache.thrift.protocol.TMap _map174 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.I64, iprot.readI32());
            _val172 = new HashMap<GlobalStreamId,Long>(2*_map174.size);
            GlobalStreamId _key175;
            long _val176;
            for (int _i177 = 0; _i177 < _map174.size; ++_i177)
            {
              _key175 = new GlobalStreamId();
              _key175.read(iprot);
              _val176 = iprot.readI64();
              _val172.put(_key175, _val176);
            }
          }
          struct.failed.put(_key171, _val172);
        }
      }
      struct.set_failed_isSet(true);
      {
        ...
        struct.process_ms_avg = new HashMap<String,Map<GlobalStreamId,Double>>(2*_map178.size);
        String _key179;
        Map<GlobalStreamId,Double> _val180;
        for (int _i181 = 0; _i181 < _map178.size; ++_i181)
        {
          _key179 = iprot.readString();
          {
            ...
            _val180 = new HashMap<GlobalStreamId,Double>(2*_map182.size);
            GlobalStreamId _key183;
            double _val184;
            for (int _i185 = 0; _i185 < _map182.size; ++_i185)
            {
              _key183 = new GlobalStreamId();
              _key183.read(iprot);
              _val184 = iprot.readDouble();
              _val180.put(_key183, _val184);
            }
          }
          struct.process_ms_avg.put(_key179, _val180);
        }
      }
      struct.set_process_ms_avg_isSet(true);
      {
        ...
        struct.executed = new HashMap<String,Map<GlobalStreamId,Long>>(2*_map186.size);
        String _key187;
        ...
        for (int _i189 = 0; _i189 < _map186.size; ++_i189)
        {
          ...
          struct.executed.put(_key187, _val188);
        }
      }
      struct.set_executed_isSet(true);
      {
        ...
        struct.execute_ms_avg = new HashMap<String,Map<GlobalStreamId,Double>>(2*_map194.size);
        String _key195;
        Map<GlobalStreamId,Double> _val196;
        for (int _i197 = 0; _i197 < _map194.size; ++_i197)
        {
          _key195 = iprot.readString();
          {
            org.apache.thrift.protocol.TMap _map198 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
            _val196 = new HashMap<GlobalStreamId,Double>(2*_map198.size);
          ...
          struct.execute_ms_avg.put(_key195, _val196);
        }
      }
      struct.set_execute_ms_avg_isSet(true);
      {
        ...
        struct.deserialize_time = new HashMap<String,Map<GlobalStreamId,Double>>(2*_map202.size);
        String _key203;
        ...
        for (int _i205 = 0; _i205 < _map202.size; ++_i205)
        {
          ...
          struct.deserialize_time.put(_key203, _val204);
        }
      }
      struct.set_deserialize_time_isSet(true);
    }
