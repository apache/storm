            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.receive_queue_length = new HashMap<String,Map<String,Double>>(2*_map130.size);
                String _key131;
                Map<String,Double> _val132;
                for (int _i133 = 0; _i133 < _map130.size; ++_i133)
                {
                  _key131 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TMap _map134 = iprot.readMapBegin();
                    _val132 = new HashMap<String,Double>(2*_map134.size);
                    String _key135;
                    double _val136;
                  ...
                  struct.receive_queue_length.put(_key131, _val132);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.batch_transfer_queue_length = new HashMap<String,Map<String,Double>>(2*_map138.size);
                String _key139;
                Map<String,Double> _val140;
                for (int _i141 = 0; _i141 < _map138.size; ++_i141)
                {
                  _key139 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TMap _map142 = iprot.readMapBegin();
                    _val140 = new HashMap<String,Double>(2*_map142.size);
                    String _key143;
                    double _val144;
                  ...
                  struct.batch_transfer_queue_length.put(_key139, _val140);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BoltStats struct) throws org.apache.thrift.TException {
      ...
      if (struct.acked != null) {
        oprot.writeFieldBegin(ACKED_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter146 : struct.acked.entrySet())
          {
      ...
      if (struct.failed != null) {
        oprot.writeFieldBegin(FAILED_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter148 : struct.failed.entrySet())
          {
      ...
      if (struct.process_ms_avg != null) {
        oprot.writeFieldBegin(PROCESS_MS_AVG_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Map<GlobalStreamId,Double>> _iter150 : struct.process_ms_avg.entrySet())
          {
            oprot.writeString(_iter150.getKey());
            {
              oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.DOUBLE, _iter150.getValue().size()));
              for (Map.Entry<GlobalStreamId, Double> _iter151 : _iter150.getValue().entrySet())
              {
      ...
      if (struct.executed != null) {
        oprot.writeFieldBegin(EXECUTED_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter152 : struct.executed.entrySet())
          {
            oprot.writeString(_iter152.getKey());
            {
              oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.I64, _iter152.getValue().size()));
      ...
      if (struct.execute_ms_avg != null) {
        oprot.writeFieldBegin(EXECUTE_MS_AVG_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Map<GlobalStreamId,Double>> _iter154 : struct.execute_ms_avg.entrySet())
          {
            oprot.writeString(_iter154.getKey());
            {
              oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.DOUBLE, _iter154.getValue().size()));
      ...
      if (struct.receive_queue_length != null) {
        if (struct.is_set_receive_queue_length()) {
          oprot.writeFieldBegin(RECEIVE_QUEUE_LENGTH_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Map<String,Double>> _iter156 : struct.receive_queue_length.entrySet())
            {
              oprot.writeString(_iter156.getKey());
              {
                oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, _iter156.getValue().size()));
                for (Map.Entry<String, Double> _iter157 : _iter156.getValue().entrySet())
                {
      ...
      if (struct.batch_transfer_queue_length != null) {
        if (struct.is_set_batch_transfer_queue_length()) {
          oprot.writeFieldBegin(BATCH_TRANSFER_QUEUE_LENGTH_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Map<String,Double>> _iter158 : struct.batch_transfer_queue_length.entrySet())
            {
              oprot.writeString(_iter158.getKey());
              {
                oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, _iter158.getValue().size()));
                for (Map.Entry<String, Double> _iter159 : _iter158.getValue().entrySet())
                {
  ...
  private static class BoltStatsTupleScheme extends TupleScheme<BoltStats> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, BoltStats struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter160 : struct.acked.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter162 : struct.failed.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Double>> _iter164 : struct.process_ms_avg.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Long>> _iter166 : struct.executed.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Map<GlobalStreamId,Double>> _iter168 : struct.execute_ms_avg.entrySet())
        {
      ...
      if (struct.is_set_receive_queue_length()) {
        {
          ...
          for (Map.Entry<String, Map<String,Double>> _iter170 : struct.receive_queue_length.entrySet())
          {
            oprot.writeString(_iter170.getKey());
            {
              oprot.writeI32(_iter170.getValue().size());
              for (Map.Entry<String, Double> _iter171 : _iter170.getValue().entrySet())
              {
      ...
      if (struct.is_set_batch_transfer_queue_length()) {
        {
          ...
          for (Map.Entry<String, Map<String,Double>> _iter172 : struct.batch_transfer_queue_length.entrySet())
          {
            oprot.writeString(_iter172.getKey());
            {
              oprot.writeI32(_iter172.getValue().size());
              for (Map.Entry<String, Double> _iter173 : _iter172.getValue().entrySet())
              {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, BoltStats struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.acked = new HashMap<String,Map<GlobalStreamId,Long>>(2*_map174.size);
        String _key175;
        ...
        for (int _i177 = 0; _i177 < _map174.size; ++_i177)
        {
          ...
          struct.acked.put(_key175, _val176);
        }
      }
      struct.set_acked_isSet(true);
      {
        ...
        struct.failed = new HashMap<String,Map<GlobalStreamId,Long>>(2*_map182.size);
        String _key183;
        ...
        for (int _i185 = 0; _i185 < _map182.size; ++_i185)
        {
          ...
          struct.failed.put(_key183, _val184);
        }
      }
      struct.set_failed_isSet(true);
      {
        ...
        struct.process_ms_avg = new HashMap<String,Map<GlobalStreamId,Double>>(2*_map190.size);
        String _key191;
        ...
        for (int _i193 = 0; _i193 < _map190.size; ++_i193)
        {
          ...
          struct.process_ms_avg.put(_key191, _val192);
        }
      }
      struct.set_process_ms_avg_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map198 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP, iprot.readI32());
        struct.executed = new HashMap<String,Map<GlobalStreamId,Long>>(2*_map198.size);
        String _key199;
        Map<GlobalStreamId,Long> _val200;
        for (int _i201 = 0; _i201 < _map198.size; ++_i201)
        {
          _key199 = iprot.readString();
          {
            org.apache.thrift.protocol.TMap _map202 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.I64, iprot.readI32());
            _val200 = new HashMap<GlobalStreamId,Long>(2*_map202.size);
            GlobalStreamId _key203;
            long _val204;
          ...
          struct.executed.put(_key199, _val200);
        }
      }
      struct.set_executed_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map206 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP, iprot.readI32());
        struct.execute_ms_avg = new HashMap<String,Map<GlobalStreamId,Double>>(2*_map206.size);
        String _key207;
        Map<GlobalStreamId,Double> _val208;
        for (int _i209 = 0; _i209 < _map206.size; ++_i209)
        {
          _key207 = iprot.readString();
          {
            org.apache.thrift.protocol.TMap _map210 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
            _val208 = new HashMap<GlobalStreamId,Double>(2*_map210.size);
            GlobalStreamId _key211;
            double _val212;
          ...
          struct.execute_ms_avg.put(_key207, _val208);
        }
      }
      struct.set_execute_ms_avg_isSet(true);
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map214 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP, iprot.readI32());
          struct.receive_queue_length = new HashMap<String,Map<String,Double>>(2*_map214.size);
          String _key215;
          ...
          for (int _i217 = 0; _i217 < _map214.size; ++_i217)
          {
            ...
            {
              org.apache.thrift.protocol.TMap _map218 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
            ...
            struct.receive_queue_length.put(_key215, _val216);
          }
        }
        struct.set_receive_queue_length_isSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.batch_transfer_queue_length = new HashMap<String,Map<String,Double>>(2*_map222.size);
          String _key223;
          Map<String,Double> _val224;
          for (int _i225 = 0; _i225 < _map222.size; ++_i225)
          {
            _key223 = iprot.readString();
            {
              org.apache.thrift.protocol.TMap _map226 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
              _val224 = new HashMap<String,Double>(2*_map226.size);
              String _key227;
              double _val228;
            ...
            struct.batch_transfer_queue_length.put(_key223, _val224);
          }
        }
        struct.set_batch_transfer_queue_length_isSet(true);
      }
