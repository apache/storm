            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.num_executors = new HashMap<String,Integer>(2*_map356.size);
                String _key357;
                int _val358;
                for (int _i359 = 0; _i359 < _map356.size; ++_i359)
                {
                  ...
                  struct.num_executors.put(_key357, _val358);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.num_executors != null) {
        if (struct.is_set_num_executors()) {
          oprot.writeFieldBegin(NUM_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter360 : struct.num_executors.entrySet())
            {
      ...
      if (struct.is_set_num_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter361 : struct.num_executors.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.num_executors = new HashMap<String,Integer>(2*_map362.size);
          String _key363;
          int _val364;
          for (int _i365 = 0; _i365 < _map362.size; ++_i365)
          {
            ...
            struct.num_executors.put(_key363, _val364);
          }
        }
        struct.set_num_executors_isSet(true);
      }
