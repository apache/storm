...
public class ComponentCommon implements org.apache.thrift.TBase<ComponentCommon, ComponentCommon._Fields>, java.io.Serializable, Cloneable, Comparable<ComponentCommon> {
  ...
  private static final org.apache.thrift.protocol.TField BATCH_SIZES_FIELD_DESC = new org.apache.thrift.protocol.TField("batch_sizes", org.apache.thrift.protocol.TType.MAP, (short)4);
  private static final org.apache.thrift.protocol.TField JSON_CONF_FIELD_DESC = new org.apache.thrift.protocol.TField("json_conf", org.apache.thrift.protocol.TType.STRING, (short)5);
  ...
  private Map<String,Integer> batch_sizes; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BATCH_SIZES((short)4, "batch_sizes"),
    JSON_CONF((short)5, "json_conf");
  ...
  private static final _Fields optionals[] = {_Fields.PARALLELISM_HINT,_Fields.BATCH_SIZES,_Fields.JSON_CONF};
  ...
  static {
    ...
    tmpMap.put(_Fields.BATCH_SIZES, new org.apache.thrift.meta_data.FieldMetaData("batch_sizes", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
  ...
  public ComponentCommon(ComponentCommon other) {
    ...
    if (other.is_set_batch_sizes()) {
      Map<String,Integer> __this__batch_sizes = new HashMap<String,Integer>(other.batch_sizes);
      this.batch_sizes = __this__batch_sizes;
    }
  ...
  public int get_batch_sizes_size() {
    return (this.batch_sizes == null) ? 0 : this.batch_sizes.size();
  }

  public void put_to_batch_sizes(String key, int val) {
    if (this.batch_sizes == null) {
      this.batch_sizes = new HashMap<String,Integer>();
    }
    this.batch_sizes.put(key, val);
  }

  public Map<String,Integer> get_batch_sizes() {
    return this.batch_sizes;
  }

  public void set_batch_sizes(Map<String,Integer> batch_sizes) {
    this.batch_sizes = batch_sizes;
  }

  public void unset_batch_sizes() {
    this.batch_sizes = null;
  }

  /** Returns true if field batch_sizes is set (has been assigned a value) and false otherwise */
  public boolean is_set_batch_sizes() {
    return this.batch_sizes != null;
  }

  public void set_batch_sizes_isSet(boolean value) {
    if (!value) {
      this.batch_sizes = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BATCH_SIZES:
      if (value == null) {
        ...
        set_batch_sizes((Map<String,Integer>)value);
      }
      break;
  ...
  public boolean equals(ComponentCommon that) {
    ...
    boolean this_present_batch_sizes = true && this.is_set_batch_sizes();
    boolean that_present_batch_sizes = true && that.is_set_batch_sizes();
    if (this_present_batch_sizes || that_present_batch_sizes) {
      if (!(this_present_batch_sizes && that_present_batch_sizes))
        return false;
      if (!this.batch_sizes.equals(that.batch_sizes))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_batch_sizes = true && (is_set_batch_sizes());
    list.add(present_batch_sizes);
    if (present_batch_sizes)
      list.add(batch_sizes);
  ...
  public int compareTo(ComponentCommon other) {
    ...
    lastComparison = Boolean.valueOf(is_set_batch_sizes()).compareTo(other.is_set_batch_sizes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_batch_sizes()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.batch_sizes, other.batch_sizes);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (is_set_batch_sizes()) {
      if (!first) sb.append(", ");
      sb.append("batch_sizes:");
      if (this.batch_sizes == null) {
        sb.append("null");
      } else {
        sb.append(this.batch_sizes);
      }
      first = false;
    }
    if (is_set_json_conf()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.batch_sizes = new HashMap<String,Integer>(2*_map32.size);
                String _key33;
                int _val34;
                for (int _i35 = 0; _i35 < _map32.size; ++_i35)
                {
                  ...
                  struct.batch_sizes.put(_key33, _val34);
                }
                iprot.readMapEnd();
              }
              struct.set_batch_sizes_isSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ComponentCommon struct) throws org.apache.thrift.TException {
      ...
      if (struct.inputs != null) {
        oprot.writeFieldBegin(INPUTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<GlobalStreamId, Grouping> _iter36 : struct.inputs.entrySet())
          {
            _iter36.getKey().write(oprot);
      ...
      if (struct.streams != null) {
        oprot.writeFieldBegin(STREAMS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, StreamInfo> _iter37 : struct.streams.entrySet())
          {
      ...
      if (struct.batch_sizes != null) {
        if (struct.is_set_batch_sizes()) {
          oprot.writeFieldBegin(BATCH_SIZES_FIELD_DESC);
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, struct.batch_sizes.size()));
            for (Map.Entry<String, Integer> _iter38 : struct.batch_sizes.entrySet())
            {
  ...
  private static class ComponentCommonTupleScheme extends TupleScheme<ComponentCommon> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ComponentCommon struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<GlobalStreamId, Grouping> _iter39 : struct.inputs.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, StreamInfo> _iter40 : struct.streams.entrySet())
        {
      ...
      if (struct.is_set_batch_sizes()) {
        {
          oprot.writeI32(struct.batch_sizes.size());
          for (Map.Entry<String, Integer> _iter41 : struct.batch_sizes.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ComponentCommon struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map42 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.inputs = new HashMap<GlobalStreamId,Grouping>(2*_map42.size);
        GlobalStreamId _key43;
        Grouping _val44;
        for (int _i45 = 0; _i45 < _map42.size; ++_i45)
        {
          _key43 = new GlobalStreamId();
          _key43.read(iprot);
          _val44 = new Grouping();
          _val44.read(iprot);
          struct.inputs.put(_key43, _val44);
        }
      }
      struct.set_inputs_isSet(true);
      {
        ...
        struct.streams = new HashMap<String,StreamInfo>(2*_map46.size);
        String _key47;
        StreamInfo _val48;
        for (int _i49 = 0; _i49 < _map46.size; ++_i49)
        {
          _key47 = iprot.readString();
          _val48 = new StreamInfo();
          _val48.read(iprot);
          struct.streams.put(_key47, _val48);
        }
      }
      struct.set_streams_isSet(true);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.batch_sizes = new HashMap<String,Integer>(2*_map50.size);
          String _key51;
          int _val52;
          for (int _i53 = 0; _i53 < _map50.size; ++_i53)
          {
            ...
            struct.batch_sizes.put(_key51, _val52);
          }
        }
        struct.set_batch_sizes_isSet(true);
      }
