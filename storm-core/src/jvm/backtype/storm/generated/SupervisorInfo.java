...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.used_ports = new ArrayList<Long>(_list376.size);
                long _elem377;
                for (int _i378 = 0; _i378 < _list376.size; ++_i378)
                {
                  _elem377 = iprot.readI64();
                  struct.used_ports.add(_elem377);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.meta = new ArrayList<Long>(_list379.size);
                long _elem380;
                for (int _i381 = 0; _i381 < _list379.size; ++_i381)
                {
                  _elem380 = iprot.readI64();
                  struct.meta.add(_elem380);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.scheduler_meta = new HashMap<String,String>(2*_map382.size);
                String _key383;
                String _val384;
                for (int _i385 = 0; _i385 < _map382.size; ++_i385)
                {
                  ...
                  struct.scheduler_meta.put(_key383, _val384);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.used_ports != null) {
        if (struct.is_set_used_ports()) {
          oprot.writeFieldBegin(USED_PORTS_FIELD_DESC);
          {
            ...
            for (long _iter386 : struct.used_ports)
            {
              oprot.writeI64(_iter386);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.meta != null) {
        if (struct.is_set_meta()) {
          oprot.writeFieldBegin(META_FIELD_DESC);
          {
            ...
            for (long _iter387 : struct.meta)
            {
              oprot.writeI64(_iter387);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.scheduler_meta != null) {
        if (struct.is_set_scheduler_meta()) {
          oprot.writeFieldBegin(SCHEDULER_META_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter388 : struct.scheduler_meta.entrySet())
            {
  ...
  private static class SupervisorInfoTupleScheme extends TupleScheme<SupervisorInfo> {
      ...
      if (struct.is_set_used_ports()) {
        {
          ...
          for (long _iter389 : struct.used_ports)
          {
      ...
      if (struct.is_set_scheduler_meta()) {
        {
          ...
          for (Map.Entry<String, String> _iter391 : struct.scheduler_meta.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list392 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.used_ports = new ArrayList<Long>(_list392.size);
          long _elem393;
          for (int _i394 = 0; _i394 < _list392.size; ++_i394)
          {
            _elem393 = iprot.readI64();
            struct.used_ports.add(_elem393);
          }
        }
        struct.set_used_ports_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list395 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.meta = new ArrayList<Long>(_list395.size);
          long _elem396;
          for (int _i397 = 0; _i397 < _list395.size; ++_i397)
          {
            _elem396 = iprot.readI64();
            struct.meta.add(_elem396);
          }
        }
        struct.set_meta_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.scheduler_meta = new HashMap<String,String>(2*_map398.size);
          String _key399;
          String _val400;
          for (int _i401 = 0; _i401 < _map398.size; ++_i401)
          {
            ...
            struct.scheduler_meta.put(_key399, _val400);
          }
        }
        struct.set_scheduler_meta_isSet(true);
      }
