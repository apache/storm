...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.used_ports = new ArrayList<Long>(_list374.size);
                long _elem375;
                for (int _i376 = 0; _i376 < _list374.size; ++_i376)
                {
                  _elem375 = iprot.readI64();
                  struct.used_ports.add(_elem375);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.meta = new ArrayList<Long>(_list377.size);
                long _elem378;
                for (int _i379 = 0; _i379 < _list377.size; ++_i379)
                {
                  _elem378 = iprot.readI64();
                  struct.meta.add(_elem378);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.scheduler_meta = new HashMap<String,String>(2*_map380.size);
                String _key381;
                String _val382;
                for (int _i383 = 0; _i383 < _map380.size; ++_i383)
                {
                  ...
                  struct.scheduler_meta.put(_key381, _val382);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.used_ports != null) {
        if (struct.is_set_used_ports()) {
          oprot.writeFieldBegin(USED_PORTS_FIELD_DESC);
          {
            ...
            for (long _iter384 : struct.used_ports)
            {
      ...
      if (struct.scheduler_meta != null) {
        if (struct.is_set_scheduler_meta()) {
          oprot.writeFieldBegin(SCHEDULER_META_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter386 : struct.scheduler_meta.entrySet())
            {
  ...
  private static class SupervisorInfoTupleScheme extends TupleScheme<SupervisorInfo> {
      ...
      if (struct.is_set_used_ports()) {
        {
          ...
          for (long _iter387 : struct.used_ports)
          {
      ...
      if (struct.is_set_meta()) {
        {
          ...
          for (long _iter388 : struct.meta)
          {
            oprot.writeI64(_iter388);
          }
        }
      }
      if (struct.is_set_scheduler_meta()) {
        {
          ...
          for (Map.Entry<String, String> _iter389 : struct.scheduler_meta.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list390 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.used_ports = new ArrayList<Long>(_list390.size);
          long _elem391;
          for (int _i392 = 0; _i392 < _list390.size; ++_i392)
          {
            _elem391 = iprot.readI64();
            struct.used_ports.add(_elem391);
          }
        }
        struct.set_used_ports_isSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.meta = new ArrayList<Long>(_list393.size);
          long _elem394;
          for (int _i395 = 0; _i395 < _list393.size; ++_i395)
          {
            _elem394 = iprot.readI64();
            struct.meta.add(_elem394);
          }
        }
        struct.set_meta_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.scheduler_meta = new HashMap<String,String>(2*_map396.size);
          String _key397;
          String _val398;
          for (int _i399 = 0; _i399 < _map396.size; ++_i399)
          {
            ...
            struct.scheduler_meta.put(_key397, _val398);
          }
        }
        struct.set_scheduler_meta_isSet(true);
      }
