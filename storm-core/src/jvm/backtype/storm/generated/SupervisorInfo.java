...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
  ...
  private static final org.apache.thrift.protocol.TField SYSTEM_STATS_FIELD_DESC = new org.apache.thrift.protocol.TField("system_stats", org.apache.thrift.protocol.TType.MAP, (short)9);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SYSTEM_STATS((short)9, "system_stats");
  ...
  private static final _Fields optionals[] = {_Fields.ASSIGNMENT_ID,_Fields.USED_PORTS,_Fields.META,_Fields.SCHEDULER_META,_Fields.UPTIME_SECS,_Fields.VERSION,_Fields.SYSTEM_STATS};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.system_stats = new HashMap<String,Double>(2*_map356.size);
                String _key357;
                double _val358;
                for (int _i359 = 0; _i359 < _map356.size; ++_i359)
                {
                  ...
                  struct.system_stats.put(_key357, _val358);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.used_ports != null) {
        if (struct.is_set_used_ports()) {
          oprot.writeFieldBegin(USED_PORTS_FIELD_DESC);
          {
            ...
            for (long _iter360 : struct.used_ports)
            {
      ...
      if (struct.meta != null) {
        if (struct.is_set_meta()) {
          oprot.writeFieldBegin(META_FIELD_DESC);
          {
            ...
            for (long _iter361 : struct.meta)
            {
              oprot.writeI64(_iter361);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.scheduler_meta != null) {
        if (struct.is_set_scheduler_meta()) {
          oprot.writeFieldBegin(SCHEDULER_META_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter362 : struct.scheduler_meta.entrySet())
            {
      ...
      if (struct.system_stats != null) {
        if (struct.is_set_system_stats()) {
          oprot.writeFieldBegin(SYSTEM_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter363 : struct.system_stats.entrySet())
            {
              oprot.writeString(_iter363.getKey());
              oprot.writeDouble(_iter363.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class SupervisorInfoTupleScheme extends TupleScheme<SupervisorInfo> {
      ...
      if (struct.is_set_system_stats()) {
        {
          ...
          for (Map.Entry<String, Double> _iter367 : struct.system_stats.entrySet())
          {
            oprot.writeString(_iter367.getKey());
            oprot.writeDouble(_iter367.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list368 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.used_ports = new ArrayList<Long>(_list368.size);
          long _elem369;
          for (int _i370 = 0; _i370 < _list368.size; ++_i370)
          {
            _elem369 = iprot.readI64();
            struct.used_ports.add(_elem369);
          }
        }
        struct.set_used_ports_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list371 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.meta = new ArrayList<Long>(_list371.size);
          long _elem372;
          for (int _i373 = 0; _i373 < _list371.size; ++_i373)
          {
            _elem372 = iprot.readI64();
            struct.meta.add(_elem372);
          }
        }
        struct.set_meta_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.scheduler_meta = new HashMap<String,String>(2*_map374.size);
          String _key375;
          String _val376;
          for (int _i377 = 0; _i377 < _map374.size; ++_i377)
          {
            ...
            struct.scheduler_meta.put(_key375, _val376);
          }
        }
        struct.set_scheduler_meta_isSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TMap _map378 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.system_stats = new HashMap<String,Double>(2*_map378.size);
          String _key379;
          double _val380;
          for (int _i381 = 0; _i381 < _map378.size; ++_i381)
          {
            ...
            struct.system_stats.put(_key379, _val380);
          }
        }
        struct.set_system_stats_isSet(true);
      }
