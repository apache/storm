...
public class NodeInfo implements org.apache.thrift.TBase<NodeInfo, NodeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<NodeInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.port = new HashSet<Long>(2*_set640.size);
                long _elem641;
                for (int _i642 = 0; _i642 < _set640.size; ++_i642)
                {
                  _elem641 = iprot.readI64();
                  struct.port.add(_elem641);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_node_isSet(true);
      {
        org.apache.thrift.protocol.TSet _set645 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.port = new HashSet<Long>(2*_set645.size);
        long _elem646;
        for (int _i647 = 0; _i647 < _set645.size; ++_i647)
        {
          _elem646 = iprot.readI64();
          struct.port.add(_elem646);
        }
      }
      struct.set_port_isSet(true);
    }
