            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.port = new HashSet<Long>(2*_set620.size);
                long _elem621;
                for (int _i622 = 0; _i622 < _set620.size; ++_i622)
                {
                  _elem621 = iprot.readI64();
                  struct.port.add(_elem621);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_node_isSet(true);
      {
        ...
        struct.port = new HashSet<Long>(2*_set625.size);
        long _elem626;
        for (int _i627 = 0; _i627 < _set625.size; ++_i627)
        {
          _elem626 = iprot.readI64();
          struct.port.add(_elem626);
        }
      }
      struct.set_port_isSet(true);
    }
