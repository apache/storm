            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulseIds = new ArrayList<String>(_list810.size);
                String _elem811;
                for (int _i812 = 0; _i812 < _list810.size; ++_i812)
                {
                  _elem811 = iprot.readString();
                  struct.pulseIds.add(_elem811);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBNodes struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulseIds != null) {
        oprot.writeFieldBegin(PULSE_IDS_FIELD_DESC);
        {
          ...
          for (String _iter813 : struct.pulseIds)
          {
      ...
      if (struct.is_set_pulseIds()) {
        {
          ...
          for (String _iter814 : struct.pulseIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulseIds = new ArrayList<String>(_list815.size);
          String _elem816;
          for (int _i817 = 0; _i817 < _list815.size; ++_i817)
          {
            _elem816 = iprot.readString();
            struct.pulseIds.add(_elem816);
          }
        }
        struct.set_pulseIds_isSet(true);
      }
