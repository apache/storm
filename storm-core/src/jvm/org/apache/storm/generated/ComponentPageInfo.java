...
public class ComponentPageInfo implements org.apache.thrift.TBase<ComponentPageInfo, ComponentPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ComponentPageInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_stats = new HashMap<String,ComponentAggregateStats>(2*_map502.size);
                String _key503;
                ComponentAggregateStats _val504;
                for (int _i505 = 0; _i505 < _map502.size; ++_i505)
                {
                  _key503 = iprot.readString();
                  _val504 = new ComponentAggregateStats();
                  _val504.read(iprot);
                  struct.window_to_stats.put(_key503, _val504);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.gsid_to_input_stats = new HashMap<GlobalStreamId,ComponentAggregateStats>(2*_map506.size);
                GlobalStreamId _key507;
                ComponentAggregateStats _val508;
                for (int _i509 = 0; _i509 < _map506.size; ++_i509)
                {
                  _key507 = new GlobalStreamId();
                  _key507.read(iprot);
                  _val508 = new ComponentAggregateStats();
                  _val508.read(iprot);
                  struct.gsid_to_input_stats.put(_key507, _val508);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.sid_to_output_stats = new HashMap<String,ComponentAggregateStats>(2*_map510.size);
                String _key511;
                ...
                for (int _i513 = 0; _i513 < _map510.size; ++_i513)
                {
                  ...
                  _val512.read(iprot);
                  struct.sid_to_output_stats.put(_key511, _val512);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.exec_stats = new ArrayList<ExecutorAggregateStats>(_list514.size);
                ExecutorAggregateStats _elem515;
                for (int _i516 = 0; _i516 < _list514.size; ++_i516)
                {
                  _elem515 = new ExecutorAggregateStats();
                  _elem515.read(iprot);
                  struct.exec_stats.add(_elem515);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.errors = new ArrayList<ErrorInfo>(_list517.size);
                ErrorInfo _elem518;
                for (int _i519 = 0; _i519 < _list517.size; ++_i519)
                {
                  _elem518 = new ErrorInfo();
                  _elem518.read(iprot);
                  struct.errors.add(_elem518);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.window_to_stats != null) {
        if (struct.is_set_window_to_stats()) {
          oprot.writeFieldBegin(WINDOW_TO_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ComponentAggregateStats> _iter520 : struct.window_to_stats.entrySet())
            {
      ...
      if (struct.gsid_to_input_stats != null) {
        if (struct.is_set_gsid_to_input_stats()) {
          oprot.writeFieldBegin(GSID_TO_INPUT_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<GlobalStreamId, ComponentAggregateStats> _iter521 : struct.gsid_to_input_stats.entrySet())
            {
              _iter521.getKey().write(oprot);
      ...
      if (struct.sid_to_output_stats != null) {
        if (struct.is_set_sid_to_output_stats()) {
          oprot.writeFieldBegin(SID_TO_OUTPUT_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ComponentAggregateStats> _iter522 : struct.sid_to_output_stats.entrySet())
            {
              oprot.writeString(_iter522.getKey());
              _iter522.getValue().write(oprot);
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.exec_stats != null) {
        if (struct.is_set_exec_stats()) {
          oprot.writeFieldBegin(EXEC_STATS_FIELD_DESC);
          {
            ...
            for (ExecutorAggregateStats _iter523 : struct.exec_stats)
            {
      ...
      if (struct.errors != null) {
        if (struct.is_set_errors()) {
          oprot.writeFieldBegin(ERRORS_FIELD_DESC);
          {
            ...
            for (ErrorInfo _iter524 : struct.errors)
            {
  ...
  private static class ComponentPageInfoTupleScheme extends TupleScheme<ComponentPageInfo> {
      ...
      if (struct.is_set_window_to_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter525 : struct.window_to_stats.entrySet())
          {
      ...
      if (struct.is_set_gsid_to_input_stats()) {
        {
          ...
          for (Map.Entry<GlobalStreamId, ComponentAggregateStats> _iter526 : struct.gsid_to_input_stats.entrySet())
          {
            _iter526.getKey().write(oprot);
      ...
      if (struct.is_set_sid_to_output_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter527 : struct.sid_to_output_stats.entrySet())
          {
      ...
      if (struct.is_set_exec_stats()) {
        {
          ...
          for (ExecutorAggregateStats _iter528 : struct.exec_stats)
          {
      ...
      if (struct.is_set_errors()) {
        {
          ...
          for (ErrorInfo _iter529 : struct.errors)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ComponentPageInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.window_to_stats = new HashMap<String,ComponentAggregateStats>(2*_map530.size);
          String _key531;
          ...
          for (int _i533 = 0; _i533 < _map530.size; ++_i533)
          {
            ...
            _val532.read(iprot);
            struct.window_to_stats.put(_key531, _val532);
          }
        }
        struct.set_window_to_stats_isSet(true);
      }
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map534 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.gsid_to_input_stats = new HashMap<GlobalStreamId,ComponentAggregateStats>(2*_map534.size);
          GlobalStreamId _key535;
          ComponentAggregateStats _val536;
          for (int _i537 = 0; _i537 < _map534.size; ++_i537)
          {
            _key535 = new GlobalStreamId();
            _key535.read(iprot);
            _val536 = new ComponentAggregateStats();
            _val536.read(iprot);
            struct.gsid_to_input_stats.put(_key535, _val536);
          }
        }
        struct.set_gsid_to_input_stats_isSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.sid_to_output_stats = new HashMap<String,ComponentAggregateStats>(2*_map538.size);
          String _key539;
          ...
          for (int _i541 = 0; _i541 < _map538.size; ++_i541)
          {
            ...
            _val540.read(iprot);
            struct.sid_to_output_stats.put(_key539, _val540);
          }
        }
        struct.set_sid_to_output_stats_isSet(true);
      }
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list542 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.exec_stats = new ArrayList<ExecutorAggregateStats>(_list542.size);
          ExecutorAggregateStats _elem543;
          for (int _i544 = 0; _i544 < _list542.size; ++_i544)
          {
            _elem543 = new ExecutorAggregateStats();
            _elem543.read(iprot);
            struct.exec_stats.add(_elem543);
          }
        }
        struct.set_exec_stats_isSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.errors = new ArrayList<ErrorInfo>(_list545.size);
          ErrorInfo _elem546;
          for (int _i547 = 0; _i547 < _list545.size; ++_i547)
          {
            _elem546 = new ErrorInfo();
            _elem546.read(iprot);
            struct.errors.add(_elem546);
          }
        }
        struct.set_errors_isSet(true);
      }
