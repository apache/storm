...
public class StormBase implements org.apache.thrift.TBase<StormBase, StormBase._Fields>, java.io.Serializable, Cloneable, Comparable<StormBase> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map684.size);
                String _key685;
                int _val686;
                for (int _i687 = 0; _i687 < _map684.size; ++_i687)
                {
                  _key685 = iprot.readString();
                  _val686 = iprot.readI32();
                  struct.component_executors.put(_key685, _val686);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new HashMap<String,DebugOptions>(2*_map688.size);
                String _key689;
                DebugOptions _val690;
                for (int _i691 = 0; _i691 < _map688.size; ++_i691)
                {
                  _key689 = iprot.readString();
                  _val690 = new DebugOptions();
                  _val690.read(iprot);
                  struct.component_debug.put(_key689, _val690);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter692 : struct.component_executors.entrySet())
            {
      ...
      if (struct.component_debug != null) {
        if (struct.is_set_component_debug()) {
          oprot.writeFieldBegin(COMPONENT_DEBUG_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, DebugOptions> _iter693 : struct.component_debug.entrySet())
            {
  ...
  private static class StormBaseTupleScheme extends TupleScheme<StormBase> {
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter694 : struct.component_executors.entrySet())
          {
            oprot.writeString(_iter694.getKey());
            oprot.writeI32(_iter694.getValue());
          }
        }
      }
      if (struct.is_set_launch_time_secs()) {
      ...
      if (struct.is_set_component_debug()) {
        {
          ...
          for (Map.Entry<String, DebugOptions> _iter695 : struct.component_debug.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormBase struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map696 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.component_executors = new HashMap<String,Integer>(2*_map696.size);
          String _key697;
          int _val698;
          for (int _i699 = 0; _i699 < _map696.size; ++_i699)
          {
            _key697 = iprot.readString();
            _val698 = iprot.readI32();
            struct.component_executors.put(_key697, _val698);
          }
        }
        struct.set_component_executors_isSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map700 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.component_debug = new HashMap<String,DebugOptions>(2*_map700.size);
          String _key701;
          DebugOptions _val702;
          for (int _i703 = 0; _i703 < _map700.size; ++_i703)
          {
            _key701 = iprot.readString();
            _val702 = new DebugOptions();
            _val702.read(iprot);
            struct.component_debug.put(_key701, _val702);
          }
        }
        struct.set_component_debug_isSet(true);
      }
