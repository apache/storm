...
public class StormBase implements org.apache.thrift.TBase<StormBase, StormBase._Fields>, java.io.Serializable, Cloneable, Comparable<StormBase> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map614.size);
                String _key615;
                int _val616;
                for (int _i617 = 0; _i617 < _map614.size; ++_i617)
                {
                  _key615 = iprot.readString();
                  _val616 = iprot.readI32();
                  struct.component_executors.put(_key615, _val616);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new HashMap<String,DebugOptions>(2*_map618.size);
                String _key619;
                DebugOptions _val620;
                for (int _i621 = 0; _i621 < _map618.size; ++_i621)
                {
                  _key619 = iprot.readString();
                  _val620 = new DebugOptions();
                  _val620.read(iprot);
                  struct.component_debug.put(_key619, _val620);
                }
                iprot.readMapEnd();
              }
  ...
  private static class StormBaseTupleScheme extends TupleScheme<StormBase> {
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter624 : struct.component_executors.entrySet())
          {
      ...
      if (struct.is_set_component_debug()) {
        {
          ...
          for (Map.Entry<String, DebugOptions> _iter625 : struct.component_debug.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormBase struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map626 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.component_executors = new HashMap<String,Integer>(2*_map626.size);
          String _key627;
          int _val628;
          for (int _i629 = 0; _i629 < _map626.size; ++_i629)
          {
            ...
            struct.component_executors.put(_key627, _val628);
          }
        }
        struct.set_component_executors_isSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.component_debug = new HashMap<String,DebugOptions>(2*_map630.size);
          String _key631;
          DebugOptions _val632;
          for (int _i633 = 0; _i633 < _map630.size; ++_i633)
          {
            _key631 = iprot.readString();
            _val632 = new DebugOptions();
            _val632.read(iprot);
            struct.component_debug.put(_key631, _val632);
          }
        }
        struct.set_component_debug_isSet(true);
      }
