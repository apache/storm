            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map714.size);
                String _key715;
                ThriftSerializedObject _val716;
                for (int _i717 = 0; _i717 < _map714.size; ++_i717)
                {
                  _key715 = iprot.readString();
                  _val716 = new ThriftSerializedObject();
                  _val716.read(iprot);
                  struct.serialized_parts.put(_key715, _val716);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, ThriftSerializedObject> _iter718 : struct.serialized_parts.entrySet())
          {
            oprot.writeString(_iter718.getKey());
            _iter718.getValue().write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, ThriftSerializedObject> _iter719 : struct.serialized_parts.entrySet())
        {
          oprot.writeString(_iter719.getKey());
          _iter719.getValue().write(oprot);
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map720.size);
        String _key721;
        ThriftSerializedObject _val722;
        for (int _i723 = 0; _i723 < _map720.size; ++_i723)
        {
          _key721 = iprot.readString();
          _val722 = new ThriftSerializedObject();
          _val722.read(iprot);
          struct.serialized_parts.put(_key721, _val722);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
