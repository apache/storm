...
public class RebalanceOptions implements org.apache.thrift.TBase<RebalanceOptions, RebalanceOptions._Fields>, java.io.Serializable, Cloneable, Comparable<RebalanceOptions> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.num_executors = new HashMap<String,Integer>(2*_map548.size);
                String _key549;
                int _val550;
                for (int _i551 = 0; _i551 < _map548.size; ++_i551)
                {
                  ...
                  struct.num_executors.put(_key549, _val550);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.num_executors != null) {
        if (struct.is_set_num_executors()) {
          oprot.writeFieldBegin(NUM_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter552 : struct.num_executors.entrySet())
            {
  ...
  private static class RebalanceOptionsTupleScheme extends TupleScheme<RebalanceOptions> {
      ...
      if (struct.is_set_num_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter553 : struct.num_executors.entrySet())
          {
            oprot.writeString(_iter553.getKey());
            oprot.writeI32(_iter553.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RebalanceOptions struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map554 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.num_executors = new HashMap<String,Integer>(2*_map554.size);
          String _key555;
          int _val556;
          for (int _i557 = 0; _i557 < _map554.size; ++_i557)
          {
            ...
            struct.num_executors.put(_key555, _val556);
          }
        }
        struct.set_num_executors_isSet(true);
      }
