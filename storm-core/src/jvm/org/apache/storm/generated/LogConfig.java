...
public class LogConfig implements org.apache.thrift.TBase<LogConfig, LogConfig._Fields>, java.io.Serializable, Cloneable, Comparable<LogConfig> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.named_logger_level = new HashMap<String,LogLevel>(2*_map784.size);
                String _key785;
                LogLevel _val786;
                for (int _i787 = 0; _i787 < _map784.size; ++_i787)
                {
                  _key785 = iprot.readString();
                  _val786 = new LogLevel();
                  _val786.read(iprot);
                  struct.named_logger_level.put(_key785, _val786);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.named_logger_level != null) {
        if (struct.is_set_named_logger_level()) {
          oprot.writeFieldBegin(NAMED_LOGGER_LEVEL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, LogLevel> _iter788 : struct.named_logger_level.entrySet())
            {
  ...
  private static class LogConfigTupleScheme extends TupleScheme<LogConfig> {
      ...
      if (struct.is_set_named_logger_level()) {
        {
          ...
          for (Map.Entry<String, LogLevel> _iter789 : struct.named_logger_level.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LogConfig struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map790 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.named_logger_level = new HashMap<String,LogLevel>(2*_map790.size);
          String _key791;
          LogLevel _val792;
          for (int _i793 = 0; _i793 < _map790.size; ++_i793)
          {
            _key791 = iprot.readString();
            _val792 = new LogLevel();
            _val792.read(iprot);
            struct.named_logger_level.put(_key791, _val792);
          }
        }
        struct.set_named_logger_level_isSet(true);
      }
