...
public class SupervisorSummary implements org.apache.thrift.TBase<SupervisorSummary, SupervisorSummary._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorSummary> {
  ...
  private @org.apache.thrift.annotation.Nullable java.lang.String supervisor_id; // required
  private @org.apache.thrift.annotation.Nullable java.lang.String version; // optional
  private @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.Double> total_resources; // optional
  ...
  public void set_total_resources(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.Double> total_resources) {
      ...
      if (struct.total_resources != null) {
        if (struct.is_set_total_resources()) {
          oprot.writeFieldBegin(TOTAL_RESOURCES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter102 : struct.total_resources.entrySet())
            {
      ...
      if (struct.is_set_total_resources()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter103 : struct.total_resources.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.total_resources = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map104.size);
