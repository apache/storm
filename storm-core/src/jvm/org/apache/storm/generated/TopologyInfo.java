...
public class TopologyInfo implements org.apache.thrift.TBase<TopologyInfo, TopologyInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyInfo> {
  ...
  private @org.apache.thrift.annotation.Nullable java.util.List<ExecutorSummary> executors; // required
  private @org.apache.thrift.annotation.Nullable java.lang.String status; // required
  private @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.util.List<ErrorInfo>> errors; // required
  private @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,DebugOptions> component_debug; // optional
  ...
  public void set_executors(@org.apache.thrift.annotation.Nullable java.util.List<ExecutorSummary> executors) {
    this.executors = executors;
  }
  ...
  public void set_errors(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.util.List<ErrorInfo>> errors) {
    this.errors = errors;
  }
  ...
  public void set_component_debug(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,DebugOptions> component_debug) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.executors = new java.util.ArrayList<ExecutorSummary>(_list332.size);
                @org.apache.thrift.annotation.Nullable ExecutorSummary _elem333;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errors = new java.util.HashMap<java.lang.String,java.util.List<ErrorInfo>>(2*_map335.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key336;
                @org.apache.thrift.annotation.Nullable java.util.List<ErrorInfo> _val337;
                for (int _i338 = 0; _i338 < _map335.size; ++_i338)
                {
                  _key336 = iprot.readString();
                  {
                    ...
                    _val337 = new java.util.ArrayList<ErrorInfo>(_list339.size);
                    @org.apache.thrift.annotation.Nullable ErrorInfo _elem340;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new java.util.HashMap<java.lang.String,DebugOptions>(2*_map342.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key343;
                @org.apache.thrift.annotation.Nullable DebugOptions _val344;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.errors != null) {
        oprot.writeFieldBegin(ERRORS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.List<ErrorInfo>> _iter347 : struct.errors.entrySet())
          {
      ...
      if (struct.component_debug != null) {
        if (struct.is_set_component_debug()) {
          oprot.writeFieldBegin(COMPONENT_DEBUG_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, DebugOptions> _iter349 : struct.component_debug.entrySet())
            {
  ...
  private static class TopologyInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<TopologyInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.status);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.util.List<ErrorInfo>> _iter351 : struct.errors.entrySet())
        {
      ...
      if (struct.is_set_component_debug()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, DebugOptions> _iter353 : struct.component_debug.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_uptime_secs_isSet(true);
      {
        ...
        struct.executors = new java.util.ArrayList<ExecutorSummary>(_list354.size);
        @org.apache.thrift.annotation.Nullable ExecutorSummary _elem355;
      ...
      struct.set_status_isSet(true);
      {
        ...
        struct.errors = new java.util.HashMap<java.lang.String,java.util.List<ErrorInfo>>(2*_map357.size);
        @org.apache.thrift.annotation.Nullable java.lang.String _key358;
        @org.apache.thrift.annotation.Nullable java.util.List<ErrorInfo> _val359;
        for (int _i360 = 0; _i360 < _map357.size; ++_i360)
        {
          _key358 = iprot.readString();
          {
            ...
            _val359 = new java.util.ArrayList<ErrorInfo>(_list361.size);
            @org.apache.thrift.annotation.Nullable ErrorInfo _elem362;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.component_debug = new java.util.HashMap<java.lang.String,DebugOptions>(2*_map364.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key365;
          @org.apache.thrift.annotation.Nullable DebugOptions _val366;
