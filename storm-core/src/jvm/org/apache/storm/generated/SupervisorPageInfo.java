...
public class SupervisorPageInfo implements org.apache.thrift.TBase<SupervisorPageInfo, SupervisorPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorPageInfo> {
  ...
  private static class SupervisorPageInfoTupleScheme extends TupleScheme<SupervisorPageInfo> {
      ...
      if (struct.is_set_supervisor_summaries()) {
        {
          ...
          for (SupervisorSummary _iter476 : struct.supervisor_summaries)
          {
      ...
      if (struct.is_set_worker_summaries()) {
        {
          ...
          for (WorkerSummary _iter477 : struct.worker_summaries)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorPageInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list478 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.supervisor_summaries = new ArrayList<SupervisorSummary>(_list478.size);
          SupervisorSummary _elem479;
          for (int _i480 = 0; _i480 < _list478.size; ++_i480)
          {
            _elem479 = new SupervisorSummary();
            _elem479.read(iprot);
            struct.supervisor_summaries.add(_elem479);
          }
        }
        struct.set_supervisor_summaries_isSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.worker_summaries = new ArrayList<WorkerSummary>(_list481.size);
          WorkerSummary _elem482;
          for (int _i483 = 0; _i483 < _list481.size; ++_i483)
          {
            _elem482 = new WorkerSummary();
            _elem482.read(iprot);
            struct.worker_summaries.add(_elem482);
          }
        }
        struct.set_worker_summaries_isSet(true);
      }
