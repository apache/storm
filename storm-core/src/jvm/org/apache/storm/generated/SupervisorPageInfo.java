            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.supervisor_summaries = new java.util.ArrayList<SupervisorSummary>(_list438.size);
                @org.apache.thrift.annotation.Nullable SupervisorSummary _elem439;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.worker_summaries = new java.util.ArrayList<WorkerSummary>(_list441.size);
                @org.apache.thrift.annotation.Nullable WorkerSummary _elem442;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.supervisor_summaries = new java.util.ArrayList<SupervisorSummary>(_list448.size);
          @org.apache.thrift.annotation.Nullable SupervisorSummary _elem449;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.worker_summaries = new java.util.ArrayList<WorkerSummary>(_list451.size);
          @org.apache.thrift.annotation.Nullable WorkerSummary _elem452;
