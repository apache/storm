...
public class SupervisorPageInfo implements org.apache.thrift.TBase<SupervisorPageInfo, SupervisorPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorPageInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.supervisor_summaries = new ArrayList<SupervisorSummary>(_list458.size);
                SupervisorSummary _elem459;
                for (int _i460 = 0; _i460 < _list458.size; ++_i460)
                {
                  _elem459 = new SupervisorSummary();
                  _elem459.read(iprot);
                  struct.supervisor_summaries.add(_elem459);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.worker_summaries = new ArrayList<WorkerSummary>(_list461.size);
                WorkerSummary _elem462;
                for (int _i463 = 0; _i463 < _list461.size; ++_i463)
                {
                  _elem462 = new WorkerSummary();
                  _elem462.read(iprot);
                  struct.worker_summaries.add(_elem462);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.supervisor_summaries != null) {
        if (struct.is_set_supervisor_summaries()) {
          oprot.writeFieldBegin(SUPERVISOR_SUMMARIES_FIELD_DESC);
          {
            ...
            for (SupervisorSummary _iter464 : struct.supervisor_summaries)
            {
      ...
      if (struct.worker_summaries != null) {
        if (struct.is_set_worker_summaries()) {
          oprot.writeFieldBegin(WORKER_SUMMARIES_FIELD_DESC);
          {
            ...
            for (WorkerSummary _iter465 : struct.worker_summaries)
            {
  ...
  private static class SupervisorPageInfoTupleScheme extends TupleScheme<SupervisorPageInfo> {
      ...
      if (struct.is_set_supervisor_summaries()) {
        {
          ...
          for (SupervisorSummary _iter466 : struct.supervisor_summaries)
          {
      ...
      if (struct.is_set_worker_summaries()) {
        {
          ...
          for (WorkerSummary _iter467 : struct.worker_summaries)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorPageInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list468 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.supervisor_summaries = new ArrayList<SupervisorSummary>(_list468.size);
          SupervisorSummary _elem469;
          for (int _i470 = 0; _i470 < _list468.size; ++_i470)
          {
            _elem469 = new SupervisorSummary();
            _elem469.read(iprot);
            struct.supervisor_summaries.add(_elem469);
          }
        }
        struct.set_supervisor_summaries_isSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.worker_summaries = new ArrayList<WorkerSummary>(_list471.size);
          WorkerSummary _elem472;
          for (int _i473 = 0; _i473 < _list471.size; ++_i473)
          {
            _elem472 = new WorkerSummary();
            _elem472.read(iprot);
            struct.worker_summaries.add(_elem472);
          }
        }
        struct.set_worker_summaries_isSet(true);
      }
