            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.topo_ids = new ArrayList<String>(_list794.size);
                String _elem795;
                for (int _i796 = 0; _i796 < _list794.size; ++_i796)
                {
                  _elem795 = iprot.readString();
                  struct.topo_ids.add(_elem795);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyHistoryInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.topo_ids != null) {
        oprot.writeFieldBegin(TOPO_IDS_FIELD_DESC);
        {
          ...
          for (String _iter797 : struct.topo_ids)
          {
      ...
      if (struct.is_set_topo_ids()) {
        {
          ...
          for (String _iter798 : struct.topo_ids)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.topo_ids = new ArrayList<String>(_list799.size);
          String _elem800;
          for (int _i801 = 0; _i801 < _list799.size; ++_i801)
          {
            _elem800 = iprot.readString();
            struct.topo_ids.add(_elem800);
          }
        }
        struct.set_topo_ids_isSet(true);
      }
