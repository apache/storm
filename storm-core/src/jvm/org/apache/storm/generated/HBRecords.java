            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<HBPulse>(_list802.size);
                HBPulse _elem803;
                for (int _i804 = 0; _i804 < _list802.size; ++_i804)
                {
                  _elem803 = new HBPulse();
                  _elem803.read(iprot);
                  struct.pulses.add(_elem803);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<HBPulse>(_list807.size);
          HBPulse _elem808;
          for (int _i809 = 0; _i809 < _list807.size; ++_i809)
          {
            _elem808 = new HBPulse();
            _elem808.read(iprot);
            struct.pulses.add(_elem808);
          }
        }
        struct.set_pulses_isSet(true);
      }
