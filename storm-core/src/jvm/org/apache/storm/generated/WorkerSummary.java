...
public class WorkerSummary implements org.apache.thrift.TBase<WorkerSummary, WorkerSummary._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerSummary> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_to_num_tasks = new HashMap<String,Long>(2*_map448.size);
                String _key449;
                long _val450;
                for (int _i451 = 0; _i451 < _map448.size; ++_i451)
                {
                  ...
                  struct.component_to_num_tasks.put(_key449, _val450);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_to_num_tasks != null) {
        if (struct.is_set_component_to_num_tasks()) {
          oprot.writeFieldBegin(COMPONENT_TO_NUM_TASKS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter452 : struct.component_to_num_tasks.entrySet())
            {
              oprot.writeString(_iter452.getKey());
              oprot.writeI64(_iter452.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class WorkerSummaryTupleScheme extends TupleScheme<WorkerSummary> {
      ...
      if (struct.is_set_component_to_num_tasks()) {
        {
          ...
          for (Map.Entry<String, Long> _iter453 : struct.component_to_num_tasks.entrySet())
          {
            oprot.writeString(_iter453.getKey());
            oprot.writeI64(_iter453.getValue());
          }
        }
      }
      if (struct.is_set_time_secs()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WorkerSummary struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TMap _map454 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.component_to_num_tasks = new HashMap<String,Long>(2*_map454.size);
          String _key455;
          long _val456;
          for (int _i457 = 0; _i457 < _map454.size; ++_i457)
          {
            _key455 = iprot.readString();
            _val456 = iprot.readI64();
            struct.component_to_num_tasks.put(_key455, _val456);
          }
        }
        struct.set_component_to_num_tasks_isSet(true);
      }
