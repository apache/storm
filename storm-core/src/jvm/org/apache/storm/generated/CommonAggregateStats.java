            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.resources_map = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map368.size);
      ...
      if (struct.resources_map != null) {
        if (struct.is_set_resources_map()) {
          oprot.writeFieldBegin(RESOURCES_MAP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter372 : struct.resources_map.entrySet())
            {
      ...
      if (struct.is_set_resources_map()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter373 : struct.resources_map.entrySet())
          {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.resources_map = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map374.size);
