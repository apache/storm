...
public class SupervisorAssignments implements org.apache.thrift.TBase<SupervisorAssignments, SupervisorAssignments._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorAssignments> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.storm_assignment = new HashMap<String,Assignment>(2*_map604.size);
                String _key605;
                Assignment _val606;
                for (int _i607 = 0; _i607 < _map604.size; ++_i607)
                {
                  _key605 = iprot.readString();
                  _val606 = new Assignment();
                  _val606.read(iprot);
                  struct.storm_assignment.put(_key605, _val606);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.storm_assignment != null) {
        if (struct.is_set_storm_assignment()) {
          oprot.writeFieldBegin(STORM_ASSIGNMENT_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Assignment> _iter608 : struct.storm_assignment.entrySet())
            {
              oprot.writeString(_iter608.getKey());
              _iter608.getValue().write(oprot);
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class SupervisorAssignmentsTupleScheme extends TupleScheme<SupervisorAssignments> {
      ...
      if (struct.is_set_storm_assignment()) {
        {
          ...
          for (Map.Entry<String, Assignment> _iter609 : struct.storm_assignment.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map610 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.storm_assignment = new HashMap<String,Assignment>(2*_map610.size);
          String _key611;
          Assignment _val612;
          for (int _i613 = 0; _i613 < _map610.size; ++_i613)
          {
            _key611 = iprot.readString();
            _val612 = new Assignment();
            _val612.read(iprot);
            struct.storm_assignment.put(_key611, _val612);
          }
        }
        struct.set_storm_assignment_isSet(true);
      }
