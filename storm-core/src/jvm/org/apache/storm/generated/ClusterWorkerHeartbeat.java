            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map724.size);
                ExecutorInfo _key725;
                ExecutorStats _val726;
                for (int _i727 = 0; _i727 < _map724.size; ++_i727)
                {
                  _key725 = new ExecutorInfo();
                  _key725.read(iprot);
                  _val726 = new ExecutorStats();
                  _val726.read(iprot);
                  struct.executor_stats.put(_key725, _val726);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_stats != null) {
        oprot.writeFieldBegin(EXECUTOR_STATS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ExecutorInfo, ExecutorStats> _iter728 : struct.executor_stats.entrySet())
          {
            _iter728.getKey().write(oprot);
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.storm_id);
      {
        ...
        for (Map.Entry<ExecutorInfo, ExecutorStats> _iter729 : struct.executor_stats.entrySet())
        {
          _iter729.getKey().write(oprot);
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map730 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map730.size);
        ExecutorInfo _key731;
        ExecutorStats _val732;
        for (int _i733 = 0; _i733 < _map730.size; ++_i733)
        {
          _key731 = new ExecutorInfo();
          _key731.read(iprot);
          _val732 = new ExecutorStats();
          _val732.read(iprot);
          struct.executor_stats.put(_key731, _val732);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
