            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map704.size);
                ExecutorInfo _key705;
                ExecutorStats _val706;
                for (int _i707 = 0; _i707 < _map704.size; ++_i707)
                {
                  _key705 = new ExecutorInfo();
                  _key705.read(iprot);
                  _val706 = new ExecutorStats();
                  _val706.read(iprot);
                  struct.executor_stats.put(_key705, _val706);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_stats != null) {
        oprot.writeFieldBegin(EXECUTOR_STATS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ExecutorInfo, ExecutorStats> _iter708 : struct.executor_stats.entrySet())
          {
            _iter708.getKey().write(oprot);
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.storm_id);
      {
        ...
        for (Map.Entry<ExecutorInfo, ExecutorStats> _iter709 : struct.executor_stats.entrySet())
        {
          _iter709.getKey().write(oprot);
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map710 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map710.size);
        ExecutorInfo _key711;
        ExecutorStats _val712;
        for (int _i713 = 0; _i713 < _map710.size; ++_i713)
        {
          _key711 = new ExecutorInfo();
          _key711.read(iprot);
          _val712 = new ExecutorStats();
          _val712.read(iprot);
          struct.executor_stats.put(_key711, _val712);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
