...
public class Assignment implements org.apache.thrift.TBase<Assignment, Assignment._Fields>, java.io.Serializable, Cloneable, Comparable<Assignment> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.node_host = new HashMap<String,String>(2*_map628.size);
                String _key629;
                String _val630;
                for (int _i631 = 0; _i631 < _map628.size; ++_i631)
                {
                  ...
                  struct.node_host.put(_key629, _val630);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map632.size);
                List<Long> _key633;
                NodeInfo _val634;
                ...
                {
                  {
                    ...
                    _key633 = new ArrayList<Long>(_list636.size);
                    long _elem637;
                    for (int _i638 = 0; _i638 < _list636.size; ++_i638)
                    {
                      _elem637 = iprot.readI64();
                      _key633.add(_elem637);
                    }
                    iprot.readListEnd();
                  }
                  _val634 = new NodeInfo();
                  _val634.read(iprot);
                  struct.executor_node_port.put(_key633, _val634);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map639.size);
                List<Long> _key640;
                long _val641;
                for (int _i642 = 0; _i642 < _map639.size; ++_i642)
                {
                  {
                    org.apache.thrift.protocol.TList _list643 = iprot.readListBegin();
                    _key640 = new ArrayList<Long>(_list643.size);
                    long _elem644;
                    for (int _i645 = 0; _i645 < _list643.size; ++_i645)
                    {
                      _elem644 = iprot.readI64();
                      _key640.add(_elem644);
                    }
                    iprot.readListEnd();
                  }
                  _val641 = iprot.readI64();
                  struct.executor_start_time_secs.put(_key640, _val641);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.worker_resources = new HashMap<NodeInfo,WorkerResources>(2*_map646.size);
                NodeInfo _key647;
                WorkerResources _val648;
                for (int _i649 = 0; _i649 < _map646.size; ++_i649)
                {
                  _key647 = new NodeInfo();
                  _key647.read(iprot);
                  _val648 = new WorkerResources();
                  _val648.read(iprot);
                  struct.worker_resources.put(_key647, _val648);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.executor_node_port != null) {
        if (struct.is_set_executor_node_port()) {
          oprot.writeFieldBegin(EXECUTOR_NODE_PORT_FIELD_DESC);
          {
            ...
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter651.getKey().size()));
      ...
      if (struct.executor_start_time_secs != null) {
        if (struct.is_set_executor_start_time_secs()) {
          oprot.writeFieldBegin(EXECUTOR_START_TIME_SECS_FIELD_DESC);
          {
            ...
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter653.getKey().size()));
  ...
  private static class AssignmentTupleScheme extends TupleScheme<Assignment> {
      ...
      if (struct.is_set_node_host()) {
        {
          ...
          for (Map.Entry<String, String> _iter656 : struct.node_host.entrySet())
          {
      ...
      if (struct.is_set_executor_node_port()) {
        {
          ...
          for (Map.Entry<List<Long>, NodeInfo> _iter657 : struct.executor_node_port.entrySet())
          {
            {
              oprot.writeI32(_iter657.getKey().size());
              for (long _iter658 : _iter657.getKey())
              {
                oprot.writeI64(_iter658);
              }
            }
            _iter657.getValue().write(oprot);
          }
        }
      }
      if (struct.is_set_executor_start_time_secs()) {
        {
          ...
          for (Map.Entry<List<Long>, Long> _iter659 : struct.executor_start_time_secs.entrySet())
          {
            {
              oprot.writeI32(_iter659.getKey().size());
              for (long _iter660 : _iter659.getKey())
              {
                oprot.writeI64(_iter660);
              }
            }
            oprot.writeI64(_iter659.getValue());
          }
        }
      }
      if (struct.is_set_worker_resources()) {
        {
          ...
          for (Map.Entry<NodeInfo, WorkerResources> _iter661 : struct.worker_resources.entrySet())
          {
            _iter661.getKey().write(oprot);
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Assignment struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map662 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.node_host = new HashMap<String,String>(2*_map662.size);
          String _key663;
          String _val664;
          for (int _i665 = 0; _i665 < _map662.size; ++_i665)
          {
            _key663 = iprot.readString();
            _val664 = iprot.readString();
            struct.node_host.put(_key663, _val664);
          }
        }
        struct.set_node_host_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map666 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map666.size);
          List<Long> _key667;
          NodeInfo _val668;
          for (int _i669 = 0; _i669 < _map666.size; ++_i669)
          {
            {
              org.apache.thrift.protocol.TList _list670 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
              _key667 = new ArrayList<Long>(_list670.size);
              long _elem671;
              for (int _i672 = 0; _i672 < _list670.size; ++_i672)
              {
                _elem671 = iprot.readI64();
                _key667.add(_elem671);
              }
            }
            _val668 = new NodeInfo();
            _val668.read(iprot);
            struct.executor_node_port.put(_key667, _val668);
          }
        }
        struct.set_executor_node_port_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map673 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map673.size);
          List<Long> _key674;
          long _val675;
          for (int _i676 = 0; _i676 < _map673.size; ++_i676)
          {
            {
              org.apache.thrift.protocol.TList _list677 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
              _key674 = new ArrayList<Long>(_list677.size);
              long _elem678;
              for (int _i679 = 0; _i679 < _list677.size; ++_i679)
              {
                _elem678 = iprot.readI64();
                _key674.add(_elem678);
              }
            }
            _val675 = iprot.readI64();
            struct.executor_start_time_secs.put(_key674, _val675);
          }
        }
        struct.set_executor_start_time_secs_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.worker_resources = new HashMap<NodeInfo,WorkerResources>(2*_map680.size);
          NodeInfo _key681;
          WorkerResources _val682;
          for (int _i683 = 0; _i683 < _map680.size; ++_i683)
          {
            _key681 = new NodeInfo();
            _key681.read(iprot);
            _val682 = new WorkerResources();
            _val682.read(iprot);
            struct.worker_resources.put(_key681, _val682);
          }
        }
        struct.set_worker_resources_isSet(true);
      }
