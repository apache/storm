            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map762.size);
                int _key763;
                LocalAssignment _val764;
                for (int _i765 = 0; _i765 < _map762.size; ++_i765)
                {
                  _key763 = iprot.readI32();
                  _val764 = new LocalAssignment();
                  _val764.read(iprot);
                  struct.assignments.put(_key763, _val764);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      if (struct.assignments != null) {
        oprot.writeFieldBegin(ASSIGNMENTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, LocalAssignment> _iter766 : struct.assignments.entrySet())
          {
            oprot.writeI32(_iter766.getKey());
  ...
  private static class LSSupervisorAssignmentsTupleScheme extends TupleScheme<LSSupervisorAssignments> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<Integer, LocalAssignment> _iter767 : struct.assignments.entrySet())
        {
          oprot.writeI32(_iter767.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map768 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map768.size);
        int _key769;
        LocalAssignment _val770;
        for (int _i771 = 0; _i771 < _map768.size; ++_i771)
        {
          _key769 = iprot.readI32();
          _val770 = new LocalAssignment();
          _val770.read(iprot);
          struct.assignments.put(_key769, _val770);
        }
      }
      struct.set_assignments_isSet(true);
    }
