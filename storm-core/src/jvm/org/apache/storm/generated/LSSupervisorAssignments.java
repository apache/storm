            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map742.size);
                int _key743;
                LocalAssignment _val744;
                for (int _i745 = 0; _i745 < _map742.size; ++_i745)
                {
                  _key743 = iprot.readI32();
                  _val744 = new LocalAssignment();
                  _val744.read(iprot);
                  struct.assignments.put(_key743, _val744);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      if (struct.assignments != null) {
        oprot.writeFieldBegin(ASSIGNMENTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, LocalAssignment> _iter746 : struct.assignments.entrySet())
          {
            oprot.writeI32(_iter746.getKey());
  ...
  private static class LSSupervisorAssignmentsTupleScheme extends TupleScheme<LSSupervisorAssignments> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<Integer, LocalAssignment> _iter747 : struct.assignments.entrySet())
        {
          oprot.writeI32(_iter747.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map748 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map748.size);
        int _key749;
        LocalAssignment _val750;
        for (int _i751 = 0; _i751 < _map748.size; ++_i751)
        {
          _key749 = iprot.readI32();
          _val750 = new LocalAssignment();
          _val750.read(iprot);
          struct.assignments.put(_key749, _val750);
        }
      }
      struct.set_assignments_isSet(true);
    }
