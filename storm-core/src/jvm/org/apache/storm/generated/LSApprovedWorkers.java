            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.approved_workers = new HashMap<String,Integer>(2*_map732.size);
                String _key733;
                int _val734;
                for (int _i735 = 0; _i735 < _map732.size; ++_i735)
                {
                  ...
                  struct.approved_workers.put(_key733, _val734);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      if (struct.approved_workers != null) {
        oprot.writeFieldBegin(APPROVED_WORKERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter736 : struct.approved_workers.entrySet())
          {
            oprot.writeString(_iter736.getKey());
  ...
  private static class LSApprovedWorkersTupleScheme extends TupleScheme<LSApprovedWorkers> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Integer> _iter737 : struct.approved_workers.entrySet())
        {
          oprot.writeString(_iter737.getKey());
          oprot.writeI32(_iter737.getValue());
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map738 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
        struct.approved_workers = new HashMap<String,Integer>(2*_map738.size);
        String _key739;
        int _val740;
        for (int _i741 = 0; _i741 < _map738.size; ++_i741)
        {
          _key739 = iprot.readString();
          _val740 = iprot.readI32();
          struct.approved_workers.put(_key739, _val740);
        }
      }
      struct.set_approved_workers_isSet(true);
    }
