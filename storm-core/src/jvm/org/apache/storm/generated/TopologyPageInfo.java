...
public class TopologyPageInfo implements org.apache.thrift.TBase<TopologyPageInfo, TopologyPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyPageInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.id_to_spout_agg_stats = new HashMap<String,ComponentAggregateStats>(2*_map474.size);
                String _key475;
                ...
                for (int _i477 = 0; _i477 < _map474.size; ++_i477)
                {
                  ...
                  _val476.read(iprot);
                  struct.id_to_spout_agg_stats.put(_key475, _val476);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.id_to_bolt_agg_stats = new HashMap<String,ComponentAggregateStats>(2*_map478.size);
                String _key479;
                ...
                for (int _i481 = 0; _i481 < _map478.size; ++_i481)
                {
                  ...
                  _val480.read(iprot);
                  struct.id_to_bolt_agg_stats.put(_key479, _val480);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.workers = new ArrayList<WorkerSummary>(_list482.size);
                WorkerSummary _elem483;
                for (int _i484 = 0; _i484 < _list482.size; ++_i484)
                {
                  _elem483 = new WorkerSummary();
                  _elem483.read(iprot);
                  struct.workers.add(_elem483);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.id_to_spout_agg_stats != null) {
        if (struct.is_set_id_to_spout_agg_stats()) {
          oprot.writeFieldBegin(ID_TO_SPOUT_AGG_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ComponentAggregateStats> _iter485 : struct.id_to_spout_agg_stats.entrySet())
            {
              oprot.writeString(_iter485.getKey());
              _iter485.getValue().write(oprot);
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.id_to_bolt_agg_stats != null) {
        if (struct.is_set_id_to_bolt_agg_stats()) {
          oprot.writeFieldBegin(ID_TO_BOLT_AGG_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ComponentAggregateStats> _iter486 : struct.id_to_bolt_agg_stats.entrySet())
            {
      ...
      if (struct.workers != null) {
        if (struct.is_set_workers()) {
          oprot.writeFieldBegin(WORKERS_FIELD_DESC);
          {
            ...
            for (WorkerSummary _iter487 : struct.workers)
            {
  ...
  private static class TopologyPageInfoTupleScheme extends TupleScheme<TopologyPageInfo> {
      ...
      if (struct.is_set_id_to_spout_agg_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter488 : struct.id_to_spout_agg_stats.entrySet())
          {
      ...
      if (struct.is_set_id_to_bolt_agg_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter489 : struct.id_to_bolt_agg_stats.entrySet())
          {
      ...
      if (struct.is_set_workers()) {
        {
          ...
          for (WorkerSummary _iter490 : struct.workers)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyPageInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TMap _map491 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.id_to_spout_agg_stats = new HashMap<String,ComponentAggregateStats>(2*_map491.size);
          String _key492;
          ComponentAggregateStats _val493;
          for (int _i494 = 0; _i494 < _map491.size; ++_i494)
          {
            _key492 = iprot.readString();
            _val493 = new ComponentAggregateStats();
            _val493.read(iprot);
            struct.id_to_spout_agg_stats.put(_key492, _val493);
          }
        }
        struct.set_id_to_spout_agg_stats_isSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TMap _map495 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.id_to_bolt_agg_stats = new HashMap<String,ComponentAggregateStats>(2*_map495.size);
          String _key496;
          ComponentAggregateStats _val497;
          for (int _i498 = 0; _i498 < _map495.size; ++_i498)
          {
            _key496 = iprot.readString();
            _val497 = new ComponentAggregateStats();
            _val497.read(iprot);
            struct.id_to_bolt_agg_stats.put(_key496, _val497);
          }
        }
        struct.set_id_to_bolt_agg_stats_isSet(true);
      }
      ...
      if (incoming.get(14)) {
        {
          ...
          struct.workers = new ArrayList<WorkerSummary>(_list499.size);
          WorkerSummary _elem500;
          for (int _i501 = 0; _i501 < _list499.size; ++_i501)
          {
            _elem500 = new WorkerSummary();
            _elem500.read(iprot);
            struct.workers.add(_elem500);
          }
        }
        struct.set_workers_isSet(true);
      }
