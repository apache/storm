...
public class TopologyPageInfo implements org.apache.thrift.TBase<TopologyPageInfo, TopologyPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyPageInfo> {
  ...
  private @org.apache.thrift.annotation.Nullable java.lang.String topology_conf; // optional
  private @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,ComponentAggregateStats> id_to_spout_agg_stats; // optional
  private @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,ComponentAggregateStats> id_to_bolt_agg_stats; // optional
  private @org.apache.thrift.annotation.Nullable java.lang.String sched_status; // optional
  private @org.apache.thrift.annotation.Nullable TopologyStats topology_stats; // optional
  ...
  private @org.apache.thrift.annotation.Nullable java.util.List<WorkerSummary> workers; // optional
  ...
  public void set_id(@org.apache.thrift.annotation.Nullable java.lang.String id) {
    this.id = id;
  }
  ...
  public void set_name(@org.apache.thrift.annotation.Nullable java.lang.String name) {
    this.name = name;
  }
  ...
  public void set_status(@org.apache.thrift.annotation.Nullable java.lang.String status) {
    this.status = status;
  }
  ...
  public void set_topology_conf(@org.apache.thrift.annotation.Nullable java.lang.String topology_conf) {
  ...
  public void set_id_to_spout_agg_stats(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,ComponentAggregateStats> id_to_spout_agg_stats) {
  ...
  public void set_id_to_bolt_agg_stats(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,ComponentAggregateStats> id_to_bolt_agg_stats) {
  ...
  public void set_sched_status(@org.apache.thrift.annotation.Nullable java.lang.String sched_status) {
  ...
  public void set_topology_stats(@org.apache.thrift.annotation.Nullable TopologyStats topology_stats) {
  ...
  public void set_owner(@org.apache.thrift.annotation.Nullable java.lang.String owner) {
    this.owner = owner;
  }
  ...
  public void set_workers(@org.apache.thrift.annotation.Nullable java.util.List<WorkerSummary> workers) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.id_to_spout_agg_stats = new java.util.HashMap<java.lang.String,ComponentAggregateStats>(2*_map454.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key455;
                @org.apache.thrift.annotation.Nullable ComponentAggregateStats _val456;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.id_to_bolt_agg_stats = new java.util.HashMap<java.lang.String,ComponentAggregateStats>(2*_map458.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key459;
                @org.apache.thrift.annotation.Nullable ComponentAggregateStats _val460;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.workers = new java.util.ArrayList<WorkerSummary>(_list462.size);
                @org.apache.thrift.annotation.Nullable WorkerSummary _elem463;
      ...
      if (struct.id_to_spout_agg_stats != null) {
        if (struct.is_set_id_to_spout_agg_stats()) {
          oprot.writeFieldBegin(ID_TO_SPOUT_AGG_STATS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, ComponentAggregateStats> _iter465 : struct.id_to_spout_agg_stats.entrySet())
            {
      ...
      if (struct.id_to_bolt_agg_stats != null) {
        if (struct.is_set_id_to_bolt_agg_stats()) {
          oprot.writeFieldBegin(ID_TO_BOLT_AGG_STATS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, ComponentAggregateStats> _iter466 : struct.id_to_bolt_agg_stats.entrySet())
            {
      ...
      if (struct.is_set_id_to_spout_agg_stats()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, ComponentAggregateStats> _iter468 : struct.id_to_spout_agg_stats.entrySet())
          {
      ...
      if (struct.is_set_id_to_bolt_agg_stats()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, ComponentAggregateStats> _iter469 : struct.id_to_bolt_agg_stats.entrySet())
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.id_to_spout_agg_stats = new java.util.HashMap<java.lang.String,ComponentAggregateStats>(2*_map471.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key472;
          @org.apache.thrift.annotation.Nullable ComponentAggregateStats _val473;
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.id_to_bolt_agg_stats = new java.util.HashMap<java.lang.String,ComponentAggregateStats>(2*_map475.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key476;
          @org.apache.thrift.annotation.Nullable ComponentAggregateStats _val477;
      ...
      if (incoming.get(14)) {
        {
          ...
          struct.workers = new java.util.ArrayList<WorkerSummary>(_list479.size);
