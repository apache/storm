...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.used_ports = new ArrayList<Long>(_list584.size);
                long _elem585;
                for (int _i586 = 0; _i586 < _list584.size; ++_i586)
                {
                  _elem585 = iprot.readI64();
                  struct.used_ports.add(_elem585);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.meta = new ArrayList<Long>(_list587.size);
                long _elem588;
                for (int _i589 = 0; _i589 < _list587.size; ++_i589)
                {
                  _elem588 = iprot.readI64();
                  struct.meta.add(_elem588);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.scheduler_meta = new HashMap<String,String>(2*_map590.size);
                String _key591;
                String _val592;
                for (int _i593 = 0; _i593 < _map590.size; ++_i593)
                {
                  ...
                  struct.scheduler_meta.put(_key591, _val592);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.resources_map = new HashMap<String,Double>(2*_map594.size);
                String _key595;
                double _val596;
                for (int _i597 = 0; _i597 < _map594.size; ++_i597)
                {
                  ...
                  struct.resources_map.put(_key595, _val596);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.used_ports != null) {
        if (struct.is_set_used_ports()) {
          oprot.writeFieldBegin(USED_PORTS_FIELD_DESC);
          {
            ...
            for (long _iter598 : struct.used_ports)
            {
      ...
      if (struct.scheduler_meta != null) {
        if (struct.is_set_scheduler_meta()) {
          oprot.writeFieldBegin(SCHEDULER_META_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter600 : struct.scheduler_meta.entrySet())
            {
      ...
      if (struct.resources_map != null) {
        if (struct.is_set_resources_map()) {
          oprot.writeFieldBegin(RESOURCES_MAP_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter601 : struct.resources_map.entrySet())
            {
  ...
  private static class SupervisorInfoTupleScheme extends TupleScheme<SupervisorInfo> {
      ...
      if (struct.is_set_used_ports()) {
        {
          ...
          for (long _iter602 : struct.used_ports)
          {
            oprot.writeI64(_iter602);
          }
        }
      }
      if (struct.is_set_meta()) {
      ...
      if (struct.is_set_scheduler_meta()) {
        {
          ...
          for (Map.Entry<String, String> _iter604 : struct.scheduler_meta.entrySet())
          {
      ...
      if (struct.is_set_resources_map()) {
        {
          ...
          for (Map.Entry<String, Double> _iter605 : struct.resources_map.entrySet())
          {
            oprot.writeString(_iter605.getKey());
            oprot.writeDouble(_iter605.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list606 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.used_ports = new ArrayList<Long>(_list606.size);
          long _elem607;
          for (int _i608 = 0; _i608 < _list606.size; ++_i608)
          {
            _elem607 = iprot.readI64();
            struct.used_ports.add(_elem607);
          }
        }
        struct.set_used_ports_isSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.meta = new ArrayList<Long>(_list609.size);
          long _elem610;
          for (int _i611 = 0; _i611 < _list609.size; ++_i611)
          {
            _elem610 = iprot.readI64();
            struct.meta.add(_elem610);
          }
        }
        struct.set_meta_isSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map612 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.scheduler_meta = new HashMap<String,String>(2*_map612.size);
          String _key613;
          String _val614;
          for (int _i615 = 0; _i615 < _map612.size; ++_i615)
          {
            _key613 = iprot.readString();
            _val614 = iprot.readString();
            struct.scheduler_meta.put(_key613, _val614);
          }
        }
        struct.set_scheduler_meta_isSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.resources_map = new HashMap<String,Double>(2*_map616.size);
          String _key617;
          double _val618;
          for (int _i619 = 0; _i619 < _map616.size; ++_i619)
          {
            ...
            struct.resources_map.put(_key617, _val618);
          }
        }
        struct.set_resources_map_isSet(true);
      }
