...
public class Config extends HashMap<String, Object> {
    ...
    /**
     * Class that specifies the avro serializer.
     */
    @isString
    public static final String TOPOLOGY_AVRO_SERIALIZER = "topology.avro.serializer";

    /**
     * The url that specifies the topology avro schema registry server.
     */
    @isString
    public static final String TOPOLOGY_AVRO_CONFLUENT_SCHEMA_REGISTRY_URL = "topology.avro.confluent.schema.registry.url";
