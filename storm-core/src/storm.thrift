...
struct BoltStats {
  ...
  6: optional map<string, map<string, double>> receive_queue_length;
  7: optional map<string, map<string, double>> batch_transfer_queue_length;
}
...
struct SpoutStats {
  ...
  4: optional map<string, map<string, double>> receive_queue_length;
  5: optional map<string, map<string, double>> batch_transfer_queue_length;
}
