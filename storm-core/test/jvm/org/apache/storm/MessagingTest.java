    ...
    public void testLocalTransport() throws Exception {
        ...
        for(boolean transportOn:transportOptions) {
            ...
            FixedTuple[] fixedTuple = {new FixedTuple((List<Object>) Collections.singletonList((Object) "a")), new FixedTuple((List<Object>) Collections.singletonList((Object) "b")),
                    new FixedTuple((List<Object>) Collections.singletonList((Object) "a")), new FixedTuple((List<Object>) Collections.singletonList((Object) "b")),
                    new FixedTuple((List<Object>) Collections.singletonList((Object) "a")), new FixedTuple((List<Object>) Collections.singletonList((Object) "b")),
                    new FixedTuple((List<Object>) Collections.singletonList((Object) "a")), new FixedTuple((List<Object>) Collections.singletonList((Object) "b")),
                    new FixedTuple((List<Object>) Collections.singletonList((Object) "a")), new FixedTuple((List<Object>) Collections.singletonList((Object) "b")),
                    new FixedTuple((List<Object>) Collections.singletonList((Object) "a")), new FixedTuple((List<Object>) Collections.singletonList((Object) "b")),
            ...
            for(int i = 0; i<12; i++) {
                fixedTuples.add (new FixedTuple((List<Object>) Collections.singletonList((Object) "a")));
                fixedTuples.add (new FixedTuple((List<Object>) Collections.singletonList((Object) "b")));
            }
            Map<String, List<FixedTuple>> data = new HashMap<>();
            //data.put("1", Arrays.asList(fixedTuple));
            ...
            //LOG.info("Cleaning inbox ... deleted: {}",Testing.readTuples(results,"2").size());
