...
public class SpoutExecutors extends BaseExecutors implements EventHandler {
    ...
    public SpoutExecutors(backtype.storm.spout.ISpout _spout,
            TaskTransfer _transfer_fn,  Map<Integer, DisruptorQueue> innerTaskTransfer, 
            Map _storm_conf, IConnection _puller, TaskSendTargets sendTargets,
        ...
        super(_transfer_fn, _storm_conf, _puller,  innerTaskTransfer, topology_context,
        ...
        this.pending = new RotatingMap(Acker.TIMEOUT_BUCKET_NUM,
                new SpoutTimeoutCallBack<Object, Object>(disruptorRecvQueue, spout,
                        storm_conf, task_stats));
        this.rotateTime = 1000L * JStormUtils.parseInt(storm_conf
        ...
        try {
            ...
            if (event instanceof IAckMsg) {
                ...
                if (stream_id.equals(Acker.ACKER_ACK_STREAM_ID)) {
                    ...
                    runnable = new AckSpoutMsg(spout, tupleInfo.getMessageId(), isDebug,
                        tupleInfo.getStream(), tupleInfo.getTimestamp(), task_stats);
