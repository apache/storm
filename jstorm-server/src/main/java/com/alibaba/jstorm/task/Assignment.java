 ...
 * taskStartTimeSecs: {taskid, taskStartSeconds} 
...
public class Assignment implements Serializable {
    ...
    /**
     * @@@ nodeHost store <supervisorId, hostname>, 
     * this will waste some zk storage
     */
    ...
    public Assignment(String masterCodeDir, Map<Integer, ResourceAssignment> taskToResource,
     ...
     */
    public Map<Integer, ResourceAssignment> getTaskToResourcebyNode(String supervisorId) {
    ...
    public static Map<WorkerSlot, List<Integer>> getWorkerTasks(Map<Integer, ResourceAssignment> taskToResource) {
        ...
        for (Entry<Integer, ResourceAssignment> entry : taskToResource.entrySet()) {
            ...
            WorkerSlot workerSlot = new WorkerSlot(assignment.getSupervisorId(),
                assignment.getPort());
    ...
    public int hashCode() {
        ...
        result = prime * result + ((taskToResource == null) ? 0 : taskToResource.hashCode());
        return result;
    }
