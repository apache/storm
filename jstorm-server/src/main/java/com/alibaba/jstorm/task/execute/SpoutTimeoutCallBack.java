...
public class SpoutTimeoutCallBack<K, V> implements RotatingMap.ExpiredCallback<K, V> {
	...
	public SpoutTimeoutCallBack(DisruptorQueue disruptorEventQueue, 
			backtype.storm.spout.ISpout _spout,
			Map _storm_conf, CommonStatsRolling stat) {
