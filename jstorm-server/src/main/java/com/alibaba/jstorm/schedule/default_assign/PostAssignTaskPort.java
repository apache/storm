...
public class PostAssignTaskPort implements IPostAssignTask{
     ...
     */
    public void assignWorkerNumToSupervisor(DefaultTopologyAssignContext defaultContext,
     ...
     */
    public void assignTaskPort(DefaultTopologyAssignContext defaultContext, List<Integer> taskList,
                               Integer workerNum, Map<Integer, ResourceAssignment> newAssigns,
    ...
    public void assignTaskPort(DefaultTopologyAssignContext defaultContext,
        ...
        for (Entry<String, List<Integer>> entry : supervisorTasks.entrySet()) {
            ...
            assignTaskPort(defaultContext, taskList, workerNum, newAssigns, supervisorInfo);
        }
    }
    ...
    public void assignTaskPort(DefaultTopologyAssignContext defaultContext,
        ...
        assignWorkerNumToSupervisor(defaultContext, newAssigns, allocWorkerNum, supervisorTasks,
            supervisorAssignSlotNumMap);

        assignTaskPort(defaultContext, supervisorAssignSlotNumMap, supervisorTasks, newAssigns);
    }
