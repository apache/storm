...
public interface StormClusterState {
	...
	public Assignment assignment_info(String topology_id, RunnableCallback callback)
			throws Exception;
	...
	public void task_heartbeat(String topology_id, int task_id, TaskHeartbeat info)
			throws Exception;
	...
	public void report_task_error(String topology_id, int task_id, Throwable error)
			throws Exception;
