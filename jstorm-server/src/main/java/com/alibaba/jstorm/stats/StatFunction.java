...
public class StatFunction {
    ...
    public static synchronized Pair<Long, Long> update_avg(Pair<Long, Long> curr, long val) {
    ...
    public static void update_keyed_avg(Map<Object, Pair<Long, Long>> map, Object key,
            long val) {
