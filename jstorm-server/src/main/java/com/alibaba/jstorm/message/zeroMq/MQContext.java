...
public class MQContext implements IContext {
	...
	public void prepare(Map storm_conf) {
		...
		int zmqThreads = JStormUtils.parseInt(storm_conf.get(Config.ZMQ_THREADS));
		linger_ms = JStormUtils.parseInt(storm_conf.get(Config.ZMQ_LINGER_MILLIS));
		...
		maxQueueMsg = JStormUtils.parseInt(
...
//		int zmqThreads = JStormUtils.parseInt(storm_conf.get(Config.ZMQ_THREADS));
//
//        int linger = JStormUtils.parseInt(storm_conf.get(Config.ZMQ_LINGER_MILLIS));
//         
...
//    }
	...
	@Override
	public IConnection bind(String storm_id, int port, boolean distribute) {
	...
	@Override
	public IConnection connect(String storm_id, String host, int port, boolean distribute) {
		if (distribute || virtportZmq) {
    ...
    private IConnection zmq_connect(boolean distributeZmq, String host,
            int port) {
        String url = null;
