...
public class Worker {
    ...
    public Worker(Map conf, IContext context, String topology_id,
        ...
        workerData = new WorkerData(conf, context, topology_id,
    ...
    private List<TaskShutdownDameon> createTasks()
        ...
        for (int taskid : taskids) {
            ...
            TaskShutdownDameon t = Task.mk_task(workerData, 
                    taskid);
    ...
    public static WorkerShutdown mk_worker(Map conf, IContext context,
        ...
        Worker w = new Worker(conf, context, topology_id, supervisor_id,
                port, worker_id);
