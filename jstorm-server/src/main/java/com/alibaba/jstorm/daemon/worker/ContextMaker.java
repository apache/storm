...
public class ContextMaker {
    ...
    public ContextMaker(WorkerData workerData) {
        /*
         * Map stormConf, String topologyId, String workerId,
    ...
    public TopologyContext makeTopologyContext(StormTopology topology,
        ...
        for (String component : components) {
            ...
            Map<String, StreamInfo> streamInfoMap = ThriftTopologyUtils.getComponentCommon(
                    topology, component).get_streams();
        ...
        return new TopologyContext(topology, stormConf,
            ...
            workerData.getUserResources(),
            workerData.getExecutorData(),
            workerData.getRegisteredMetrics(),
