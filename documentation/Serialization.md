...
Storm provides helpers for registering serializers in a topology config. The [Config](/javadoc/apidocs/org/apache/storm/Config.html) class has a method called `registerSerialization` that takes in a registration to add to the config.
