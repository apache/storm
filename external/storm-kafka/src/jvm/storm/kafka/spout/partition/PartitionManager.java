...
import storm.kafka.spout.KafkaSpout.EmitState;
import storm.kafka.spout.KafkaSpout.MessageAndRealOffset;
...
import storm.kafka.spout.retry.FailedMsgRetryManager;
...
public class PartitionManager {
    ...
    private final String ZK_STATE_ROOT = "/kafka_consumer_offset";
    ...
    public PartitionManager(ConsumerConnectionCache connectionCache, String topologyInstanceId, ZkState state, Map stormConf, KafkaConfig spoutConfig, Partition id) {
        _partition = id;
        _connections = connectionCache;
        _spoutConfig = spoutConfig;
        _topologyInstanceId = topologyInstanceId;
        _consumer = connectionCache.register(id.host, id.partition);
        _state = state;
        _stormConf = stormConf;
        numberAcked = numberFailed = 0;
        _topologyId = (String) stormConf.get(Config.STORM_ID);
    ...
    private String committedPath() {
        return ZK_STATE_ROOT + "/" + _topologyId + "/" + _partition.getId();
    }
