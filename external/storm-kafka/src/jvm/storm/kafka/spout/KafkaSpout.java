...
import storm.kafka.spout.partition.KafkaPartitionCoordinator;
import storm.kafka.spout.partition.Partition;
import storm.kafka.spout.partition.PartitionCoordinator;
import storm.kafka.spout.partition.PartitionManager;
import storm.kafka.spout.partition.PartitionManager.KafkaMessageId;
...
public class KafkaSpout extends BaseRichSpout {
    ...
    public KafkaSpout(KafkaConfig spoutConf) {
    ...
    public void open(Map conf, final TopologyContext context, final SpoutOutputCollector collector) {
        ...
        _connections = new ConsumerConnectionCache(_spoutConfig);

        // using TransactionalState like this is a hack
        int totalTasks = context.getComponentTasks(context.getThisComponentId()).size();
        _coordinator = new KafkaPartitionCoordinator(_connections, conf, _spoutConfig, _state, context.getThisTaskIndex(), totalTasks, _uuid);
