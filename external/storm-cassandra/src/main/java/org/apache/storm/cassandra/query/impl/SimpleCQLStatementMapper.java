...
public class SimpleCQLStatementMapper implements CQLStatementTupleMapper {
    ...
    public List<Statement<?>> map(Map<String, Object> conf, CqlSession session, ITuple tuple) {
        ...
        StatementBuilder statementBuilder = new SimpleStatementBuilder(queryString)
                .addPositionalValues(Column.getValsList(columns));
        //SimpleStatement statement = new DefaultSimpleStatement(queryString, Column.getValsList(columns));
        //new DefaultSimpleStatement(queryString,
        //        Column.getValsList(columns)),
        //        Maps.newHashMap(),
        //        "execProfile",
        //        new DriverExecutionProfile.Base(inst())
