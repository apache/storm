...
public class PulsarBoltIntegrationTest extends ProducerConsumerBase {
    ...
    public void testSharedProducer() throws Exception {
        ...
        Assert.assertEquals(1, topicStats.getPublishers().size());
    ...
    public void testFailedProducer() {
        ...
        try {
            bolt.prepare(Maps.newHashMap(), context, collector);
            Assert.fail("should have failed as producer creation failed");
