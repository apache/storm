...
| .setIgnoreSuffix()         |~~hdfsspout.ignore.suffix~~           |   .ignore   | Comma separated list of files name suffixes. File with matching suffixes in the hdfsspout.source.dir location will not be processed |
