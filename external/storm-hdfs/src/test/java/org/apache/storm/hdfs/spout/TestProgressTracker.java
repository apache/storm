...
public class TestProgressTracker {
    ...
    public void testBasic() throws Exception {
        ...
        failassertEquals(pos5, tracker.getCommitPosition()); // should be at 5

        tracker.recordAckedOffset(pos6);
        failassertEquals(pos6, tracker.getCommitPosition()); // should be at 6
        tracker.recordAckedOffset(pos6);                        // double ack on same msg
        failassertEquals(pos6, tracker.getCommitPosition()); // should still be at 6

        tracker.recordAckedOffset(pos7);
        failassertEquals(pos7, tracker.getCommitPosition()); // should be at 7
