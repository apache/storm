...
public class TestTransactionalTridentEmitter {
	...
	public void testEmitInSequence() {
		...
		Map<String, String> meta = emitter.emitPartitionBatchNew(null, collectorMock, partition, null);
	...
	public void testReEmit() {
		...
		// emit second batch
		Map<String, String> meta1 = emitter.emitPartitionBatchNew(null, collectorMock, partition, meta);
