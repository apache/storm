...
public class GroupedAggregator implements Aggregator<Object[]> {
	...
	public GroupedAggregator(Aggregator agg, Fields group, Fields input,
			int outSize) {
		_groupFields = group;
		_inFields = input;
		_agg = agg;
	...
	public Object[] init(Object batchId, TridentCollector collector) {
		return new Object[] { new GroupCollector(collector, _fact),
				new HashMap(), batchId };
	}

	@Override
	public void aggregate(Object[] arr, TridentTuple tuple,
