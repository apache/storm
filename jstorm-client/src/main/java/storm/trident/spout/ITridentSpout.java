...
public interface ITridentSpout<T> extends Serializable {
	public interface BatchCoordinator<X> {
		 ...
		 * @param currMetadata
		 *            The metadata for this transaction the last time it was
		 *            initialized. null if this is the first attempt
	...
	public interface Emitter<X> {
		...
		/**
		 * This attempt committed successfully, so all state for this commit and
		 * before can be safely cleaned up.
		 */
	 ...
	 * replayed.
	 */
	BatchCoordinator<T> getCoordinator(String txStateId, Map conf,
