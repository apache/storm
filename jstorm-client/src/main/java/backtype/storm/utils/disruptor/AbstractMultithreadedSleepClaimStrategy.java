...
public abstract class AbstractMultithreadedSleepClaimStrategy implements ClaimStrategy
{
    ...
    public AbstractMultithreadedSleepClaimStrategy(int bufferSize)
    {
    ...
    protected void waitForFreeSlotAt(final long sequence, final Sequence[] dependentSequences, final MutableLong minGatingSequence)
    {
