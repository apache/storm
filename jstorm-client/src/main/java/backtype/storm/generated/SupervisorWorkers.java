...
public class SupervisorWorkers implements
		org.apache.thrift.TBase<SupervisorWorkers, SupervisorWorkers._Fields>,
		java.io.Serializable, Cloneable {
	private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
			"SupervisorWorkers");

	private static final org.apache.thrift.protocol.TField SUPERVISOR_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"supervisor", org.apache.thrift.protocol.TType.STRUCT, (short) 1);
	private static final org.apache.thrift.protocol.TField WORKERS_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"workers", org.apache.thrift.protocol.TType.LIST, (short) 2);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		SUPERVISOR((short) 1, "supervisor"), WORKERS((short) 2, "workers");
	...
	static {
		Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
				_Fields.class);
		tmpMap.put(_Fields.SUPERVISOR,
				new org.apache.thrift.meta_data.FieldMetaData("supervisor",
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				SupervisorWorkers.class, metaDataMap);
	}

	public SupervisorWorkers() {
	}

	public SupervisorWorkers(SupervisorSummary supervisor,
	...
	/**
	 * Returns true if field supervisor is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	/**
	 * Returns true if field workers is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	public int compareTo(SupervisorWorkers other) {
		...
		lastComparison = Boolean.valueOf(is_set_supervisor()).compareTo(
				typedOther.is_set_supervisor());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (is_set_supervisor()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.supervisor, typedOther.supervisor);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(is_set_workers()).compareTo(
				typedOther.is_set_workers());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (is_set_workers()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.workers, typedOther.workers);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		while (true) {
			...
			case 2: // WORKERS
				if (field.type == org.apache.thrift.protocol.TType.LIST) {
					{
						org.apache.thrift.protocol.TList _list197 = iprot
								.readListBegin();
						this.workers = new ArrayList<WorkerSummary>(
								_list197.size);
						for (int _i198 = 0; _i198 < _list197.size; ++_i198) {
							WorkerSummary _elem199; // required
							_elem199 = new WorkerSummary();
							_elem199.read(iprot);
							this.workers.add(_elem199);
						}
						iprot.readListEnd();
					}
				} else {
		...
		if (this.workers != null) {
			oprot.writeFieldBegin(WORKERS_FIELD_DESC);
			{
				oprot.writeListBegin(new org.apache.thrift.protocol.TList(
						org.apache.thrift.protocol.TType.STRUCT, this.workers
								.size()));
				for (WorkerSummary _iter200 : this.workers) {
	...
	public void validate() throws org.apache.thrift.TException {
		...
		if (!is_set_supervisor()) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'supervisor' is unset! Struct:"
							+ toString());
		}

		if (!is_set_workers()) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'workers' is unset! Struct:" + toString());
		}
