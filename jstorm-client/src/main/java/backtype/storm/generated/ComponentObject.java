...
public class ComponentObject extends
		org.apache.thrift.TUnion<ComponentObject, ComponentObject._Fields> {
	private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
			"ComponentObject");
	private static final org.apache.thrift.protocol.TField SERIALIZED_JAVA_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"serialized_java", org.apache.thrift.protocol.TType.STRING,
			(short) 1);
	private static final org.apache.thrift.protocol.TField SHELL_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"shell", org.apache.thrift.protocol.TType.STRUCT, (short) 2);
	private static final org.apache.thrift.protocol.TField JAVA_OBJECT_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"java_object", org.apache.thrift.protocol.TType.STRUCT, (short) 3);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		SERIALIZED_JAVA((short) 1, "serialized_java"), SHELL((short) 2, "shell"), JAVA_OBJECT(
				(short) 3, "java_object");
	...
	static {
		Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
				_Fields.class);
		tmpMap.put(_Fields.SERIALIZED_JAVA,
				new org.apache.thrift.meta_data.FieldMetaData(
						"serialized_java",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.FieldValueMetaData(
								org.apache.thrift.protocol.TType.STRING, true)));
		tmpMap.put(_Fields.SHELL,
				new org.apache.thrift.meta_data.FieldMetaData("shell",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.StructMetaData(
								org.apache.thrift.protocol.TType.STRUCT,
								ShellComponent.class)));
		tmpMap.put(_Fields.JAVA_OBJECT,
				new org.apache.thrift.meta_data.FieldMetaData("java_object",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.StructMetaData(
								org.apache.thrift.protocol.TType.STRUCT,
								JavaObject.class)));
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				ComponentObject.class, metaDataMap);
	}
	...
	protected void checkType(_Fields setField, Object value)
		...
		case SERIALIZED_JAVA:
			...
			throw new ClassCastException(
					"Was expecting value of type ByteBuffer for field 'serialized_java', but got "
		...
		case SHELL:
			...
			throw new ClassCastException(
					"Was expecting value of type ShellComponent for field 'shell', but got "
							+ value.getClass().getSimpleName());
		case JAVA_OBJECT:
			...
			throw new ClassCastException(
					"Was expecting value of type JavaObject for field 'java_object', but got "
							+ value.getClass().getSimpleName());
		default:
	...
	public byte[] get_serialized_java() {
		set_serialized_java(org.apache.thrift.TBaseHelper
				.rightSize(buffer_for_serialized_java()));
	...
	public ByteBuffer buffer_for_serialized_java() {
		if (getSetField() == _Fields.SERIALIZED_JAVA) {
			...
			throw new RuntimeException(
					"Cannot get field 'serialized_java' because union is currently set to "
	...
	public ShellComponent get_shell() {
		if (getSetField() == _Fields.SHELL) {
			...
			throw new RuntimeException(
					"Cannot get field 'shell' because union is currently set to "
							+ getFieldDesc(getSetField()).name);
		}
	}
	...
	public JavaObject get_java_object() {
		if (getSetField() == _Fields.JAVA_OBJECT) {
			...
			throw new RuntimeException(
					"Cannot get field 'java_object' because union is currently set to "
							+ getFieldDesc(getSetField()).name);
		}
	}
