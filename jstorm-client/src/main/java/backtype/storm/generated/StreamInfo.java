...
public class StreamInfo implements
		org.apache.thrift.TBase<StreamInfo, StreamInfo._Fields>,
		java.io.Serializable, Cloneable {
	private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
			"StreamInfo");

	private static final org.apache.thrift.protocol.TField OUTPUT_FIELDS_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"output_fields", org.apache.thrift.protocol.TType.LIST, (short) 1);
	private static final org.apache.thrift.protocol.TField DIRECT_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"direct", org.apache.thrift.protocol.TType.BOOL, (short) 2);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		OUTPUT_FIELDS((short) 1, "output_fields"), DIRECT((short) 2, "direct");
	...
	static {
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				StreamInfo.class, metaDataMap);
	}

	public StreamInfo() {
	}

	public StreamInfo(List<String> output_fields, boolean direct) {
		this();
	...
	public java.util.Iterator<String> get_output_fields_iterator() {
		return (this.output_fields == null) ? null : this.output_fields
				.iterator();
	}
	...
	/**
	 * Returns true if field output_fields is set (has been assigned a value)
	 * and false otherwise
	 */
	...
	/**
	 * Returns true if field direct is set (has been assigned a value) and false
	 * otherwise
	 */
	...
	public boolean equals(StreamInfo that) {
		...
		boolean this_present_output_fields = true && this
				.is_set_output_fields();
		boolean that_present_output_fields = true && that
				.is_set_output_fields();
	...
	public int compareTo(StreamInfo other) {
		...
		lastComparison = Boolean.valueOf(is_set_output_fields()).compareTo(
				typedOther.is_set_output_fields());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (is_set_output_fields()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.output_fields, typedOther.output_fields);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(is_set_direct()).compareTo(
				typedOther.is_set_direct());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (is_set_direct()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.direct, typedOther.direct);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void validate() throws org.apache.thrift.TException {
		...
		if (!is_set_output_fields()) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'output_fields' is unset! Struct:"
							+ toString());
		}

		if (!is_set_direct()) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'direct' is unset! Struct:" + toString());
		}
