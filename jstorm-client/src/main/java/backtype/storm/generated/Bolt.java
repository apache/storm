...
public class Bolt implements org.apache.thrift.TBase<Bolt, Bolt._Fields>,
	...
	private static final org.apache.thrift.protocol.TField BOLT_OBJECT_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"bolt_object", org.apache.thrift.protocol.TType.STRUCT, (short) 1);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		BOLT_OBJECT((short) 1, "bolt_object"), COMMON((short) 2, "common");
	...
	static {
		Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
				_Fields.class);
		tmpMap.put(_Fields.BOLT_OBJECT,
				new org.apache.thrift.meta_data.FieldMetaData("bolt_object",
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				Bolt.class, metaDataMap);
	}

	public Bolt() {
	}

	public Bolt(ComponentObject bolt_object, ComponentCommon common) {
		this();
	...
	/**
	 * Returns true if field bolt_object is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	public int compareTo(Bolt other) {
		...
		lastComparison = Boolean.valueOf(is_set_bolt_object()).compareTo(
				typedOther.is_set_bolt_object());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (is_set_bolt_object()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.bolt_object, typedOther.bolt_object);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void validate() throws org.apache.thrift.TException {
		...
		if (!is_set_bolt_object()) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'bolt_object' is unset! Struct:"
							+ toString());
		}
