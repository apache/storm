...
public class Grouping extends
	...
	private static final org.apache.thrift.protocol.TField SHUFFLE_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"shuffle", org.apache.thrift.protocol.TType.STRUCT, (short) 2);
	private static final org.apache.thrift.protocol.TField ALL_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"all", org.apache.thrift.protocol.TType.STRUCT, (short) 3);
	private static final org.apache.thrift.protocol.TField NONE_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"none", org.apache.thrift.protocol.TType.STRUCT, (short) 4);
	private static final org.apache.thrift.protocol.TField DIRECT_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"direct", org.apache.thrift.protocol.TType.STRUCT, (short) 5);
	private static final org.apache.thrift.protocol.TField CUSTOM_OBJECT_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"custom_object", org.apache.thrift.protocol.TType.STRUCT, (short) 6);
	private static final org.apache.thrift.protocol.TField CUSTOM_SERIALIZED_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"custom_serialized", org.apache.thrift.protocol.TType.STRING,
			(short) 7);
	private static final org.apache.thrift.protocol.TField LOCAL_OR_SHUFFLE_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"local_or_shuffle", org.apache.thrift.protocol.TType.STRUCT,
			(short) 8);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		FIELDS((short) 1, "fields"), SHUFFLE((short) 2, "shuffle"), ALL(
				(short) 3, "all"), NONE((short) 4, "none"), DIRECT((short) 5,
				"direct"), CUSTOM_OBJECT((short) 6, "custom_object"), CUSTOM_SERIALIZED(
				(short) 7, "custom_serialized"), LOCAL_OR_SHUFFLE((short) 8,
				"local_or_shuffle");
	...
	static {
		...
		tmpMap.put(_Fields.SHUFFLE,
				new org.apache.thrift.meta_data.FieldMetaData("shuffle",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.StructMetaData(
								org.apache.thrift.protocol.TType.STRUCT,
								NullStruct.class)));
		tmpMap.put(_Fields.ALL, new org.apache.thrift.meta_data.FieldMetaData(
				"all", org.apache.thrift.TFieldRequirementType.DEFAULT,
				new org.apache.thrift.meta_data.StructMetaData(
						org.apache.thrift.protocol.TType.STRUCT,
						NullStruct.class)));
		tmpMap.put(_Fields.NONE, new org.apache.thrift.meta_data.FieldMetaData(
				"none", org.apache.thrift.TFieldRequirementType.DEFAULT,
				new org.apache.thrift.meta_data.StructMetaData(
						org.apache.thrift.protocol.TType.STRUCT,
						NullStruct.class)));
		tmpMap.put(_Fields.DIRECT,
				new org.apache.thrift.meta_data.FieldMetaData("direct",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.StructMetaData(
								org.apache.thrift.protocol.TType.STRUCT,
								NullStruct.class)));
		tmpMap.put(_Fields.CUSTOM_OBJECT,
				new org.apache.thrift.meta_data.FieldMetaData("custom_object",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.StructMetaData(
								org.apache.thrift.protocol.TType.STRUCT,
								JavaObject.class)));
		tmpMap.put(_Fields.CUSTOM_SERIALIZED,
				new org.apache.thrift.meta_data.FieldMetaData(
						"custom_serialized",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.FieldValueMetaData(
								org.apache.thrift.protocol.TType.STRING, true)));
		tmpMap.put(_Fields.LOCAL_OR_SHUFFLE,
				new org.apache.thrift.meta_data.FieldMetaData(
						"local_or_shuffle",
						org.apache.thrift.TFieldRequirementType.DEFAULT,
						new org.apache.thrift.meta_data.StructMetaData(
	...
	protected void checkType(_Fields setField, Object value)
		...
		case FIELDS:
			...
			throw new ClassCastException(
					"Was expecting value of type List<String> for field 'fields', but got "
		...
		case SHUFFLE:
			...
			throw new ClassCastException(
					"Was expecting value of type NullStruct for field 'shuffle', but got "
							+ value.getClass().getSimpleName());
		case ALL:
			if (value instanceof NullStruct) {
				break;
			...
			throw new ClassCastException(
					"Was expecting value of type NullStruct for field 'all', but got "
							+ value.getClass().getSimpleName());
		case NONE:
			if (value instanceof NullStruct) {
				break;
			...
			throw new ClassCastException(
					"Was expecting value of type NullStruct for field 'none', but got "
							+ value.getClass().getSimpleName());
		case DIRECT:
			if (value instanceof NullStruct) {
				break;
			...
			throw new ClassCastException(
					"Was expecting value of type NullStruct for field 'direct', but got "
							+ value.getClass().getSimpleName());
		case CUSTOM_OBJECT:
			...
			throw new ClassCastException(
					"Was expecting value of type JavaObject for field 'custom_object', but got "
							+ value.getClass().getSimpleName());
		case CUSTOM_SERIALIZED:
			...
			throw new ClassCastException(
					"Was expecting value of type ByteBuffer for field 'custom_serialized', but got "
							+ value.getClass().getSimpleName());
		case LOCAL_OR_SHUFFLE:
			...
			throw new ClassCastException(
					"Was expecting value of type NullStruct for field 'local_or_shuffle', but got "
							+ value.getClass().getSimpleName());
		default:
	...
	public List<String> get_fields() {
		if (getSetField() == _Fields.FIELDS) {
			...
			throw new RuntimeException(
					"Cannot get field 'fields' because union is currently set to "
	...
	public NullStruct get_shuffle() {
		if (getSetField() == _Fields.SHUFFLE) {
			...
			throw new RuntimeException(
					"Cannot get field 'shuffle' because union is currently set to "
							+ getFieldDesc(getSetField()).name);
		}
	}
	...
	public NullStruct get_all() {
		if (getSetField() == _Fields.ALL) {
			...
			throw new RuntimeException(
					"Cannot get field 'all' because union is currently set to "
							+ getFieldDesc(getSetField()).name);
		}
	}
	...
	public NullStruct get_none() {
		if (getSetField() == _Fields.NONE) {
			...
			throw new RuntimeException(
					"Cannot get field 'none' because union is currently set to "
							+ getFieldDesc(getSetField()).name);
		}
	}
	...
	public NullStruct get_direct() {
		if (getSetField() == _Fields.DIRECT) {
			...
			throw new RuntimeException(
					"Cannot get field 'direct' because union is currently set to "
							+ getFieldDesc(getSetField()).name);
		}
	}
	...
	public JavaObject get_custom_object() {
		if (getSetField() == _Fields.CUSTOM_OBJECT) {
			...
			throw new RuntimeException(
					"Cannot get field 'custom_object' because union is currently set to "
							+ getFieldDesc(getSetField()).name);
		}
	}
	...
	public byte[] get_custom_serialized() {
		set_custom_serialized(org.apache.thrift.TBaseHelper
				.rightSize(buffer_for_custom_serialized()));
	...
	public NullStruct get_local_or_shuffle() {
		if (getSetField() == _Fields.LOCAL_OR_SHUFFLE) {
			...
			throw new RuntimeException(
					"Cannot get field 'local_or_shuffle' because union is currently set to "
							+ getFieldDesc(getSetField()).name);
		}
	}
	...
	public int hashCode() {
		...
		if (setField != null) {
			...
			if (value instanceof org.apache.thrift.TEnum) {
				hcb.append(((org.apache.thrift.TEnum) getFieldValue())
						.getValue());
			} else {
				hcb.append(value);
			}
