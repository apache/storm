...
public class SpoutStats implements
		org.apache.thrift.TBase<SpoutStats, SpoutStats._Fields>,
	...
	private static final org.apache.thrift.protocol.TField COMPLETE_MS_AVG_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"complete_ms_avg", org.apache.thrift.protocol.TType.MAP, (short) 3);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		ACKED((short) 1, "acked"), FAILED((short) 2, "failed"), COMPLETE_MS_AVG(
				(short) 3, "complete_ms_avg");
	...
	public SpoutStats(SpoutStats other) {
		if (other.is_set_acked()) {
			...
			for (Map.Entry<String, Map<String, Long>> other_element : other.acked
					.entrySet()) {
		...
		if (other.is_set_failed()) {
			...
			for (Map.Entry<String, Map<String, Long>> other_element : other.failed
					.entrySet()) {
		...
		if (other.is_set_complete_ms_avg()) {
			...
			for (Map.Entry<String, Map<String, Double>> other_element : other.complete_ms_avg
					.entrySet()) {
				...
				for (Map.Entry<String, Double> other_element_value_element : other_element_value
					...
					__this__complete_ms_avg_copy_value.put(
							__this__complete_ms_avg_copy_value_copy_key,
							__this__complete_ms_avg_copy_value_copy_value);
				}

				__this__complete_ms_avg.put(__this__complete_ms_avg_copy_key,
						__this__complete_ms_avg_copy_value);
			}
	...
	public void set_complete_ms_avg(
			Map<String, Map<String, Double>> complete_ms_avg) {
		this.complete_ms_avg = complete_ms_avg;
	}
	...
	/**
	 * Returns true if field complete_ms_avg is set (has been assigned a value)
	 * and false otherwise
	 */
	...
	public boolean equals(SpoutStats that) {
		...
		boolean this_present_complete_ms_avg = true && this
				.is_set_complete_ms_avg();
		boolean that_present_complete_ms_avg = true && that
				.is_set_complete_ms_avg();
	...
	public int compareTo(SpoutStats other) {
		...
		lastComparison = Boolean.valueOf(is_set_complete_ms_avg()).compareTo(
				typedOther.is_set_complete_ms_avg());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (is_set_complete_ms_avg()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.complete_ms_avg, typedOther.complete_ms_avg);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		while (true) {
			...
			case 1: // ACKED
				if (field.type == org.apache.thrift.protocol.TType.MAP) {
					{
						org.apache.thrift.protocol.TMap _map95 = iprot
								.readMapBegin();
						this.acked = new HashMap<String, Map<String, Long>>(
								2 * _map95.size);
						for (int _i96 = 0; _i96 < _map95.size; ++_i96) {
							...
							{
								org.apache.thrift.protocol.TMap _map99 = iprot
										.readMapBegin();
								_val98 = new HashMap<String, Long>(
										2 * _map99.size);
			...
			case 2: // FAILED
				if (field.type == org.apache.thrift.protocol.TType.MAP) {
					{
						org.apache.thrift.protocol.TMap _map103 = iprot
								.readMapBegin();
						this.failed = new HashMap<String, Map<String, Long>>(
								2 * _map103.size);
						for (int _i104 = 0; _i104 < _map103.size; ++_i104) {
							...
							{
								org.apache.thrift.protocol.TMap _map107 = iprot
										.readMapBegin();
								_val106 = new HashMap<String, Long>(
										2 * _map107.size);
			...
			case 3: // COMPLETE_MS_AVG
				if (field.type == org.apache.thrift.protocol.TType.MAP) {
					{
						org.apache.thrift.protocol.TMap _map111 = iprot
								.readMapBegin();
						this.complete_ms_avg = new HashMap<String, Map<String, Double>>(
								2 * _map111.size);
						for (int _i112 = 0; _i112 < _map111.size; ++_i112) {
							...
							{
								org.apache.thrift.protocol.TMap _map115 = iprot
										.readMapBegin();
								_val114 = new HashMap<String, Double>(
										2 * _map115.size);
	...
	public void write(org.apache.thrift.protocol.TProtocol oprot)
		...
		if (this.acked != null) {
			oprot.writeFieldBegin(ACKED_FIELD_DESC);
			{
				...
				for (Map.Entry<String, Map<String, Long>> _iter119 : this.acked
						.entrySet()) {
					oprot.writeString(_iter119.getKey());
					{
						oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(
								org.apache.thrift.protocol.TType.STRING,
								org.apache.thrift.protocol.TType.I64, _iter119
										.getValue().size()));
						for (Map.Entry<String, Long> _iter120 : _iter119
								.getValue().entrySet()) {
			...
			oprot.writeFieldBegin(FAILED_FIELD_DESC);
			{
				oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(
						...
						org.apache.thrift.protocol.TType.MAP, this.failed
								.size()));
				for (Map.Entry<String, Map<String, Long>> _iter121 : this.failed
						.entrySet()) {
					oprot.writeString(_iter121.getKey());
					{
						oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(
								org.apache.thrift.protocol.TType.STRING,
								org.apache.thrift.protocol.TType.I64, _iter121
										.getValue().size()));
						for (Map.Entry<String, Long> _iter122 : _iter121
								.getValue().entrySet()) {
		...
		if (this.complete_ms_avg != null) {
			oprot.writeFieldBegin(COMPLETE_MS_AVG_FIELD_DESC);
			{
				oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(
						org.apache.thrift.protocol.TType.STRING,
						org.apache.thrift.protocol.TType.MAP,
						this.complete_ms_avg.size()));
				for (Map.Entry<String, Map<String, Double>> _iter123 : this.complete_ms_avg
						.entrySet()) {
					oprot.writeString(_iter123.getKey());
					{
						oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(
								org.apache.thrift.protocol.TType.STRING,
								org.apache.thrift.protocol.TType.DOUBLE,
								_iter123.getValue().size()));
						for (Map.Entry<String, Double> _iter124 : _iter123
								.getValue().entrySet()) {
	...
	public void validate() throws org.apache.thrift.TException {
		...
		if (!is_set_complete_ms_avg()) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'complete_ms_avg' is unset! Struct:"
							+ toString());
		}
