...
public class JavaObject implements
		org.apache.thrift.TBase<JavaObject, JavaObject._Fields>,
		java.io.Serializable, Cloneable {
	private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
			"JavaObject");

	private static final org.apache.thrift.protocol.TField FULL_CLASS_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"full_class_name", org.apache.thrift.protocol.TType.STRING,
			(short) 1);
	private static final org.apache.thrift.protocol.TField ARGS_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"args_list", org.apache.thrift.protocol.TType.LIST, (short) 2);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		FULL_CLASS_NAME((short) 1, "full_class_name"), ARGS_LIST((short) 2,
				"args_list");
	...
	static {
		Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
				_Fields.class);
		tmpMap.put(_Fields.FULL_CLASS_NAME,
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				JavaObject.class, metaDataMap);
	}

	public JavaObject() {
	}

	public JavaObject(String full_class_name, List<JavaObjectArg> args_list) {
		this();
	...
	/**
	 * Returns true if field full_class_name is set (has been assigned a value)
	 * and false otherwise
	 */
	...
	/**
	 * Returns true if field args_list is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	public boolean equals(JavaObject that) {
		...
		boolean this_present_full_class_name = true && this
				.is_set_full_class_name();
		boolean that_present_full_class_name = true && that
				.is_set_full_class_name();
	...
	public int compareTo(JavaObject other) {
		...
		lastComparison = Boolean.valueOf(is_set_full_class_name()).compareTo(
				typedOther.is_set_full_class_name());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (is_set_full_class_name()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.full_class_name, typedOther.full_class_name);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(is_set_args_list()).compareTo(
				typedOther.is_set_args_list());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (is_set_args_list()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.args_list, typedOther.args_list);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (this.args_list != null) {
			oprot.writeFieldBegin(ARGS_LIST_FIELD_DESC);
			{
				oprot.writeListBegin(new org.apache.thrift.protocol.TList(
						org.apache.thrift.protocol.TType.STRUCT, this.args_list
								.size()));
	...
	public void validate() throws org.apache.thrift.TException {
		...
		if (!is_set_full_class_name()) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'full_class_name' is unset! Struct:"
							+ toString());
		}

		if (!is_set_args_list()) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'args_list' is unset! Struct:" + toString());
		}
