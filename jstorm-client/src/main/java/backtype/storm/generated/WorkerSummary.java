...
public class WorkerSummary implements
		org.apache.thrift.TBase<WorkerSummary, WorkerSummary._Fields>,
	...
	private static final org.apache.thrift.protocol.TField PORT_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"port", org.apache.thrift.protocol.TType.I32, (short) 1);
	private static final org.apache.thrift.protocol.TField TOPOLOGY_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"topology", org.apache.thrift.protocol.TType.STRING, (short) 2);
	private static final org.apache.thrift.protocol.TField TASKS_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"tasks", org.apache.thrift.protocol.TType.LIST, (short) 3);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		PORT((short) 1, "port"), TOPOLOGY((short) 2, "topology"), TASKS(
				(short) 3, "tasks");
	...
	static {
		...
		tmpMap.put(_Fields.TOPOLOGY,
				new org.apache.thrift.meta_data.FieldMetaData("topology",
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				WorkerSummary.class, metaDataMap);
	}
	...
	/**
	 * Returns true if field topology is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	/**
	 * Returns true if field tasks is set (has been assigned a value) and false
	 * otherwise
	 */
	...
	public int compareTo(WorkerSummary other) {
		...
		lastComparison = Boolean.valueOf(is_set_topology()).compareTo(
				typedOther.is_set_topology());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (is_set_topology()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.topology, typedOther.topology);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(is_set_tasks()).compareTo(
				typedOther.is_set_tasks());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (is_set_tasks()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.tasks, typedOther.tasks);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		while (true) {
			...
			case 3: // TASKS
				if (field.type == org.apache.thrift.protocol.TType.LIST) {
					{
						org.apache.thrift.protocol.TList _list193 = iprot
								.readListBegin();
		...
		if (this.tasks != null) {
			oprot.writeFieldBegin(TASKS_FIELD_DESC);
			{
				oprot.writeListBegin(new org.apache.thrift.protocol.TList(
						org.apache.thrift.protocol.TType.STRUCT, this.tasks
								.size()));
				for (TaskSummary _iter196 : this.tasks) {
	...
	public void validate() throws org.apache.thrift.TException {
		...
		if (!is_set_topology()) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'topology' is unset! Struct:" + toString());
		}

		if (!is_set_tasks()) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'tasks' is unset! Struct:" + toString());
		}
