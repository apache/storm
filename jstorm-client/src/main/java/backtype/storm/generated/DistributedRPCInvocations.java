...
public class DistributedRPCInvocations {
	...
	public interface AsyncIface {
		...
		public void result(
				String id,
				String result,
				org.apache.thrift.async.AsyncMethodCallback<AsyncClient.result_call> resultHandler)
				throws org.apache.thrift.TException;

		public void fetchRequest(
				String functionName,
				org.apache.thrift.async.AsyncMethodCallback<AsyncClient.fetchRequest_call> resultHandler)
				throws org.apache.thrift.TException;

		public void failRequest(
				String id,
				org.apache.thrift.async.AsyncMethodCallback<AsyncClient.failRequest_call> resultHandler)
				throws org.apache.thrift.TException;
	...
	public static class Client extends org.apache.thrift.TServiceClient
		...
		public DRPCRequest recv_fetchRequest()
			...
			throw new org.apache.thrift.TApplicationException(
					...
					"fetchRequest failed: unknown result");
		}
	...
	public static class AsyncClient extends
		...
		public void result(
				String id,
				String result,
				org.apache.thrift.async.AsyncMethodCallback<result_call> resultHandler)
				throws org.apache.thrift.TException {
			checkReady();
			result_call method_call = new result_call(id, result,
					resultHandler, this, ___protocolFactory, ___transport);
			this.___currentMethod = method_call;
			___manager.call(method_call);
		}

		public static class result_call extends
			...
			public void write_args(org.apache.thrift.protocol.TProtocol prot)
				...
				prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage(
						"result", org.apache.thrift.protocol.TMessageType.CALL,
						0));
				result_args args = new result_args();
				args.set_id(id);
				args.set_result(result);
		...
		public void fetchRequest(
				String functionName,
				org.apache.thrift.async.AsyncMethodCallback<fetchRequest_call> resultHandler)
				throws org.apache.thrift.TException {
			checkReady();
			fetchRequest_call method_call = new fetchRequest_call(functionName,
					resultHandler, this, ___protocolFactory, ___transport);
			this.___currentMethod = method_call;
			___manager.call(method_call);
		}

		public static class fetchRequest_call extends
				org.apache.thrift.async.TAsyncMethodCall {
			private String functionName;

			public fetchRequest_call(
					String functionName,
					org.apache.thrift.async.AsyncMethodCallback<fetchRequest_call> resultHandler,
					org.apache.thrift.async.TAsyncClient client,
					org.apache.thrift.protocol.TProtocolFactory protocolFactory,
		...
		public void failRequest(
				String id,
				org.apache.thrift.async.AsyncMethodCallback<failRequest_call> resultHandler)
				throws org.apache.thrift.TException {
			checkReady();
			failRequest_call method_call = new failRequest_call(id,
					resultHandler, this, ___protocolFactory, ___transport);
			this.___currentMethod = method_call;
			___manager.call(method_call);
		}

		public static class failRequest_call extends
				org.apache.thrift.async.TAsyncMethodCall {
			private String id;

			public failRequest_call(
					String id,
					org.apache.thrift.async.AsyncMethodCallback<failRequest_call> resultHandler,
					org.apache.thrift.async.TAsyncClient client,
					org.apache.thrift.protocol.TProtocolFactory protocolFactory,
	...
	public static class Processor<I extends Iface> extends
		...
		private static class result<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, result_args> {
			public result() {
				super("result");
			}
			...
			protected result_result getResult(I iface, result_args args)
					throws org.apache.thrift.TException {
				result_result result = new result_result();
		...
		private static class fetchRequest<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, fetchRequest_args> {
			public fetchRequest() {
				super("fetchRequest");
			}
			...
			protected fetchRequest_result getResult(I iface,
					fetchRequest_args args) throws org.apache.thrift.TException {
				fetchRequest_result result = new fetchRequest_result();
		...
		private static class failRequest<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, failRequest_args> {
			public failRequest() {
				super("failRequest");
			}
			...
			protected failRequest_result getResult(I iface,
					failRequest_args args) throws org.apache.thrift.TException {
				failRequest_result result = new failRequest_result();
	...
	public static class result_args implements
			org.apache.thrift.TBase<result_args, result_args._Fields>,
		...
		public enum _Fields implements org.apache.thrift.TFieldIdEnum {
			ID((short) 1, "id"), RESULT((short) 2, "result");
		...
		static {
			...
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					result_args.class, metaDataMap);
		}

		public result_args() {
		}

		public result_args(String id, String result) {
			this();
			this.id = id;
			this.result = result;
		}
		...
		/**
		 * Returns true if field result is set (has been assigned a value) and
		 * false otherwise
		 */
		...
		public int compareTo(result_args other) {
			...
			lastComparison = Boolean.valueOf(is_set_id()).compareTo(
					typedOther.is_set_id());
			if (lastComparison != 0) {
			...
			lastComparison = Boolean.valueOf(is_set_result()).compareTo(
					typedOther.is_set_result());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (is_set_result()) {
	...
	public static class result_result implements
			org.apache.thrift.TBase<result_result, result_result._Fields>,
			java.io.Serializable, Cloneable {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"result_result");
		...
		static {
			...
			metaDataMap = Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					result_result.class, metaDataMap);
		}
	...
	public static class fetchRequest_args
			implements
			org.apache.thrift.TBase<fetchRequest_args, fetchRequest_args._Fields>,
			java.io.Serializable, Cloneable {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"fetchRequest_args");

		private static final org.apache.thrift.protocol.TField FUNCTION_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"functionName", org.apache.thrift.protocol.TType.STRING,
				(short) 1);
		...
		static {
			Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
					_Fields.class);
			tmpMap.put(_Fields.FUNCTION_NAME,
			...
			metaDataMap = Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					fetchRequest_args.class, metaDataMap);
		}
	...
	public static class fetchRequest_result
			implements
			org.apache.thrift.TBase<fetchRequest_result, fetchRequest_result._Fields>,
			java.io.Serializable, Cloneable {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"fetchRequest_result");
		...
		static {
			...
			metaDataMap = Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					fetchRequest_result.class, metaDataMap);
		}

		public fetchRequest_result() {
		}

		public fetchRequest_result(DRPCRequest success) {
			this();
	...
	public static class failRequest_args
			implements
			org.apache.thrift.TBase<failRequest_args, failRequest_args._Fields>,
			java.io.Serializable, Cloneable {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"failRequest_args");
		...
		static {
			...
			metaDataMap = Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					failRequest_args.class, metaDataMap);
		}

		public failRequest_args() {
		}

		public failRequest_args(String id) {
			this();
			this.id = id;
		}
	...
	public static class failRequest_result
			implements
			org.apache.thrift.TBase<failRequest_result, failRequest_result._Fields>,
			java.io.Serializable, Cloneable {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"failRequest_result");
		...
		static {
			...
			metaDataMap = Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					failRequest_result.class, metaDataMap);
		}
